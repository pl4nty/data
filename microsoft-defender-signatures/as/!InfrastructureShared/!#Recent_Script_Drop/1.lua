...
-- Command line: lua\!InfrastructureShared\!#Recent_Script_Drop\1.luac 
...
do
  if l_0_3 and #l_0_3 > 0 then
    ...
    for l_0_8,l_0_9 in ipairs(l_0_3) do
      local l_0_10, l_0_11 = (MpCommon.StringRegExpSearch)("(alf:|slf:|tel:|detection:|scpt:DefenderReg)", (string.lower)(l_0_9))
      if l_0_10 and #l_0_4 < 15 then
    ...
    if #l_0_4 > 0 then
      ...
      ;
      (mp.set_mpattribute)("RecentScriptDropWithAttrib")
    end
  end
  ...
  if not (mp.IOAVGetDownloadUrl)() then
    ...
    do
      local l_0_12, l_0_13 = safeJsonSerialize(l_0_2) or ""
      -- DECOMPILER ERROR at PC134: Confused about usage of register: R4 in 'UnsetPending'

      AppendToRollingQueue("RQ_RecentScriptDropped", l_0_0, l_0_12, 31104000, 1000, 1)
      return mp.CLEAN
    end
  end
end
