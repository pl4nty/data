...
L2_1 = L2_1.find
L3_1 = L1_1
L4_1 = "/library/developer/commandlinetools/library/frameworks/python3.framework/versions/%d%.%d/lib/"
L5_1 = 1
...
if L0_1 then
  ...
  L3_1 = L0_1
  L4_1 = "T1140"
  L5_1 = "DefenseEvasion_DeobfuscateDecodeFilesInfo_base64aes"
  L2_1(L3_1, L4_1, L5_1)
  L2_1 = MpCommon
  L2_1 = L2_1.BmTriggerSig
  L3_1 = L0_1
  L4_1 = "BM_DeobfuscateDecode"
  L5_1 = L1_1
  L2_1(L3_1, L4_1, L5_1)
end
L2_1 = mp
