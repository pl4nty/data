...
-- Command line: lua\!InfrastructureShared\5bb38e7b06ba\1.luac 
...
if l_0_2:find("ScreenConnect.ClientSetup.sh", 1, true) or l_0_2:find("/tmp/connectwisecontrol-", 1, true) then
  return mp.CLEAN
end
