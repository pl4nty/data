...
-- Command line: lua\!InfrastructureShared\2db36cbc5132\1.luac 
...
do
  ...
  if l_0_0 ~= nil and l_0_0 ~= "" then
    ...
    if ((string.find)(l_0_0, "/tmp", 1, true) or (string.find)(l_0_0, "/home", 1, true) or (string.find)(l_0_0, "/dev/shm", 1, true) or (string.find)(l_0_0, "/var/crash", 1, true)) and StringEndsWith(l_0_0, "java") then
      return mp.INFECTED
    end
  end
  return mp.CLEAN
