...
for L9_1, L10_1 in L6_1, L7_1, L8_1 do
  ...
  if L11_1 then
    ...
    L12_1 = "BM_MacAppinUsrMasquerading"
    L11_1(L12_1)
    if L3_1 then
      L11_1 = MpCommon
      L11_1 = L11_1.BmTriggerSig
      L12_1 = L3_1
      L13_1 = "BM_MacAppinUsrMasquerading"
      L14_1 = L4_1
      L11_1(L12_1, L13_1, L14_1)
      L11_1 = TrackPidAndTechnique
      L12_1 = L3_1
      L13_1 = "T1036.005"
      L14_1 = "DefenseEvasion_Masquerading_BundleWitPopularName"
      L11_1(L12_1, L13_1, L14_1)
    end
    L11_1 = mp
  ...
  if L12_1 then
    ...
    if L3_1 then
      ...
      L13_1 = L3_1
      L14_1 = "BM_MacAppinUsrMasquerading"
      L15_1 = L4_1
      L12_1(L13_1, L14_1, L15_1)
      L12_1 = TrackPidAndTechnique
      L13_1 = L3_1
      L14_1 = "T1036.005"
      L15_1 = "DefenseEvasion_Masquerading_BundleWitPopularName"
      L12_1(L13_1, L14_1, L15_1)
    end
    L12_1 = mp
