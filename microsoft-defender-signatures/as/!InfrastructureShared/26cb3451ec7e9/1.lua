...
local l_0_5 = false
local l_0_6 = {}
-- DECOMPILER ERROR at PC17: No list found for R6 , SetList fails
...
if (("certutil")[2]).matched and (this_sigattrlog[2]).utf8p2 ~= nil then
  do
    for l_0_11 = 1, ("msiexec").SIGATTR_LOG_SZ, "scriptrunner" do
      ...
      if (("cscript")[l_0_11]).matched and (sigattr_head[l_0_11]).attribute == 16400 and (sigattr_head[l_0_11]).utf8p2 then
