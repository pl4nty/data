...
-- Command line: lua\!InfrastructureShared\58d71722649f\1.luac 
...
if (string.find)(l_0_1, "=rundll32", 1, true) and (string.find)(l_0_1, "=pushd", 1, true) and (string.find)(l_0_1, " \\\\", 1, true) then
