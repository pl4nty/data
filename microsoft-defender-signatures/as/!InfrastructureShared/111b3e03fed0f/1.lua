  ...
  if l_0_0 ~= nil and (string.find)(l_0_0, "-ap \"", 1, true) then
    ...
    do
      do
        ...
        local l_0_6 = nil
        local l_0_7 = nil
        if (ExtractDeviceProperties()).DeviceRoles and ((ExtractDeviceProperties()).DeviceRoles).SharePointServer ~= nil then
          local l_0_8 = nil
          ...
          for l_0_14,l_0_15 in pairs((sysio.FindFiles)(l_0_7, "*.aspx", 0)) do
            ...
            ;
            (mp.ReportLowfi)(R10_PC98, 2037457591)
          end
          return mp.INFECTED
        end
        do
          ...
          do
            ...
            for l_0_25,l_0_26 in ipairs(l_0_18) do
              ...
              if (2037457591).PoolName ~= nil and (2037457591).PoolName ~= "" and (2037457591).Path ~= nil and (2037457591).Path ~= "" and (string.lower)((2037457591).PoolName) == l_0_6 then
                ...
                -- DECOMPILER ERROR at PC205: Confused about usage of register: R19 in 'UnsetPending'
                ...
                if merge_tables(l_0_28, l_0_29, l_0_30, l_0_31, l_0_32) then
                  ...
                  for l_0_37,l_0_38 in pairs(merge_tables(l_0_28, l_0_29, l_0_30, l_0_31, l_0_32)) do
                    local l_0_34 = nil
                    -- DECOMPILER ERROR at PC225: Confused about usage of register: R25 in 'UnsetPending'

                    -- DECOMPILER ERROR at PC234: Confused about usage of register: R25 in 'UnsetPending'
            ...
            -- DECOMPILER ERROR at PC275: Confused about usage of register R13 for local variables in 'ReleaseLocals'
