...
-- Command line: lua\!InfrastructureShared\147b3f3c45d43\1.luac 
...
do
  ...
  do
    ...
    for l_1_6,l_1_7 in ipairs({".exe", ".dll", ".scr", ".cpl", ".com", ".bat", ".cmd", ".vbs", ".vbe", ".js", ".jse", ".wsf", ".wsh", ".hta"}) do
      local l_1_3 = nil
  ...
  AppendToRollingQueue(l_0_4, "BM:MsIntuneDeployment.B", 1, 900)
  return mp.INFECTED
end
