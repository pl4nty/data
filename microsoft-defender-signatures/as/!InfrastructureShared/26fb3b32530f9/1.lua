...
-- Command line: lua\!InfrastructureShared\26fb3b32530f9\1.luac 
...
if MpCommon.SECURITY_MANDATORY_HIGH_RID <= l_0_0.integrity_level then
  ...
  if l_0_3 and next("regsvr32.exe") and l_0_3.IntegrityLevel and MpCommon.SECURITY_MANDATORY_HIGH_RID <= l_0_3.IntegrityLevel and IsProcNameInParentProcessTree("BM", "mshta.exe") then
    local l_0_4 = nil
    if not (this_sigattrlog[6]).matched or not ((sysio.GetLastResult)()).Success then
      return mp.CLEAN
    end
    ...
    if (sysio.GetFileSize)(l_0_4) <= 65536 or not 65536 then
      ...
      do
        do
          local l_0_11 = {"1ÀÃ", "H1ÀÃ"}
          -- DECOMPILER ERROR at PC137: Overwrote pending register: R14 in 'AssignReg'

          if (string.find)(l_0_9, "sdbf", "msxsl.exe", true) ~= nil and ((string.find)(l_0_9, "p\000w\000s\000h\000.\000e\000x\000e\000", 1, true) ~= nil or (string.find)(l_0_9, ".\000p\000w\000s\000h\000", 1, true) ~= nil or (string.find)(l_0_9, ".\000M\000i\000c\000r\000o\000s\000o\000f\000t\000.\000*\000", 1, true) ~= nil) then
