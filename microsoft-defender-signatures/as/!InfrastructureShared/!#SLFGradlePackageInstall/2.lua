...
-- Command line: lua\!InfrastructureShared\!#SLFGradlePackageInstall\2.luac 
...
if l_0_3:find("\\.gradle\\caches\\modules-2\\", 1, true) == nil then
  return mp.CLEAN
end
return mp.INFECTED
