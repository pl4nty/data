...
-- Command line: lua\!InfrastructureShared\!#SLFTrojanWin32PersistInStart\3.luac 
...
if l_0_0 ~= "64eacc49-6a31-42c6-9b39-c3d9148e65f4" and l_0_0 ~= "0d5a49d5-57c7-40c0-ab8b-3a066e83b05a" and (l_0_0 ~= "d7c7c745-195f-4223-9c7a-99fb420fd000" or (MpCommon.IsSampled)(1, false, true, true) ~= true) then
  return mp.CLEAN
end
