...
if l_0_8 and l_0_9 then
  do
    ...
    if l_0_21 and l_0_22 then
      ...
      l_0_23 = set_research_data
      l_0_23("Evidence", (MpCommon.Base64Encode)(safeJsonSerialize(l_0_1)), false)
      l_0_23 = ipairs
      ...
      for l_0_27,l_0_28 in l_0_23 do
        ...
        if l_0_29 then
          ...
          l_0_30 = l_0_29.AppName
          if l_0_30 == "OneDrive" then
            l_0_30 = string
            l_0_30 = l_0_30.find
            l_0_30 = l_0_30(l_0_5, "shell32.dll")
            if l_0_30 then
              l_0_30 = mp
              l_0_30 = l_0_30.CLEAN
              return l_0_30
    ...
    do
      ...
      do
        ...
        -- DECOMPILER ERROR at PC228: Overwrote pending register: R15 in 'AssignReg'

        -- DECOMPILER ERROR at PC229: Overwrote pending register: R15 in 'AssignReg'

        do return l_0_32 end
        -- DECOMPILER ERROR at PC231: Confused about usage of register R13 for local variables in 'ReleaseLocals'
