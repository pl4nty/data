...
-- Command line: lua\!InfrastructureShared\49d70e77bfe2\1.luac 
...
if l_0_5:match("%.docx?$") or l_0_5:match("%.pdf$") or l_0_5:match("%.xlsx?$") or l_0_5:match("%.msi?$") or not l_0_5:match("%.pptx?$") then
  return mp.CLEAN
end
