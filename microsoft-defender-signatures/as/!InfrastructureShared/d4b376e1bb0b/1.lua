...
-- Command line: lua\!InfrastructureShared\d4b376e1bb0b\1.luac 
...
local l_0_5, l_0_6, l_0_7 = ("NdrClientCall3")(this_sigattrlog[2], l_0_0)
;
(bm.add_related_string)((string.format)("%s_Debug", l_0_0), (this_sigattrlog[2]).utf8p2, bm.RelatedStringBMReport)
