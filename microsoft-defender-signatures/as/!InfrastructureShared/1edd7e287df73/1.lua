...
-- Command line: lua\!InfrastructureShared\1edd7e287df73\1.luac 
...
do
  if not (l_0_0.mem_forever).matched and not (l_0_0.mem_perm).matched and not (l_0_0.mem_future).matched then
    local l_0_1 = (l_0_0.mem_everyfuture).matched
  end
  do
    if not (l_0_0.mem_exfil_next).matched then
      local l_0_2 = nil
    end
