...
-- Command line: lua\!InfrastructureShared\!#LUAAIDiscovery_vscodetasks_json\1.luac 
...
local l_0_3 = "ai_vscode_tasks_json"
local l_0_4 = "ai_vscode_tasks_json_" .. l_0_1
local l_0_5 = 86400
...
if not l_0_8.tasks or not (l_0_8.tasks)[1] then
  return mp.CLEAN
end
local l_0_9 = (l_0_8.tasks)[1]
if not l_0_9.runOptions or not (l_0_9.runOptions).runOn then
  return mp.CLEAN
end
local l_0_10 = l_0_8
...
do
  ...
  if l_0_19 then
    (MpCommon.BmTriggerSig)(l_0_19, "AIDiscovery_vscode_tasks_json", l_0_11)
  end
  ;
