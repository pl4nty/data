...
if l_0_2 ~= nil and l_0_2 ~= "" then
  ...
  if l_0_3 ~= nil and (string.lower)(l_0_3) == "d7c7c745-195f-4223-9c7a-99fb420fd000" and (MpCommon.IsSampled)(60000, false, true, true) == true and (string.find)(l_0_2, ".:\\program files[^\\]*\\common files\\microsoft shared\\clicktorun\\") then
    return mp.CLEAN
  end
end
do
