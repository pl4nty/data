...
reportDetectedRegions = function(l_8_0)
  ...
  local l_8_1 = function(l_9_0)
    ...
    local l_9_8 = function(l_11_0, l_11_1)
      -- function num : 0_7_0_1 , upvalues : l_9_4
    ...
    local l_9_12 = function(l_12_0, l_12_1)
      -- function num : 0_7_0_2 , upvalues : l_9_5, l_9_3
      if not l_9_5(l_12_0, l_12_1) then
        return nil
      end
      local l_12_2 = 65536
      local l_12_3 = l_9_3
    ...
    if not l_9_0 then
      for l_9_16,l_9_17 in ipairs((mp.hstr_full_log)()) do
        local l_9_13, l_9_14, l_9_15, l_9_16, l_9_17 = function(l_13_0)
...
, function(l_15_0, l_15_1)
      -- function num : 0_7_0_5 , upvalues : l_9_8, l_9_7
      ...
      local l_15_2 = "\027\127\238-" .. (string.char)((mp.GetSMSProcArchitecture)()) .. l_9_8(l_15_0.addr) .. l_9_7(l_15_0.size) .. l_9_7(l_15_0.alloc_prot) .. l_9_7(l_15_0.prot) .. l_9_7(#l_15_1) .. l_15_1
      if (versioning.GetEngineBuild)() >= 24030 then
        l_15_2 = (MpCommon.GzipCompress)(l_15_2)
      end
      return (MpCommon.Base64Encode)(l_15_2), #l_15_2
    end
, function(l_16_0)
      -- function num : 0_7_0_6 , upvalues : l_9_1, l_9_6, l_9_9
      local l_16_1 = 0
      ...
      if not IsKeyInRollingQueue(l_16_2, l_16_3, true) then
        local l_16_4 = l_9_6(l_16_0.addr, l_16_0.size)
        local l_16_5, l_16_6 = l_9_9(l_16_0, l_16_4)
        if l_16_5 ~= nil then
          l_16_1 = l_16_6
...
, function(l_17_0)
      -- function num : 0_7_0_7 , upvalues : l_9_4
      if not l_17_0 then
        return nil
      end
      local l_17_1 = 0
      ...
      l_17_1 = 0
      local l_17_4 = l_9_4(l_17_0.addr + l_17_0.size + 1)
      while 1 do
        if l_17_4 then
          l_17_2[#l_17_2 + 1] = l_17_4
          l_17_4 = l_9_4(l_17_4.addr + l_17_4.size + 1)
          l_17_1 = l_17_1 + 1
        end
        if l_17_1 == 8 then
          break
      ...
      return l_17_2
        ...
        if R17_PC34.matched then
          local l_9_18 = 0
          if l_9_7(R17_PC34.VA) then
            for l_9_23,l_9_24 in ipairs(l_9_17(l_9_7(R17_PC34.VA))) do
              local l_9_24 = nil
              -- DECOMPILER ERROR at PC50: Confused about usage of register: R24 in 'UnsetPending'

              local l_9_25 = nil
              if l_9_3 <= l_9_18 + l_9_16(R24_PC50) then
                break
              end
              l_9_18 = l_9_18 + l_9_16(R24_PC50)
            end
            break
          end
        end
      ...
      do
        for l_9_29,l_9_30 in ipairs(l_9_0) do
          local l_9_26, l_9_27, l_9_28, l_9_29, l_9_30 = nil
          ...
          if l_9_7(l_9_23) and l_9_3 <= l_9_31 + l_9_29(l_9_7(l_9_23)) then
            break
          end
          l_9_31 = l_9_31 + l_9_29(l_9_7(l_9_23))
        end
        do
          do
            ...
            ;
            (MpCommon.BmTriggerSig)(l_9_1, "RegionsCollected", (string.format)("%d", l_9_31))
...
getDetectedRegions = function()
  -- function num : 0_8
  local l_9_0 = (mp.GetSMSMemRanges)()
  local l_9_1 = {}
  for l_9_5,l_9_6 in ipairs((mp.hstr_full_log)()) do
    if l_9_6.matched then
      for l_9_10,l_9_11 in ipairs(l_9_6.VA_all) do
        local l_9_12, l_9_13 = (mp.SMSVirtualQuery)(l_9_11)
        if l_9_12 then
          local l_9_14 = l_9_0[l_9_13.found_ix]
          if l_9_14 and l_9_1[l_9_14.addr] == nil then
            l_9_1[l_9_14.addr] = l_9_14
          end
        end
      end
    end
...
CmdReportParent = function(l_10_0)
  -- function num : 0_9
  local l_10_1 = (mp.getfilename)()
  if l_10_1 ~= nil then
    l_10_1 = (string.lower)(l_10_1)
    local l_10_2 = l_10_1:match("([^\\]+)$")
    if l_10_2 ~= nil and l_10_2 ~= "powershell.exe" and l_10_2 ~= "cmd.exe" and l_10_2 ~= "7zg.exe" and l_10_2 ~= "autoconv.exe" and l_10_2 ~= "robocopy.exe" and l_10_2 ~= "wscript.exe" and l_10_2 ~= "cscript.exe" and l_10_2 ~= "skypeapp.exe" and l_10_2 ~= "ctregsvr.exe" and l_10_2 ~= "reg.exe" and l_10_2 ~= "regedt32.exe" and l_10_2 ~= "regsvr32.exe" and l_10_2 ~= "mpcmdrun.exe" then
      return true
    end
  end
  do
    local l_10_3 = (mp.GetParentProcInfo)()
    if l_10_3 == nil then
      return false
    end
    local l_10_4 = l_10_3.image_path
    if l_10_4 == nil then
      return false
    end
    l_10_4 = (string.lower)(l_10_4)
    local l_10_5 = l_10_4:match("([^\\]+)$")
    if l_10_5 == nil then
      return false
    end
    if l_10_5 == "powershell.exe" or l_10_5 == "cmd.exe" or l_10_5 == "7zg.exe" or l_10_5 == "autoconv.exe" or l_10_5 == "robocopy.exe" or l_10_5 == "wscript.exe" or l_10_5 == "cscript.exe" or l_10_5 == "skypeapp.exe" or l_10_5 == "ctregsvr.exe" or l_10_5 == "reg.exe" or l_10_5 == "regedt32.exe" or l_10_5 == "regsvr32.exe" or l_10_5 == "mpcmdrun.exe" then
      return false
    end
    ;
    (mp.ReportLowfi)(l_10_4, l_10_0)
    return true
  end
end
...
candidatePeFile = function()
  -- function num : 0_10
  local l_11_0 = (mp.getfilesize)()
  if l_11_0 > 4000000 or l_11_0 < 4000 then
    return false
  end
  ...
  local l_11_1 = (mp.getfilename)((mp.bitor)(mp.FILEPATH_QUERY_FULL, mp.FILEPATH_QUERY_LOWERCASE))
  if l_11_1:find("program files", 1, true) then
    return false
  end
  if l_11_1:find("system32", 1, true) then
    return false
  end
  if l_11_1:find("syswow64", 1, true) then
    return false
  end
  if l_11_1:find("winsxs", 1, true) then
    return false
  end
  return true
end
...
getScannedRegions = function()
  ...
  local l_12_2 = (mp.GetScannedPPID)()
  local l_12_3 = (mp.GetSMSMemRanges)()
  local l_12_4 = "memRegionsMetadata"
  local l_12_5 = 0
  local l_12_6 = {}
  l_12_6.ppid = l_12_2
  l_12_6.arch = (mp.GetSMSProcArchitecture)()
  l_12_6.regions = {}
  for l_12_10,l_12_11 in ipairs(l_12_3) do
    l_12_5 = l_12_5 + 1
    if l_12_5 <= 150 then
      if not l_12_11.addr or not l_12_11.size or not l_12_11.prot or not l_12_11.alloc_prot then
        return 3
      end
      local l_12_12 = l_12_6.regions
      local l_12_13 = #l_12_6.regions + 1
      local l_12_14 = {}
      l_12_14.addr = l_12_1(l_12_11.addr)
      l_12_14.size = l_12_0(l_12_11.size)
      l_12_14.alloc_prot = l_12_0(l_12_11.alloc_prot)
      l_12_14.prot = l_12_0(l_12_11.prot)
      l_12_14.state_type = l_12_0(l_12_11.state_type)
      l_12_14.flags = l_12_0(l_12_11.flags)
      l_12_12[l_12_13] = l_12_14
    end
  end
  l_12_6.nRegions = l_12_5
  local l_12_15 = (MpCommon.JsonSerialize)(l_12_6)
  AppendToRollingQueue(l_12_4, "data", l_12_15)
  ;
  (MpCommon.BmTriggerSig)(l_12_2, l_12_4, (string.format)("nRegions %d", l_12_5))
  return 0
end
