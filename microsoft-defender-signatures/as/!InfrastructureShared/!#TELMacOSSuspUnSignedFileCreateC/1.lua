...
if L0_1 ~= nil and L0_1 ~= "" then
  ...
  L1_1 = L0_1.lower
  L1_1 = L1_1(L2_1)
  if L1_1 == "ac006843-1fb8-455e-9738-5726827ed4a0" then
    goto lbl_15
  end
end
L1_1 = mp
...
if L1_1 ~= nil and L1_1 ~= "" then
  ...
  L2_1 = L1_1.lower
  L2_1 = L2_1(L3_1)
  if L2_1 == "18088170-fab3-5391-9131-b07bf758566b" then
    goto lbl_29
  end
end
L2_1 = mp
...
if L4_1 then
  ...
  L4_1 = L4_1.find
  L5_1 = L3_1
  L6_1 = "com.apple.system.settings"
  L7_1 = 1
  L8_1 = true
  L4_1 = L4_1(L5_1, L6_1, L7_1, L8_1)
  if L4_1 then
