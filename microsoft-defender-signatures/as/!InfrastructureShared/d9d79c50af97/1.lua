...
if l_0_8 and l_0_9 then
  do
    ...
    for l_0_14,l_0_15 in ipairs(l_0_9) do
      if (string.find)(l_0_15.value, "UnsignedFile", 1, true) then
        ...
        if l_0_16 then
          ...
          local l_0_18 = l_0_16
          local l_0_19 = {}
          -- DECOMPILER ERROR at PC115: No list found for R18 , SetList fails
          ...
          -- DECOMPILER ERROR at PC125: Overwrote pending register: R21 in 'AssignReg'

          -- DECOMPILER ERROR at PC126: Overwrote pending register: R22 in 'AssignReg'
          ...
          if l_0_17 then
            do
              ...
              -- DECOMPILER ERROR at PC135: Overwrote pending register: R17 in 'AssignReg'
    ...
    if (MpCommon.StringRegExpSearch)("\\\\(desktop|download|onedrive|document|picture)", l_0_5) then
      ...
      -- DECOMPILER ERROR at PC199: Overwrote pending register: R12 in 'AssignReg'
      ...
      if not contains(l_0_5, l_0_25) or GetRollingQueueKeyValues("PFApp_PotentialDownload_Ppid", l_0_25) then
        ...
        -- DECOMPILER ERROR at PC205: Overwrote pending register: R6 in 'AssignReg'
      ...
      if pcall(l_0_25, l_0_26, l_0_27) and l_0_25 then
        ...
        -- DECOMPILER ERROR at PC218: Overwrote pending register: R14 in 'AssignReg'
      ...
      l_0_1.Score = l_0_6
      -- DECOMPILER ERROR at PC241: Overwrote pending register: R14 in 'AssignReg'

      local l_0_35, l_0_36 = nil
      -- DECOMPILER ERROR at PC247: Overwrote pending register: R15 in 'AssignReg'
      ...
      do
        ...
        -- DECOMPILER ERROR at PC254: Overwrote pending register: R15 in 'AssignReg'

        -- DECOMPILER ERROR at PC255: Overwrote pending register: R15 in 'AssignReg'

        do return l_0_35 end
        -- DECOMPILER ERROR at PC257: Confused about usage of register R14 for local variables in 'ReleaseLocals'
