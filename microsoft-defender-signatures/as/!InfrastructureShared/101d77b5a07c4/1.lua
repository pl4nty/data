...
if l_0_12.Evidence_L1 and ((l_0_12.Evidence_L1).MultilayerEncoding or (l_0_12.Evidence_L1).Obfuscated_FailedToDecode) and l_0_12.Score > 0 then
  ...
  do
    if l_0_12.Evidence_L2 and (l_0_12.Evidence_L2).CommandlineTokens then
      local l_0_15 = (l_0_12.Evidence_L2).CommandlineTokens
      if table_contains(l_0_15, "googleupdate", true) or table_contains(l_0_15, "[scriptblock]::create($split_parts[0])&$exec_wrapper", true) then
        l_0_14 = true
      end
    end
    if not l_0_14 then
      local l_0_16, l_0_17 = safeJsonSerialize(l_0_12, 150, nil, true)
      do
        local l_0_18, l_0_19 = (l_0_12.Evidence_L1).MultilayerEncoding and "Appomaly_MultilayerEncoded_Tracked" or "Appomaly_Encoded_Obfuscated_Tracked"
        local l_0_20 = nil
        local l_0_21 = MpCommon.BmTriggerSig
        local l_0_22 = l_0_2.ppid
        do
          l_0_21(l_0_22, l_0_20, l_0_16 or l_0_17)
          ...
          if l_0_12.Score > 30 then
            if l_0_12.CommandlineTokens then
              ...
              do
                ...
                if l_0_31 == false and "Appomaly_ChildProcName_CmdLine" == false then
                  return mp.CLEAN
                else
                  if l_0_31 and not "Appomaly_ChildProcName_CmdLine" then
                    local l_0_32, l_0_33, l_0_34 = , IsPotentiallyClean("CmdLine", l_0_6 .. ";" .. l_0_28, l_0_12.CommandlineTokens)
                    if l_0_34 then
                      l_0_1.IsPotentiallyClean = "CmdLine"
                    end
                    ;
                    (MpCommon.BmTriggerSig)(l_0_2.ppid, "AnomalousChildCommandline", safeJsonSerialize(l_0_29))
                  end
                end
                do
                  local l_0_35, l_0_36 = , startTrackingApp(l_0_7, l_0_6, "PFServers", "PFApp_Parent")
                  if not l_0_36 then
                    ...
                    IncreaseProcessAnomalyScore(l_0_2.ppid, l_0_12.Score, l_0_38, "PFApp_Parent", {ProcessName = (MpCommon.GetImagePathFromPid)(l_0_0), IsProcessFriendly = (MpCommon.IsFriendlyProcess)(l_0_0), Pid = l_0_0, Base64GradingInfo = l_0_1.Base64GradingInfo, IndicatorScore = l_0_12.Score, Parents = l_0_8})
                    if next(l_0_37) and l_0_37.IsNewApp then
                      l_0_37.SignatureName = "PFApps.C"
                      l_0_37.Score = l_0_12.Score
                      ;
                      (MpCommon.BmTriggerSig)(l_0_7, "SetProcessAttrib", safeJsonSerialize(l_0_37))
                    end
                  end
                  do
                    ...
                    for l_0_43 = 1, 3 do
                      ...
                      if l_0_40 and l_0_40["Evidence_L" .. MpCommon.BmTriggerSig] then
                        ...
                        do
                          do
                            if (l_0_40["Evidence_L" .. l_0_44]).MultilayerEncoding then
                    ...
                    do
                      if l_0_40 and l_0_40.Evidence_L1 then
                        local l_0_50 = nil
                        if (l_0_40.Evidence_L1).MultilayerEncoding then
                      ...
                      local l_0_52 = nil
                      local l_0_53 = {}
                      for l_0_57,l_0_58 in ipairs(l_0_1.Parents) do
                        local l_0_54 = 0
                      ...
                      do
                        local l_0_62, l_0_63 = , safeJsonSerialize(l_0_1, 150, nil, true)
                        if l_0_63 then
                          set_research_data("Evidence", (MpCommon.Base64Encode)(l_0_63), false)
                          ;
