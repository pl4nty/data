...
if L0_1 == L1_1 then
  ...
  if L1_1 and L2_1 then
    ...
    if L3_1 and L4_1 ~= nil then
      ...
      L6_1 = L6_1.find
      L7_1 = L5_1
      L8_1 = "\\appdata\\local\\packages\\microsoft.windowscommunicationsapps_8wekyb3d8bbwe\\localstate\\files\\"
      L9_1 = 1
      L10_1 = true
      ...
      if L6_1 == nil then
        ...
        L6_1 = L6_1.find
        L7_1 = L5_1
        L8_1 = "\\appdata\\local\\microsoft\\windows\\inetcache\\content.outlook\\"
        L9_1 = 1
        L10_1 = true
        L6_1 = L6_1(L7_1, L8_1, L9_1, L10_1)
        if L6_1 == nil then
