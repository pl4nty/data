...
-- Command line: lua\!InfrastructureShared\8db37627401a\1.luac 
...
do
  local l_0_9, l_0_10 = pcall(reportBmInfo)
  if not l_0_9 and l_0_10 then
    (bm.add_related_string)("bmInfoFailReason", tostring(l_0_10), bm.RelatedStringBMReport)
  end
  return mp.INFECTED
end
