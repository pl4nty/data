...
-- Command line: lua\!InfrastructureShared\1013d77a8ed0ef\1.luac 
...
do
  if contains(l_0_3, "powershell") then
    local l_0_5, l_0_6 = (MpCommon.StringRegExpSearch)("(?i)[^\\w\\d\\s]w[indowstyle]*\\s+(?:h[iden]*|1|m[inimized]*)\\s+", l_0_3)
    if l_0_5 then
      return mp.INFECTED
    end
  end
