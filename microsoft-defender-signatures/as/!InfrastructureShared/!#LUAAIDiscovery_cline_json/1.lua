...
-- Command line: lua\!InfrastructureShared\!#LUAAIDiscovery_cline_json\1.luac 
      ...
      do
        do
          ...
          do
            ...
            local l_0_44 = (mp.get_contextdata)(mp.CONTEXT_DATA_PROCESS_PPID)
            if l_0_44 then
              (MpCommon.BmTriggerSig)(l_0_44, "AIDiscovery_cline_json", l_0_36)
            end
            ;
