...
-- Command line: lua\!InfrastructureShared\1aeb33c848121\1.luac 
...
do
  if (this_sigattrlog[2]).matched and (this_sigattrlog[2]).utf8p2 ~= nil then
    local l_0_5 = (string.lower)((this_sigattrlog[2]).utf8p2)
  ...
  if (this_sigattrlog[3]).matched and (this_sigattrlog[3]).utf8p1 ~= nil and (this_sigattrlog[3]).utf8p2 ~= nil then
    l_0_7 = (string.lower)((this_sigattrlog[3]).utf8p1)
    local l_0_8 = (string.lower)((this_sigattrlog[3]).utf8p2)
  ...
  do
    ...
    if (this_sigattrlog[5]).matched and (this_sigattrlog[5]).utf8p1 ~= nil and (this_sigattrlog[5]).utf8p2 ~= nil then
      l_0_10 = (string.lower)((this_sigattrlog[5]).utf8p1)
      local l_0_11 = (string.lower)((this_sigattrlog[5]).utf8p2)
          ...
          do
            ...
            if not isnull(ipv4ToInt(l_0_4)) then
              ...
              if not isnull(l_0_18) then
                ...
                if l_0_18 == true then
                  (bm.trigger_sig)("Ransomware!RemoteGenT.A!RemoteIpPrivate", l_0_19)
                  return mp.INFECTED
                else
                  ;
                  (bm.trigger_sig)("Ransomware!RemoteGenT.A!RemoteIpPublic", l_0_19)
                  return mp.INFECTED
                end
              end
            end
