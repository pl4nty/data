...
-- Command line: lua\!InfrastructureShared\dcb305c6d3f6\1.luac 
...
do
  ...
  for l_0_9 = 1, ("\\nomad.exe").SIGATTR_LOG_SZ, "\\helm.exe" do
    ...
    if (("\\go.exe")[l_0_9]).matched then
      if (sigattr_head[l_0_9]).attribute == 28768 then
        ...
        -- DECOMPILER ERROR at PC107: Overwrote pending register: R12 in 'AssignReg'

        -- DECOMPILER ERROR at PC108: Overwrote pending register: R13 in 'AssignReg'

        -- DECOMPILER ERROR at PC109: Overwrote pending register: R14 in 'AssignReg'
  ...
  TrackPidAndTechniqueBM("BM", "T1071.001", "SliverBeacon")
  ;
