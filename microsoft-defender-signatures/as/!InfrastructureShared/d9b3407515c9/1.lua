...
if (this_sigattrlog[2]).matched and (this_sigattrlog[2]).utf8p1 ~= nil and (this_sigattrlog[2]).utf8p1 ~= "" then
  ...
  do
    ...
    if ((this_sigattrlog[3]).matched and (this_sigattrlog[3]).utf8p1 ~= nil and (this_sigattrlog[3]).utf8p1 ~= "" and l_0_6 == nil) or (string.find)(l_0_6, ".app/Contents/", 1, true) then
      return mp.CLEAN
    end
