...
-- Command line: lua\!InfrastructureShared\58d70c24de7e\1.luac 
...
if l_0_0 ~= nil then
  ...
  do
    ...
    do
      ...
      if (string.find)(l_0_4, "&& curl", 1, true) and (string.find)(l_0_4, "&& tar.exe -xf", 1, true) and (string.find)(l_0_4, "/c mkdir", 1, true) then
        return mp.INFECTED
      end
      return mp.CLEAN
    end
