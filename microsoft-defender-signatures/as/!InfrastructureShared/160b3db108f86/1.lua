...
-- Command line: lua\!InfrastructureShared\160b3db108f86\1.luac 
...
do
  if (this_sigattrlog[5]).matched and (this_sigattrlog[5]).utf8p1 ~= nil and (this_sigattrlog[5]).utf8p1 ~= "" then
    local l_0_0, l_0_1, l_0_4, l_0_6, l_0_7, l_0_9, l_0_10, l_0_12, l_0_13, l_0_14, l_0_16, l_0_18, l_0_19, l_0_21, l_0_23, l_0_26, l_0_27 = nil, nil, nil
  else
  end
  if (not (this_sigattrlog[6]).matched or (this_sigattrlog[6]).utf8p1 == nil or (this_sigattrlog[6]).utf8p1 == "" or (this_sigattrlog[2]).matched) and (this_sigattrlog[2]).utf8p1 ~= nil and (this_sigattrlog[2]).utf8p1 ~= "" and (this_sigattrlog[2]).utf8p2 ~= nil and (this_sigattrlog[2]).utf8p2 ~= "" then
    local l_0_2, l_0_5, l_0_8, l_0_11, l_0_15, l_0_17, l_0_20, l_0_22, l_0_24, l_0_28 = (this_sigattrlog[6]).utf8p1, (this_sigattrlog[2]).utf8p1
    l_0_11 = this_sigattrlog
    l_0_11 = l_0_11[2]
    l_0_8 = l_0_11.utf8p2
    local l_0_3, l_0_25, l_0_29 = nil
  end
  do
