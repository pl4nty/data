...
-- Command line: lua\!InfrastructureShared\edd7a9197409\1.luac 
...
local l_0_4, l_0_5 = (MpCommon.StringRegExpSearch)("(?i)[â€\149-]w[indowstyle]*\\s+(?:h[iden]*|1|minimized)\\s+", l_0_3)
if not l_0_4 then
  return mp.CLEAN
end
local l_0_6 = false
