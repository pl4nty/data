...
-- Command line: lua\!InfrastructureShared\18dd715b78f04\1.luac 
...
do
  if not (l_0_0.rep_dbl1).matched and not (l_0_0.rep_dbl2).matched then
    local l_0_1 = (l_0_0.rep_dbl3).matched
  end
  do
    if not (l_0_0.rep_param).matched and not (l_0_0.rep_baseurl).matched then
      local l_0_2 = nil
    end
    -- DECOMPILER ERROR at PC72: Confused about usage of register: R1 in 'UnsetPending'

    if not l_0_2 or not (l_0_0.rep_pseudocode).matched then
      return mp.CLEAN
    end
