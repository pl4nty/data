...
-- Command line: lua\!InfrastructureShared\119d74e17d87d\1.luac 

-- params : ...
-- function num : 0
local l_0_0 = (mp.GetParentProcInfo)()
if not isnull(l_0_0) and not isnull(l_0_0.image_path) and not isnull(l_0_0.ppid) and (string.find)(l_0_0.image_path, "node.exe", -8, true) then
  local l_0_1 = {}
  local l_0_2 = {}
  ...
  l_0_2 = l_0_2(l_0_3, "npm-cli.js", "npm install")
  if l_0_2 then
    l_0_2 = mp
