...
-- Command line: lua\!InfrastructureShared\!#ALFPERTrojanWin64FalconAnvilA!dha\1.luac 
...
if l_0_6 - l_0_9 < 16 then
  return mp.CLEAN
end
;
(mp.readprotection)(false)
local l_0_10 = (mp.readfile)(l_0_9, 16)
if l_0_10 == nil then
  return mp.CLEAN
end
if l_0_10 == "EMBED_PAYLOAD_v2" then
  return mp.INFECTED
end
return mp.CLEAN
