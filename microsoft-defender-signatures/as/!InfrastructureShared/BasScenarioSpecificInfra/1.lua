...
IsBasFileEncryptExt = function(l_1_0)
  ...
  if l_1_2 ~= nil and l_1_2 ~= "" then
    ...
    local l_1_3 = {}
    l_1_3[".lockbit"] = true
    if l_1_3[l_1_0] == true and (l_1_2 == "d7c7c745-195f-4223-9c7a-99fb420fd000" or l_1_2 == "d7c7c745-195f-4223-9c7a-99fb420fd000" or (MpCommon.IsSampled)(45000, false, true, true) == true) then
      return true
    end
  end
  do
