...
-- Command line: lua\!InfrastructureShared\103b317497d93\1.luac 
...
if l_0_0:find("/bin/bash", 1, true) == nil and l_0_0:find("/bin/sh", 1, true) == nil and l_0_0:find("/bin/zsh", 1, true) == nil then
  return mp.CLEAN
end
