...
-- Command line: lua\!InfrastructureShared\1b7b3ae027e98\1.luac 
...
do
  ...
  if ((this_sigattrlog[4]).matched and (this_sigattrlog[4]).utf8p1 ~= nil and not (this_sigattrlog[5]).matched) or not nil then
    return mp.CLEAN
  end
  local l_0_3 = nil
