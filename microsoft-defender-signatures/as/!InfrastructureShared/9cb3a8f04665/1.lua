...
-- Command line: lua\!InfrastructureShared\9cb3a8f04665\1.luac 
...
if this_sigattrlog[4] == nil or not (this_sigattrlog[4]).matched then
  return mp.CLEAN
end
do
  local l_0_0 = (this_sigattrlog[4]).utf8p1 or "unknown"
  do
    local l_0_1 = nil
    local l_0_2 = nil
    ...
    local l_0_3 = (this_sigattrlog[4]).utf8p2 or ""
