...
do
  ...
  local l_0_3 = nil
  do
    local l_0_4, l_0_5, l_0_6, l_0_7, l_0_8, l_0_9, l_0_10, l_0_11, l_0_12, l_0_13, l_0_14, l_0_15, l_0_18, l_0_21, l_0_24, l_0_27, l_0_30, l_0_33, l_0_36, l_0_39, l_0_40, l_0_41, l_0_42, l_0_43, l_0_45, l_0_47, l_0_49, l_0_51, l_0_53, l_0_55, l_0_57, l_0_59, l_0_61, l_0_62, l_0_64, l_0_66, l_0_68, l_0_69, l_0_71, l_0_74, l_0_75, l_0_77, l_0_80, l_0_82, l_0_83, l_0_84, l_0_86, l_0_88 = , (mp.GetParentProcInfo)() ~= nil and ((mp.GetParentProcInfo)()).image_path or ""
    do
      local l_0_16, l_0_19, l_0_22, l_0_25, l_0_28, l_0_31, l_0_34, l_0_37, l_0_44, l_0_46, l_0_48, l_0_50, l_0_52, l_0_54, l_0_56, l_0_58, l_0_60, l_0_63, l_0_65, l_0_67, l_0_70, l_0_72, l_0_76, l_0_78, l_0_81, l_0_85, l_0_87, l_0_89 = , l_0_0 ~= nil and l_0_0.command_line or ""
      -- DECOMPILER ERROR at PC39: Confused about usage of register: R3 in 'UnsetPending'

      -- DECOMPILER ERROR at PC43: Confused about usage of register: R3 in 'UnsetPending'

      do
        local l_0_17, l_0_20, l_0_23, l_0_26, l_0_29, l_0_32, l_0_35, l_0_38, l_0_73, l_0_79, l_0_90 = , l_0_16 ~= nil and (mp.GetProcessCommandLine)(l_0_16.ppid) or ""
        ...
        -- DECOMPILER ERROR at PC469: Confused about usage of register: R5 in 'UnsetPending'
        ...
        if (function()
  -- function num : 0_1 , upvalues : l_0_1, l_0_r5
  local l_2_0 = {}
  ...
  if ("/emr/instance-controller/lib/bootstrap-actions/")("/usr/bin/instance-controller", "aws157.instancecontroller.Main") or l_0_1(l_0_r5, l_2_0[2]) or l_0_1(l_0_r5, l_2_0[3]) then
    return true
  end
  local l_2_1, l_2_2 = pcall(bm.get_process_relationships)
  if not l_2_1 or l_2_2 == nil then
    return false
  end
  for l_2_6,l_2_7 in ipairs(l_2_2) do
    do
      local l_2_8 = l_2_7.image_path or ""
      do
        local l_2_9 = nil
        for l_2_13,l_2_14 in ipairs(l_2_0) do
          local l_2_10, l_2_11 = , l_2_7.cmd_line or ""
          -- DECOMPILER ERROR at PC53: Confused about usage of register: R14 in 'UnsetPending'

          if l_0_1(l_2_10, R14_PC53) or l_0_1(l_2_11, R14_PC53) then
            return true
          end
        end
        do
  ...
  return false
        ...
        -- DECOMPILER ERROR at PC500: Confused about usage of register: R5 in 'UnsetPending'
        ...
        do
          do
            ...
            -- DECOMPILER ERROR at PC560: Confused about usage of register: R8 in 'UnsetPending'

            -- DECOMPILER ERROR at PC566: Confused about usage of register: R8 in 'UnsetPending'

            -- DECOMPILER ERROR at PC572: Confused about usage of register: R8 in 'UnsetPending'

            -- DECOMPILER ERROR at PC578: Confused about usage of register: R8 in 'UnsetPending'

            if l_0_1(l_0_93, "/authselect") or l_0_1((not l_0_1(l_0_3, "/usr/bin/ln") and not l_0_1(l_0_3, "/bin/ln")) or not l_0_1(l_0_23, "ln -sf /etc/pam.d/system-auth /etc/pam.d/sshd") or "", "authselect ") or l_0_1((not l_0_1(l_0_3, "/usr/bin/ln") and not l_0_1(l_0_3, "/bin/ln")) or not l_0_1(l_0_23, "ln -sf /etc/pam.d/system-auth /etc/pam.d/sshd") or "", "authconfig ") or l_0_1((not l_0_1(l_0_3, "/usr/bin/ln") and not l_0_1(l_0_3, "/bin/ln")) or not l_0_1(l_0_23, "ln -sf /etc/pam.d/system-auth /etc/pam.d/sshd") or "", "pam-auth-update") or l_0_1((not l_0_1(l_0_3, "/usr/bin/ln") and not l_0_1(l_0_3, "/bin/ln")) or not l_0_1(l_0_23, "ln -sf /etc/pam.d/system-auth /etc/pam.d/sshd") or "", "/usr/libexec/authselect/") or l_0_1((not l_0_1(l_0_3, "/usr/bin/ln") and not l_0_1(l_0_3, "/bin/ln")) or not l_0_1(l_0_23, "ln -sf /etc/pam.d/system-auth /etc/pam.d/sshd") or "", "/usr/lib/authselect/") then
              return mp.CLEAN
            end
            -- DECOMPILER ERROR at PC587: Confused about usage of register: R5 in 'UnsetPending'

            -- DECOMPILER ERROR at PC593: Confused about usage of register: R5 in 'UnsetPending'

            -- DECOMPILER ERROR at PC611: Confused about usage of register: R5 in 'UnsetPending'

            -- DECOMPILER ERROR at PC617: Confused about usage of register: R5 in 'UnsetPending'

            if l_0_1(l_0_94, "dpkg") and l_0_1(l_0_94, "--status-fd") and (l_0_1(l_0_3, "/qemu-") or l_0_1(l_0_3, ".buildkit_qemu_emulator") or l_0_1(l_0_94, "qemu-binfmt") or l_0_1(l_0_94, ".buildkit_qemu_emulator")) then
              return mp.CLEAN
            end
            do return mp.INFECTED end
            -- DECOMPILER ERROR at PC628: freeLocal<0 in 'ReleaseLocals'
