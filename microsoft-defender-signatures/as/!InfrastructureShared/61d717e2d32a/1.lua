...
-- Command line: lua\!InfrastructureShared\61d717e2d32a\1.luac 
...
l_0_1 = l_0_1:gsub("\'", "")
l_0_1 = l_0_1:gsub("%s+", " ")
if (string.find)(l_0_1, "msiexec", 1, true) and (string.find)(l_0_1, "http", 1, true) and (string.find)(l_0_1, " /q", 1, true) and (string.find)(l_0_1, " /i", 1, true) then
