...
if l_0_1 ~= "64eacc49-6a31-42c6-9b39-c3d9148e65f4" and l_0_1 ~= "0d5a49d5-57c7-40c0-ab8b-3a066e83b05a" and l_0_1 ~= "d7c7c745-195f-4223-9c7a-99fb420fd000" and (MpCommon.IsSampled)(50000, false, false, false) ~= true then
  return mp.CLEAN
end
...
if l_0_2 == "sbsimulator.exe" or (string.find)(l_0_2, "sbsimulation_sb_%d+_bs_%d+_gold%.exe") ~= nil or (string.find)(l_0_2, "sbsimulation_sb_%d+_bs_%d+_red%.exe") ~= nil or (string.find)(l_0_2, "sbsimulation_sb_%d+_bs_%d+_green%.exe") ~= nil then
  if not (string.find)(l_0_3, "^[a-z]:\\program files\\safebreach\\") then
    return mp.CLEAN
  end
