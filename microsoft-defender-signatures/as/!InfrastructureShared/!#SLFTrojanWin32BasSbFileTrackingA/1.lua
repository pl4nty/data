...
if L2_1 ~= "sbsimulator.exe" then
  ...
  L4_1 = L4_1.find
  L5_1 = L2_1
  L6_1 = "sbsimulation_sb_%d+_bs_%d+_gold%.exe"
  L4_1 = L4_1(L5_1, L6_1)
  if L4_1 == nil then
    L4_1 = string
    L4_1 = L4_1.find
    L5_1 = L2_1
    L6_1 = "sbsimulation_sb_%d+_bs_%d+_red%.exe"
    L4_1 = L4_1(L5_1, L6_1)
    if L4_1 == nil then
      L4_1 = string
      L4_1 = L4_1.find
      L5_1 = L2_1
      L6_1 = "sbsimulation_sb_%d+_bs_%d+_green%.exe"
      L4_1 = L4_1(L5_1, L6_1)
      if L4_1 == nil then
        goto lbl_129
      end
...
L4_1 = L4_1.find
L5_1 = L3_1
L6_1 = "^[a-z]:\\program files\\safebreach\\"
L4_1 = L4_1(L5_1, L6_1)
if not L4_1 then
  L4_1 = mp
  L4_1 = L4_1.CLEAN
...
L4_1 = AddRqKeyAndValueNS
L5_1 = "BAS_SB_Coverage"
L6_1 = "BAS_SB_OriginalExecFiles_Tel"
L7_1 = L3_1
L8_1 = "1"
