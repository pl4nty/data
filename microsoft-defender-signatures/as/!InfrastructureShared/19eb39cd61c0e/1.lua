...
do
  ...
  do
    -- DECOMPILER ERROR at PC188: Overwrote pending register: R7 in 'AssignReg'

    -- DECOMPILER ERROR at PC192: Overwrote pending register: R10 in 'AssignReg'
    ...
    if (l_0_10.find)(l_0_3, "\\conhost.exe", "http", true) then
      ...
      -- DECOMPILER ERROR at PC208: No list found for R9 , SetList fails

      -- DECOMPILER ERROR at PC210: Overwrote pending register: R6 in 'AssignReg'

    end
    do
      -- DECOMPILER ERROR at PC211: Overwrote pending register: R7 in 'AssignReg'
      ...
      if (l_0_13.find)(l_0_3, "\\msiexec.exe", " %-%-headless ", true) then
        ...
        -- DECOMPILER ERROR at PC227: No list found for R9 , SetList fails

        -- DECOMPILER ERROR at PC229: Overwrote pending register: R6 in 'AssignReg'
