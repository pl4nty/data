...
if (string.find)(l_0_1, ".monster/?", 1, true) or (string.find)(l_0_1, ".top/?", 1, true) or (string.find)(l_0_1, ".pro/?", 1, true) or (string.find)(l_0_1, "?subid=", 1, true) or (string.find)(l_0_1, "?msclkid=", 1, true) or (string.find)(l_0_1, "?srsltid=", 1, true) or (string.find)(l_0_1, "campaignid=", 1, true) or (string.find)(l_0_1, "?__cf_chl_tk=", 1, true) then
  return mp.INFECTED
end
...
if (string.find)(l_0_3, "\\powershell.exe", 1, true) or (string.find)(l_0_3, "\\pwsh.exe", 1, true) then
  ...
  local l_0_8 = l_0_3
  local l_0_9 = {}
  -- DECOMPILER ERROR at PC162: No list found for R9 , SetList fails
...
do
  ...
  if (l_0_7.find)(l_0_3, "\\cmd.exe", "iex[()]", true) then
    ...
    -- DECOMPILER ERROR at PC185: Overwrote pending register: R18 in 'AssignReg'

    -- DECOMPILER ERROR at PC186: Overwrote pending register: R19 in 'AssignReg'

    -- DECOMPILER ERROR at PC187: Overwrote pending register: R20 in 'AssignReg'

    -- DECOMPILER ERROR at PC188: Overwrote pending register: R21 in 'AssignReg'

    -- DECOMPILER ERROR at PC189: No list found for R9 , SetList fails
  ...
  do
    ...
    if (l_0_10.find)(l_0_3, "\\conhost.exe", "http", true) then
      ...
      local l_0_14 = l_0_3
      local l_0_15 = {}
      -- DECOMPILER ERROR at PC206: Overwrote pending register: R12 in 'AssignReg'

      -- DECOMPILER ERROR at PC207: Overwrote pending register: R13 in 'AssignReg'
      ...
      -- DECOMPILER ERROR at PC212: No list found for R9 , SetList fails

      -- DECOMPILER ERROR at PC214: Overwrote pending register: R6 in 'AssignReg'

    end
    do
      -- DECOMPILER ERROR at PC215: Overwrote pending register: R7 in 'AssignReg'

      -- DECOMPILER ERROR at PC219: Overwrote pending register: R10 in 'AssignReg'

      if (l_0_13.find)(l_0_3, "\\msiexec.exe", " %-%-headless ", true) then
        local l_0_16 = str_count_match
        local l_0_17 = l_0_3
        local l_0_18 = {}
        -- DECOMPILER ERROR at PC229: Overwrote pending register: R12 in 'AssignReg'
