...
-- Command line: lua\!InfrastructureShared\280b32de48483\1.luac 
...
if (this_sigattrlog[7]).matched and (this_sigattrlog[7]).utf8p1 ~= nil and (this_sigattrlog[7]).utf8p1 ~= "" then
  ...
  do
    ...
    if ((this_sigattrlog[8]).matched and (this_sigattrlog[8]).utf8p1 ~= nil and (this_sigattrlog[8]).utf8p1 ~= "" and l_0_6 == nil) or (string.find)(l_0_6, "/System/", 1, true) == 1 then
      return mp.CLEAN
    end
    local l_0_9 = nil
