...
-- Command line: lua\!InfrastructureShared\e9d77d2ec6b8\1.luac 
...
if l_0_0 ~= nil and l_0_0.ppid ~= nil then
  ...
  l_0_1 = l_0_1:gsub("\'", "")
  l_0_1 = l_0_1:gsub("%s+", " ")
  if (string.find)(l_0_1, "hd \\\\", 1, true) and ((string.find)(l_0_1, "@ssl\\", 1, true) or (string.find)(l_0_1, "=@ssl", 1, true)) then
