...
-- Command line: lua\!InfrastructureShared\21d0d5228207\1.luac 
...
do
  ...
  local l_0_5 = nil
  if (mp.BMSearchFile)(0, l_0_3, "󠁣󠁲󠁩󠁰󠁴\144\000") < 0 then
    return mp.INFECTED
  end
  do
    if (mp.BMSearchFile)(0, l_0_3, "󠁣󠁲󠁩󠁰󠁴\144\000") - 80 < 0 then
      local l_0_6 = nil
    end
    local l_0_7 = nil
    ;
