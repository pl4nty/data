...
if l_0_7 ~= nil and l_0_7 ~= "" then
  ...
  if l_0_7 == "d7c7c745-195f-4223-9c7a-99fb420fd000" and (MpCommon.IsSampled)(2000, false, true, true) == true and l_0_6 == "klist.exe" and (string.find)(l_0_3, ":\\program files[^\\]*\\.+\\jre\\bin\\") ~= nil then
    return mp.CLEAN
  end
end
local l_0_8 = false
