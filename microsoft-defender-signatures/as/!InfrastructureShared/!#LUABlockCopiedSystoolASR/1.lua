...
if (l_0_7 == "d7c7c745-195f-4223-9c7a-99fb420fd000" or l_0_7 == "d7c7c745-195f-4223-9c7a-99fb420fd000" or (versioning.IsSampled)(4000, false, true, true) == true) and l_0_6 == "klist.exe" and (string.find)(l_0_3, ":\\program files[^\\]*\\.+\\jre\\bin\\") ~= nil then
  return mp.CLEAN
end
local l_0_8 = false
local l_0_9 = {}
