...
if (this_sigattrlog[1]).matched and (this_sigattrlog[1]).utf8p1 and (this_sigattrlog[1]).utf8p2 then
  ...
  if l_0_3 and l_0_4 then
    local l_0_5 = "http://962b56e5-5eb2-4ed3-8757-3f22f190d202.update"
    local l_0_6 = {}
    l_0_6[1] = l_0_5
    local l_0_7 = {}
    l_0_7.SIG_CONTEXT = "BM_Custom_Update_Scan_Completed"
    l_0_7.CONTENT_SOURCE = "HEIMDALL_PRECISION_PULSE"
    l_0_7.TAG = "NOLOOKUP"
    l_0_7.FilePath = l_0_1
    l_0_7.SigCounter = l_0_0
    SafeGetUrlReputation(l_0_6, l_0_7, false, 2000)
    return mp.CLEAN
  else
    do
      if l_0_0 == 10 then
