...
-- Command line: lua\!InfrastructureShared\d7b398090a2c\1.luac 

-- params : ...
-- function num : 0
if isnull(this_sigattrlog[4]) or isnull((this_sigattrlog[4]).utf8p2) then
  return mp.CLEAN
end
local l_0_0, l_0_1 = (string.match)((this_sigattrlog[4]).utf8p2, "Config=(.-);Assembly=(.+)")
...
-- DECOMPILER ERROR at PC130: Unhandled construct in 'MakeBoolean' P3
...
if (l_0_2:find("..-:\\windows\\") and not l_0_2:find("\\temp\\", 1, true)) or l_0_2:find("\\solarwinds\\", 1, true) then
  return mp.CLEAN
end
