...
-- Command line: lua\!InfrastructureShared\!#LuaAppDomainManagerMatchingConfigA\1.luac 
...
if l_0_5 and not isnull(R7_PC53) then
  l_0_4(R7_PC53)
...
R7_PC53 = R7_PC53(l_0_0, "^(.*)\\[^\\]+$")
local l_0_7 = {}
while not isnull(R7_PC53) and #R7_PC53 >= 3 and #l_0_7 < 12 do
  l_0_7[#l_0_7 + 1] = R7_PC53
  R7_PC53 = (string.match)(R7_PC53, "^(.*)\\[^\\]+$")
end
if #l_0_7 == 0 then
  return mp.CLEAN
end
...
if (mp.get_mpattribute)("SLF:Trojan:MSIL/AppDomainManagerLoader.AM") then
  local l_0_12 = nil
  local l_0_13 = #{} + 1
...
do
  ...
  if (mp.get_mpattribute)("SLF:Trojan:MSIL/AppDomainManagerLoader.AN") then
    local l_0_14 = nil
...
, false
        ...
        AppendToRollingQueueNamespaced(R20_PC147[1], l_0_9, l_0_0, 1, l_0_17, l_0_19, 1)
        if l_0_20(l_0_10, l_0_0) then
          l_0_21 = true
        end
        for l_0_28,l_0_29 in ipairs(l_0_1) do
          for l_0_33,l_0_34 in ipairs(l_0_7) do
            -- DECOMPILER ERROR at PC172: Confused about usage of register: R30 in 'UnsetPending'

            AppendToRollingQueueNamespaced(l_0_26[2], l_0_9, l_0_31 .. "|" .. R30_PC172, 1, l_0_17, l_0_19, 1)
            -- DECOMPILER ERROR at PC185: Confused about usage of register: R31 in 'UnsetPending'

            if l_0_20(l_0_11, l_0_31 .. "|" .. R30_PC172) then
              l_0_21 = true
            end
          end
        end
      end
      -- DECOMPILER ERROR at PC196: Confused about usage of register: R15 in 'UnsetPending'

      if not l_0_21 then
        return mp.CLEAN
      end
      do return mp.INFECTED end
      -- DECOMPILER ERROR at PC204: freeLocal<0 in 'ReleaseLocals'
