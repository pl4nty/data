...
if l_0_0 ~= "d7c7c745-195f-4223-9c7a-99fb420fd000" or (MpCommon.IsSampled)(100, false, true, true) ~= true then
  return mp.CLEAN
end
...
if (mp.get_contextdata)(mp.CONTEXT_DATA_PROCESS_ID) == 4 then
  ...
  do
    ...
    do
      ...
      do
        local l_0_13, l_0_14, l_0_16, l_0_19, l_0_23, l_0_27, l_0_31, l_0_35, l_0_36, l_0_38, l_0_41, l_0_43, l_0_45, l_0_48, l_0_50 = tonumber(GetRqValueByKeyNS("BAS_SB_Coverage", "BAS_SB_EncryptProcs_Tel", l_0_4 .. "\\OriginalNonExecFiles")) or 0
        do
              ...
              if (((GetRqValueByKeyNS("BAS_SB_Coverage", "BAS_SB_OriginalNonExecFiles_Tel", l_0_3) and not GetRqValueByKeyNS("BAS_SB_Coverage", "BAS_SB_RelatedNonExecFiles_Tel", l_0_3)) or GetRqValueByKeyNS("BAS_SB_Coverage", "BAS_SB_EncryptSmbNonExecFiles_Tel", l_0_3)) and not GetRqValueByKeyNS("BAS_SB_Coverage", "BAS_SB_EncryptRestNonExecFiles_Tel", l_0_3)) or l_0_5 then
                ...
                do
                  if GetRqValueByKeyNS("BAS_SB_Coverage", "BAS_SB_OriginalProcs_Tel", l_0_4) or GetRqValueByKeyNS("BAS_SB_Coverage", "BAS_SB_RelatedProcs_Tel", l_0_4) then
                    ...
                    local l_0_32, l_0_37, l_0_39, l_0_42, l_0_44, l_0_46, l_0_49, l_0_51 = , UpdateRqIntValueByKeyNS("BAS_SB_Coverage", "BAS_SB_EncryptProcs_Tel", l_0_4 .. "\\RelatedNonExecFiles", 1)
                  else
                    do
                      ...
                      -- DECOMPILER ERROR at PC407: Confused about usage of register: R8 in 'UnsetPending'
                      ...
                      -- DECOMPILER ERROR at PC412: Confused about usage of register: R7 in 'UnsetPending'

                      -- DECOMPILER ERROR at PC413: Confused about usage of register: R8 in 'UnsetPending'

                      -- DECOMPILER ERROR at PC416: Confused about usage of register: R6 in 'UnsetPending'

                      -- DECOMPILER ERROR at PC416: Confused about usage of register: R7 in 'UnsetPending'

                      -- DECOMPILER ERROR at PC417: Confused about usage of register: R8 in 'UnsetPending'
