...
-- Command line: lua\!InfrastructureShared\!#SLFTrojanWin32SuspElectronScriptJackedMK\1.luac 
  ...
  do
    ...
    do
      do
        ...
        if not l_0_8 and not (((((((string.find)(l_0_7, "execSync", 1, true) and not (string.find)(l_0_7, "new Function(", 1, true)) or not (string.find)(l_0_7, "require(\'net\')", 1, true)) and not (string.find)(l_0_7, "require(\"net\")", 1, true)) or not (string.find)(l_0_7, "require(\'tls\')", 1, true)) and not (string.find)(l_0_7, "require(\"tls\")", 1, true)) or (string.find)(l_0_7, "Buffer.from(", 1, true)) and not (string.find)(l_0_7, "\'base64\'", 1, true) and 0 + 1 + 1 + 1 + 1 + 1 + 1 + 1 >= 3 then
          return mp.CLEAN
        end
        if l_0_9 < 15 then
          return mp.CLEAN
