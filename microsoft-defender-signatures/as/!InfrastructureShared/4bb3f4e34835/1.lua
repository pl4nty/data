...
if l_0_0 and ((string.find)(l_0_0, "\\program files", 1, true) or (string.find)(l_0_0, "\\windows\\explorer.exe", 1, true) or (string.find)(l_0_0, "\\xcopy.exe", 1, true) or (string.find)(l_0_0, "\\cvtres.exe", 1, true) or (string.find)(l_0_0, "\\wermgr.exe", 1, true) or (string.find)(l_0_0, "\\werfault.exe", 1, true)) then
  return mp.CLEAN
end
