...
-- Command line: lua\!InfrastructureShared\!#ALFTrojanWin32PFApps_CmdlineA\1.luac 
...
do
  ...
  if l_0_3 and not (string.find)(l_0_3, "powershell", 1, true) and not (string.find)(l_0_3, "pwsh.exe", 1, true) then
    return mp.CLEAN
  end
  do
