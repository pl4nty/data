      ...
      do
        ...
        do
          if (string.match)(l_0_8, "^%.[A-Za-z][A-Za-z][A-Za-z]0$") and (string.match)(l_0_11, "^%.[A-Za-z][A-Za-z][A-Za-z]1$") then
            ...
            if (string.sub)(l_0_8, 2, 4) == (string.sub)(l_0_11, 2, 4) and (string.lower)((string.sub)(l_0_8, 2, 4)) ~= "vmp" and l_0_2.type == l_0_0 and l_0_3.type == l_0_0 and (mp.bitand)(l_0_2.flags, l_0_1) ~= 0 and (mp.bitand)(l_0_3.flags, l_0_1) ~= 0 and elfhdr.entry >= 0 and l_0_3.addr >= 0 and l_0_3.size >= 0 and l_0_3.addr <= elfhdr.entry and elfhdr.entry - l_0_3.addr < l_0_3.size then
              return mp.INFECTED
            end
          end
          return mp.CLEAN
