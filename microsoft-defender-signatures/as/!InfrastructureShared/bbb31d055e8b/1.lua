...
if (string.find)(l_0_0, "\\windows\\microsoft.net\\framework", 1, true) or (string.find)(l_0_0, "\\users\\public\\", 1, true) or (string.find)(l_0_0, "\\appdata\\roaming\\", 1, true) or (string.find)(l_0_0, "\\appdata\\local\\", 1, true) or (string.find)(l_0_0, "\\windows\\temp\\", 1, true) or (string.find)(l_0_0, "\\windows\\syswow64\\", 1, true) or (string.find)(l_0_0, "_x\\", 1, true) or (string.find)(l_0_0, "\\programdata\\", 1, true) then
