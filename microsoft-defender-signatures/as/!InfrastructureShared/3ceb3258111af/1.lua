...
-- Command line: lua\!InfrastructureShared\3ceb3258111af\1.luac 
...
do
  if (this_sigattrlog[12]).matched and (this_sigattrlog[12]).utf8p2 ~= nil and (this_sigattrlog[12]).utf8p2 ~= "" then
    local l_0_3 = (this_sigattrlog[12]).utf8p2
