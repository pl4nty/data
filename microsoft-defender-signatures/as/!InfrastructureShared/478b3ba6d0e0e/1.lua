...
-- Command line: lua\!InfrastructureShared\478b3ba6d0e0e\1.luac 
...
do
  if (this_sigattrlog[16]).matched and (this_sigattrlog[16]).utf8p2 ~= nil and (this_sigattrlog[16]).utf8p2 ~= "" then
    local l_0_3 = (this_sigattrlog[16]).utf8p2
