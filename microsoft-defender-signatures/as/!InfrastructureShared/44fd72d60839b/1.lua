...
-- Command line: lua\!InfrastructureShared\44fd72d60839b\1.luac 
...
do
  if contains(l_0_3, "powershell") then
    local l_0_5, l_0_6 = (MpCommon.StringRegExpSearch)("(?i)[â€\149-]w[indowstyle]*\\s+(?:h[iden]*|1|minimized)\\s+", l_0_3)
    if l_0_5 then
      return mp.INFECTED
    end
  end
