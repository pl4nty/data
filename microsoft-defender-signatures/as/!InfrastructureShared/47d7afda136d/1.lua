...
-- Command line: lua\!InfrastructureShared\47d7afda136d\1.luac 
...
l_0_2 = l_0_2:lower()
local l_0_4 = nil
if contains(l_0_2, {"invoke-webrequest", "invoke-expression", "| invoke-expression", "|iex", "| iex", "iwr ", "downloaddata", "net.webclient", "iex(["}) then
  return mp.INFECTED
end
return mp.CLEAN
