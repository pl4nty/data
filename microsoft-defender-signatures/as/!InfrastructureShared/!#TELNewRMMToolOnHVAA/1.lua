      ...
      if l_0_14 then
        ...
        do
          ...
          if l_0_19 and MpCommon.QuerySessionInformation and MpCommon.QuerySessionInformation ~= "" then
            local l_0_20 = nil
            local l_0_21 = scrubData(R20_PC329)
            l_0_12[R20_PC329] = tostring(l_0_21)
          end
          do
            -- DECOMPILER ERROR at PC336: Overwrote pending register: R20 in 'AssignReg'

            -- DECOMPILER ERROR at PC338: Overwrote pending register: R20 in 'AssignReg'

            local l_0_22, l_0_23 = , pcall(R20_PC329, l_0_14, MpCommon.WTSUserName)
            if l_0_23 and R20_PC329 and R20_PC329 ~= "" then
              local l_0_24 = R20_PC329
              local l_0_25 = scrubData(R22_PC352)
              l_0_12[R22_PC352] = tostring(l_0_25)
            end
            do
              -- DECOMPILER ERROR at PC359: Overwrote pending register: R22 in 'AssignReg'

              -- DECOMPILER ERROR at PC361: Overwrote pending register: R22 in 'AssignReg'

              local l_0_26, l_0_27 = l_0_24, pcall(R22_PC352, l_0_14, MpCommon.WTSClientAddress)
              if l_0_27 and R22_PC352 and R22_PC352 ~= "" then
                local l_0_28 = R22_PC352
                local l_0_29 = scrubData(R24_PC375)
