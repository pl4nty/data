...
-- Command line: lua\!InfrastructureShared\21d72e593327\1.luac 
...
do
  if l_0_2 and l_0_2.image_path then
    ...
    if (string.find)(l_0_3, "\\msbuild.exe", 1, true) or (string.find)(l_0_3, "\\devenv.exe", 1, true) or (string.find)(l_0_3, "\\dotnet.exe", 1, true) or (string.find)(l_0_3, "\\visual studio\\", 1, true) then
      return mp.CLEAN
    end
  end
  do
    ...
    TrackPidAndTechniqueBM("CMDHSTR", "T1127.001", "SuspIlasmCompile")
    return mp.INFECTED
  end
end
