...
-- Command line: lua\!InfrastructureShared\33db3d109795b\1.luac 
...
do
  ...
  if ((this_sigattrlog[15]).matched and (this_sigattrlog[15]).utf8p2 ~= nil and (string.lower)((this_sigattrlog[15]).utf8p2) == nil) or (string.lower)((this_sigattrlog[15]).utf8p2) == "" then
    return mp.CLEAN
  end
  local l_0_4 = nil
  ...
  if ((not (this_sigattrlog[16]).matched or (this_sigattrlog[16]).utf8p2 == nil or (this_sigattrlog[17]).matched) and nil == nil) or nil == "" then
    return mp.CLEAN
  end
