...
if (string.find)(l_0_1, "\\program files", 1, true) or (string.find)(l_0_1, "\\netlogon\\", 1, true) or (string.find)(l_0_1, "\\sysvol\\", 1, true) or (string.find)(l_0_1, " -nologo ", 1, true) or (string.find)(l_0_1, " -noprofile ", 1, true) or (string.find)(l_0_1, " -noninteractive ", 1, true) or (string.find)(l_0_1, "mmdactionengine.ps1", 1, true) or (string.find)(l_0_1, "\\windows\\ccmcache\\", 1, true) or (string.find)(l_0_1, "\\centrastage\\", 1, true) or (string.find)(l_0_1, "\\managedmetadata\\", 1, true) or (string.find)(l_0_1, "\\packages\\plugins\\microsoft.azure.azuredefenderforservers.mde.windows\\", 1, true) or (string.find)(l_0_1, "\\drv\\tools\\global\\proactiveagent\\scripts", 1, true) then
  return mp.CLEAN
end
do
