...
-- Command line: lua\!InfrastructureShared\578b318dc6ae7\1.luac 
...
do
  if (this_sigattrlog[20]).matched and (this_sigattrlog[20]).utf8p2 ~= nil and (this_sigattrlog[20]).utf8p2 ~= "" then
    local l_0_3 = (this_sigattrlog[20]).utf8p2
