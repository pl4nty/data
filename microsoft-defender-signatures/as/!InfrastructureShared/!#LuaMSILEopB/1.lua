...
if L0_1 ~= nil then
  ...
  if L1_1 == ".exe" or L1_1 == ".scr" or L1_1 == ".com" then
    ...
    L21_1 = "SIGATTR:MSIL:Invoke"
    L22_1 = "SIGATTR:MSIL:LoadAssemblyThread"
    L2_1[1] = L3_1
    L2_1[2] = L4_1
    L2_1[3] = L5_1
    L2_1[4] = L6_1
    ...
    L14_1 = "TEL:VirTool:MSIL/Obfuscator"
    L15_1 = "AGGR:MSIL:GenPossibleCustomObfuscator.A"
    L16_1 = "Lua:MSIL.AbnormalMethod.Name"
    L17_1 = "Trojan:Win32/AutoitInject"
    L18_1 = "HSTR:VirTool:Win32/Obfuscator"
    L19_1 = "LoD:VirTool:Win32/Obfuscator"
    L20_1 = "HSTR:Crypto.A"
    L21_1 = "Lua:Win32/Packed"
    L22_1 = "LUA:PEAnomaly_CertificateExpired"
    L23_1 = "SIGATTR:LoadAssembly.A"
    L24_1 = "ALF:Trojan:Win32"
    L25_1 = "TEL:Trojan:MSIL/"
    L26_1 = "SIGATTR:Cypto.A"
    L27_1 = "SIGATTR:LoadAssemblyCrypt.A"
    L28_1 = "Trojan:MSIL/NanoCore"
    L29_1 = "Trojan:MSIL/FormBook"
    L30_1 = "SIGATTR:DisableAMSI"
    L31_1 = "Lowfi:HSTR:MSIL/Obfuscator.DotNETReactor.B"
    L32_1 = "SIGATTR:MSIL/LoressoObfus.A"
    L4_1[1] = L5_1
    L4_1[2] = L6_1
    L4_1[3] = L7_1
    L4_1[4] = L8_1
