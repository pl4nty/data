...
-- Command line: lua\!InfrastructureShared\1e7b35c4f55f4\1.luac 
  ...
  do
    ...
    do
      if (not (this_sigattrlog[6]).matched or (this_sigattrlog[6]).utf8p1 == nil or (this_sigattrlog[7]).matched) and (this_sigattrlog[7]).utf8p1 ~= nil then
        local l_0_2, l_0_3, l_0_4, l_0_5 = (this_sigattrlog[6]).utf8p1
      end
      ...
      TrackPidAndTechniqueBM("BM", "T1543.001", "Persistence")
      add_parents()
      return mp.INFECTED
    end
  end
