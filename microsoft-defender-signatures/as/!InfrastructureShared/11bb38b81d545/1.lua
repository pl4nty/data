                          ...
                          do
                            ...
                            do
                              ...
                              if not l_0_24 then
                                ...
                                if not l_0_8.Known_VulnerableDll and not l_0_8.POTENTIAL_SIDE_LOADING then
                                  return mp.CLEAN
                                end
                                local l_0_56, l_0_57 = safeJsonSerialize(l_0_8, 150, nil, true)
                                if l_0_8.Known_VulnerableDll and l_0_8.POTENTIAL_SIDE_LOADING then
                                  (bm.trigger_sig)("PotentialSideLoading_D_Evaluator", l_0_56)
                                end
