  ...
  if L0_1 == true then
    ...
    if L0_1 ~= nil then
      ...
      if 12 < L2_1 and L1_1 ~= nil then
        ...
        L6_1 = -10
        L4_1 = L4_1(L5_1, L6_1)
        if L4_1 == "\\downloads" then
          L2_1 = true
          L3_1 = "Lua:WrittenToDownloadFolder"
          L4_1 = mp
          ...
          if L4_1 ~= nil then
            L2_1 = true
            L3_1 = "Lua:WrittenToDownloadFolder1Sub"
            L4_1 = mp
            L4_1 = L4_1.set_mpattribute
            L5_1 = L3_1
            L4_1(L5_1)
        ...
        if L2_1 == true then
          ...
          if 64 < L4_1 then
            L4_1 = mp
            L4_1 = L4_1.set_mpattribute
            L5_1 = "Lua:WrittenToDownloadFolderWithLongFileName"
            L4_1(L5_1)
          end
          L4_1 = mp
          ...
          if L4_1 == "" then
            ...
            L5_1 = {}
            L5_1["radeonsettings.exe"] = "Updater"
            L5_1["razercentralservice.exe"] = "Updater"
