...
-- Command line: lua\!InfrastructureShared\59d7e5d053f5\1.luac 
...
if l_0_0 ~= nil then
  ...
  do
    ...
    do
      ...
      if (string.find)(l_0_4, "cmdkey /add:", 1, true) and (string.find)(l_0_4, "/user:", 1, true) and (string.find)(l_0_4, "&& start rundll32", 1, true) then
        return mp.INFECTED
      end
      return mp.CLEAN
    end
