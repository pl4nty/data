...
if not l_0_1:match("\\([^\\]+)$") then
  ...
  do
    ...
    local l_0_7 = {}
    -- DECOMPILER ERROR at PC88: No list found for R5 , SetList fails
    ...
    for l_0_11,l_0_12 in ("\\windowsazure\\")("\\drivers\\mbamswissarmy.sys") do
    ...
    do
      ...
      TrackFileAndTechnique(l_0_6, "T1543.003:svc_imagepath_hijack", 1000)
      TrackPidAndTechniqueBM("BM", "T1543.003", "susp_svc_imagepath_hijack")
      return mp.INFECTED
    end
  end
end
