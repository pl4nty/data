...
-- Command line: lua\!InfrastructureShared\34eb34a8b3532\1.luac 
...
if (this_sigattrlog[7]).matched and (this_sigattrlog[7]).utf8p2 ~= nil then
  ...
  do
    ...
    if not (this_sigattrlog[8]).matched or (this_sigattrlog[8]).utf8p2 == nil or not isIEXfound(l_0_4) then
      return mp.CLEAN
    end
