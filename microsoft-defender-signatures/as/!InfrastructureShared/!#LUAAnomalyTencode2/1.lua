...
L1_1 = "MpInternal_researchdata=TENCODE2="
L0_1 = L0_1(L1_1)
if L0_1 ~= nil then
  L1_1 = #L0_1
  if 0 < L1_1 then
    ...
    for L4_1, L5_1 in L1_1, L2_1, L3_1 do
      ...
      L6_1 = L6_1.match
      L7_1 = L5_1
      L8_1 = "MpInternal_researchdata=TENCODE2=(%w+)$"
      L6_1 = L6_1(L7_1, L8_1)
      if L6_1 == nil then
        L7_1 = mp
        L7_1 = L7_1.CLEAN
      ...
      L8_1 = "AnomalyTencode2"
      L9_1 = "Tencode2TableMarker"
      L10_1 = 100
      L7_1 = L7_1(L8_1, L9_1, L10_1)
      if L7_1 == nil then
        L8_1 = MpCommon
        L8_1 = L8_1.AnomalyEventUpdate
        L9_1 = "AnomalyTencode2"
        L10_1 = "Tencode2TableMarker"
        L11_1 = 1
        L12_1 = 1
      ...
      if L8_1 == nil then
        ...
        if L9_1 == true and L10_1 == "!#Tencode2CommonGlobal" then
          L12_1 = mp
          L12_1 = L12_1.CLEAN
          return L12_1
        end
