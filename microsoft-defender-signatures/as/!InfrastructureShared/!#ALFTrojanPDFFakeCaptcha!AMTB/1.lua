...
-- Command line: lua\!InfrastructureShared\!#ALFTrojanPDFFakeCaptcha!AMTB\1.luac 
  ...
  for l_0_12,l_0_13,i_3 in l_0_4:gmatch("(%d%d%d%d%d%d%d%d%d%d)%s+(%d+)%s+([nf])") do
    if i_3 == "n" then
      ...
      if (string.find)((string.lower)((mp.readfile)(l_0_12, 30)), "/type/annot", 1, true) ~= nil then
        ...
        -- DECOMPILER ERROR at PC180: Confused about usage of register: R15 in 'UnsetPending'

        -- DECOMPILER ERROR at PC189: Confused about usage of register: R15 in 'UnsetPending'

        -- DECOMPILER ERROR at PC198: Confused about usage of register: R15 in 'UnsetPending'
