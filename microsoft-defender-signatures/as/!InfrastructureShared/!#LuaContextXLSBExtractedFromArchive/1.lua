...
if L0_1 == L1_1 then
  ...
  if L2_1 ~= nil then
    ...
    L3_1 = "Lua:ContextXLSBWinRARExtracted.A"
    L2_1(L3_1)
  end
  L3_1 = L1_1
  L2_1 = L1_1.find
  ...
  if L2_1 ~= nil then
    L2_1 = mp
    L2_1 = L2_1.set_mpattribute
    L3_1 = "Lua:ContextXLSB7ZipExtracted.A"
    L2_1(L3_1)
  end
  L3_1 = L1_1
  L2_1 = L1_1.find
  ...
  if L2_1 ~= nil then
    L2_1 = mp
    L2_1 = L2_1.set_mpattribute
    L3_1 = "Lua:ContextXLSBWinZipExtracted.A"
    L2_1(L3_1)
  end
  L2_1 = string
  L2_1 = L2_1.lower
  ...
  if L2_1 == "7zg.exe" then
    ...
    L4_1 = "Lua:ContextXLSB7ZipExtracted.B"
    L3_1(L4_1)
  end
  ::lbl_77::
  if L2_1 == "explorer.exe" then
    ...
    if L3_1 ~= nil then
      L3_1 = mp
      L3_1 = L3_1.set_mpattribute
      L4_1 = "Lua:ContextXLSBExplorerZIPExtracted.A"
      L3_1(L4_1)
    end
  end
end
