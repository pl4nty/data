...
do
    ...
    if (sigattr_tail[l_0_24]).attribute == 16386 then
      ...
      if (l_0_1[l_0_28] ~= nil or l_0_1[l_0_27] ~= nil) and l_0_10[l_0_27] == nil then
        ...
        if l_0_29 ~= nil and (mp.bitand)((mp.GetExtensionClass)(l_0_29), 3) ~= 0 and #l_0_25 < #l_0_26 and l_0_26:find(l_0_25, 1, true) == 1 and l_0_26:byte(#l_0_25 + 1) ~= 58 then
          ...
          if (mp.GetExtensionClass)(l_0_30) ~= 4 or isKnownRansomExtension(l_0_30) then
            ...
            if l_0_8[l_0_31] ~= nil then
              ...
              local l_0_32 = {}
              -- DECOMPILER ERROR at PC156: No list found for R27 , SetList fails
            ...
            do
              ...
              if l_0_33 ~= nil then
                if l_0_9[l_0_33] ~= nil then
                  ...
                  local l_0_34 = {}
                  -- DECOMPILER ERROR at PC176: No list found for R28 , SetList fails
                    ...
                    if #l_0_8[l_0_31] >= 5 then
                                ...
                                if l_0_58 ~= nil and (l_0_18 == "" or l_0_18 == l_0_58) then
                                  ...
                                  do
                                    do
                                      ...
                                      -- DECOMPILER ERROR at PC326: LeaveBlock: unexpected jumping out IF_ELSE_STMT
                      ...
                      for l_0_72,l_0_73 in pairs(l_0_8[l_0_31]) do
                        ...
                        do
                          ...
                          -- DECOMPILER ERROR at PC399: Confused about usage of register: R42 in 'UnsetPending'
                          ...
                          do
                            ...
                            -- DECOMPILER ERROR at PC453: Confused about usage of register: R43 in 'UnsetPending'
                      ...
                      if l_0_19 == false and #l_0_13 > 0 and l_0_18 ~= nil and l_0_18 ~= "" then
                        ...
                        do
                          if not l_0_97 or l_0_98 == nil then
                            ...
                            -- DECOMPILER ERROR at PC627: Overwrote pending register: R43 in 'AssignReg'
                          ...
                          local l_0_101 = "1bb146aa"
                          local l_0_102 = "app_ext_" .. l_0_31
                          local l_0_103 = (MpCommon.AtomicCounterValueNamespaced)(l_0_102, l_0_101)
                          if not l_0_103 then
                            l_0_12.ACFilesEncrypted = l_0_103
                          else
                            l_0_12.ACFilesEncrypted = -1
                          end
                          ;
                          ...
                          local l_0_104, l_0_105 = pcall(updateSystemDNSServers)
                          if not l_0_104 then
                            (bm.add_related_string)("updateSystemDNSServers_fail", l_0_105, bm.RelatedStringBMReport)
                          end
                          local l_0_106, l_0_107, l_0_108, l_0_109 = pcall(updateDomainInfo)
                          if l_0_106 then
                          ...
                          local l_0_110 = SafeGetUrlReputation
                          local l_0_111 = {}
                          -- DECOMPILER ERROR at PC702: No list found for R55 , SetList fails

                          local l_0_112 = {}
                          l_0_112.SIG_CONTEXT = "BM"
                          l_0_112.CONTEXT_SOURCE = "GenRansom3"
                          l_0_112.TAG = "NOLOOKUP"
                          l_0_112.data = safeJsonSerialize(l_0_12)
                          l_0_110 = l_0_110(l_0_111, l_0_112, false, 3000, false)
                          if l_0_110 then
                            l_0_111 = l_0_110.error
                            if l_0_111 == 3 then
                              l_0_12.CRReportError = "Failed the first attempt"
                              l_0_111 = SafeGetUrlReputation
                              local l_0_113 = {}
                              l_0_113.SIG_CONTEXT = "BM"
                              l_0_113.CONTEXT_SOURCE = "GenRansom3"
                              l_0_113.TAG = "NOLOOKUP"
                              l_0_113.data = safeJsonSerialize(l_0_12)
                              l_0_111, l_0_112 = l_0_111(l_0_112, l_0_113, false, 3000, false), {l_0_18}
                              l_0_110 = l_0_111
                            end
                          end
                          do
                            do
                              l_0_111 = safeJsonDeserialize
                              l_0_112 = safeJsonSerialize
                              l_0_111 = l_0_111(l_0_112(l_0_12))
                              l_0_111.ip = l_0_18
                              l_0_111.response = l_0_110
                              ;
                              (bm.trigger_sig_delayed)("RemoteGenericRansomwareDelay:Type2", safeJsonSerialize(l_0_111), 1800000)
                              if (l_0_110.urls)[l_0_18] and (((l_0_110.urls)[l_0_18]).determination == 2 or ((l_0_110.urls)[l_0_18]).determination == 1) and ((l_0_110.urls)[l_0_18]).confidence and ((l_0_110.urls)[l_0_18]).confidence >= 50 and (((l_0_110.urls)[l_0_18]).context).Source == "GenRansom" then
                                l_0_12.confidence = ((l_0_110.urls)[l_0_18]).confidence
                                l_0_12.family = (((l_0_110.urls)[l_0_18]).context).Family
                                l_0_12.determination = ((l_0_110.urls)[l_0_18]).determination
                                l_0_12.action = {action = (((l_0_110.urls)[l_0_18]).context).action, parameter = (((l_0_110.urls)[l_0_18]).context).action_parameter, ttl = (((l_0_110.urls)[l_0_18]).context).action_ttl}
                                l_0_12.context = ((l_0_110.urls)[l_0_18]).context
                                l_0_12.ip = l_0_18
                                l_0_12.unscrubbed_username = l_0_14
                                l_0_12.unscrubbed_domain = l_0_15
                                ;
                                (bm.trigger_sig)("RemoteGenericRansomware:Malware", safeJsonSerialize(l_0_12))
                                -- DECOMPILER ERROR at PC827: Confused about usage of register R56 for local variables in 'ReleaseLocals'

                              end
                              l_0_96 = bm
                              l_0_96 = l_0_96.add_related_string
                              l_0_97 = "sigcount_type2"
                              -- DECOMPILER ERROR at PC830: Overwrote pending register: R43 in 'AssignReg'

                              l_0_100 = bm
                              l_0_100 = l_0_100.RelatedStringBMReport
                              l_0_96(l_0_97, l_0_98, l_0_100)
                              l_0_96 = mp
                              l_0_96 = l_0_96.INFECTED
                              do return l_0_96 end
                              -- DECOMPILER ERROR at PC837: LeaveBlock: unexpected jumping out DO_STMT

                              -- DECOMPILER ERROR at PC837: LeaveBlock: unexpected jumping out DO_STMT

                              -- DECOMPILER ERROR at PC837: LeaveBlock: unexpected jumping out IF_THEN_STMT

                              -- DECOMPILER ERROR at PC837: LeaveBlock: unexpected jumping out IF_STMT
  ...
  -- DECOMPILER ERROR at PC841: Confused about usage of register R19 for local variables in 'ReleaseLocals'
