...
-- Command line: lua\!InfrastructureShared\5bb38b6f0d76\1.luac 
...
do
  if (string.find)(l_0_4, "xattr -c", 1, true) or (string.find)(l_0_4, "xattr -d", 1, true) or (string.find)(l_0_4, "xattr -rc", 1, true) then
