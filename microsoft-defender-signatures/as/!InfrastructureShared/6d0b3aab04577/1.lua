...
-- Command line: lua\!InfrastructureShared\6d0b3aab04577\1.luac 
...
-- DECOMPILER ERROR at PC22: Overwrote pending register: R12 in 'AssignReg'
...
if (("certutil")[2]).matched and (this_sigattrlog[2]).utf8p2 ~= nil then
  ...
  do
    ...
    -- DECOMPILER ERROR at PC183: Overwrote pending register: R18 in 'AssignReg'

    -- DECOMPILER ERROR at PC224: No list found for R10 , SetList fails
