    ...
    for L4_1, L5_1 in L1_1, L2_1, L3_1 do
      ...
      if L8_1 == nil then
        ...
        if L12_1 == 1 then
          L12_1 = mp
          L12_1 = L12_1.set_mpattribute
          L13_1 = "Lua:AnomalyImphashObsMal"
          L12_1(L13_1)
          L12_1 = mp
          L12_1 = L12_1.INFECTED
          return L12_1
        ...
        if L12_1 < 3 then
          ...
          if 20160 < L12_1 then
            L12_1 = mp
            L12_1 = L12_1.set_mpattribute
            L13_1 = "Lua:AnomalyImphashNotFreq"
            L12_1(L13_1)
            L12_1 = mp
            L12_1 = L12_1.INFECTED
            return L12_1
