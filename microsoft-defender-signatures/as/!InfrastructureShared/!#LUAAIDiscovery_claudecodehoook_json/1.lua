...
-- Command line: lua\!InfrastructureShared\!#LUAAIDiscovery_claudecodehoook_json\1.luac 
...
local l_0_4 = "ai_claude_hooks_json_" .. l_0_1
local l_0_5 = 86400
...
do
  ...
  if l_0_18 then
    (MpCommon.BmTriggerSig)(l_0_18, "AIDiscovery_claude_hooks_json", l_0_10)
  end
  ;
