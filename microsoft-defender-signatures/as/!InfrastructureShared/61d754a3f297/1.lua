...
-- Command line: lua\!InfrastructureShared\61d754a3f297\1.luac 
...
l_0_1 = l_0_1:gsub("\'", "")
l_0_1 = l_0_1:gsub("%s+", " ")
if (string.find)(l_0_1, "nslookup", 1, true) and (string.find)(l_0_1, "-q=txt", 1, true) and (string.find)(l_0_1, "| where-object", 1, true) and (string.find)(l_0_1, "| foreach-object", 1, true) then
