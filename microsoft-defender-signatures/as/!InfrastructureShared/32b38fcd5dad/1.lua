            ...
            do
              ...
              do
                ...
                if l_0_33 then
                  ...
                  l_0_29.Error = tostring(R18_PC256) .. R18_PC256
                  -- DECOMPILER ERROR at PC262: Overwrote pending register: R18 in 'AssignReg'

                  ;
                  (bm.trigger_sig)(R18_PC256, safeJsonSerialize(l_0_29))
                end
                ...
                if l_0_28 == "Appomaly_Network_HOST" then
                  l_0_36 = R18_PC256 .. "[" .. (((bm.get_current_process_startup_info)()).ppid):match("pid:(%d+)") .. "][" .. l_0_3.HostName .. "]"
                else
                  ...
                  -- DECOMPILER ERROR at PC296: Overwrote pending register: R15 in 'AssignReg'

                  -- DECOMPILER ERROR at PC297: Overwrote pending register: R18 in 'AssignReg'

                  if l_0_28 == "Appomaly_Network_UserAgent" and R18_PC256 ~= "" then
                    l_0_36 = R18_PC256 .. "[" .. (((bm.get_current_process_startup_info)()).ppid):match("pid:(%d+)") .. "][" .. l_0_3.UserAgent .. "]"
                  end
                end
                -- DECOMPILER ERROR at PC309: Overwrote pending register: R18 in 'AssignReg'

                if l_0_35 then
                  local l_0_37, l_0_38 = , R18_PC256
                  local l_0_39 = nil
                  if not (MpCommon.AnomalyEventLookup)(l_0_28, l_0_35, 1) then
                    local l_0_40 = nil
                    local l_0_41 = nil
                    -- DECOMPILER ERROR at PC323: Confused about usage of register: R22 in 'UnsetPending'
                    ...
                    if (l_0_23 - l_0_34) / 60 / 1440 > 30 then
                      ...
                      do
                        do
                          -- DECOMPILER ERROR at PC377: Overwrote pending register: R18 in 'AssignReg'

                          l_0_29.Error = tostring(l_0_39) .. ";Failed to add the key"
                          -- DECOMPILER ERROR at PC385: Confused about usage of register: R20 in 'UnsetPending'

                          do
                            do
                              local l_0_44 = nil
                              -- DECOMPILER ERROR at PC395: Overwrote pending register: R19 in 'AssignReg'

                              -- DECOMPILER ERROR at PC396: Overwrote pending register: R18 in 'AssignReg'
