        ...
        if l_0_12.Score > 40 then
          ...
          do
            ...
            if l_0_19 and l_0_16.CommandlineTokens then
              ...
              -- DECOMPILER ERROR at PC160: Confused about usage of register: R17 in 'UnsetPending'
              ...
              do
                -- DECOMPILER ERROR at PC207: Confused about usage of register: R17 in 'UnsetPending'
                  ...
                  do
                    ...
                    if not l_0_36 then
                      ...
                      if not startTrackingApp(l_0_0.ppid, l_0_19 or l_0_9, l_0_19 and "programfiles" or "generic") then
                        ...
                        ;
                        (MpCommon.BmTriggerSig)(l_0_0.ppid, "ProcAttribError", safeJsonSerialize(R26_PC259))
                      else
                        if next(R23_PC264) and (l_0_0.ppid).IsNewApp then
                          (l_0_0.ppid).SignatureName = "APML_SuspCommand.A"
                          ;
                          ...
                          ;
                          (MpCommon.BmTriggerSig)(R23_PC264, "SetProcessAttrib", safeJsonSerialize(R26_PC279))
                        end
                      end
                      ...
                      -- DECOMPILER ERROR at PC287: Overwrote pending register: R23 in 'AssignReg'

                      do
                        local l_0_41 = nil
                        IncreaseProcessAnomalyScore(l_0_0.ppid, l_0_16.Score, "Base64Cmd_child[" .. R23_PC264 .. "][cmd/APML_SuspCommand.A]", "PFAppTracked", R23_PC264)
                        l_0_10.Concrete = false
                        l_0_10.Remediation_Reason = ""
                        local l_0_42 = nil
                        for l_0_46 = 1, 3 do
                          local l_0_43, l_0_44, l_0_45, l_0_46 = , l_0_10.Base64GradingInfo
                          -- DECOMPILER ERROR at PC326: Confused about usage of register: R17 in 'UnsetPending'

                          -- DECOMPILER ERROR at PC332: Confused about usage of register: R17 in 'UnsetPending'

                          if l_0_46 and l_0_46["Evidence_L" .. l_0_41] then
                            for l_0_51,R23_PC264 in pairs((l_0_46["Evidence_L" .. l_0_41]).Urls) do
                              local l_0_51 = nil
                              if R23_PC264.BadUrlRep then
                            ...
                            do
                              do
                                -- DECOMPILER ERROR at PC349: Confused about usage of register: R17 in 'UnsetPending'
                        ...
                        do
                          ...
                          -- DECOMPILER ERROR at PC426: Confused about usage of register: R14 in 'UnsetPending'

                          -- DECOMPILER ERROR at PC430: Confused about usage of register: R14 in 'UnsetPending'
                          ...
                          for l_0_60,l_0_61 in ipairs(l_0_10.Parents) do
                            ...
                            -- DECOMPILER ERROR at PC440: Overwrote pending register: R23 in 'AssignReg'

                            if IsFileRecentlyDropped(R23_PC264) then
                              (table.insert)(l_0_59, R27_PC448)
                              l_0_60 = l_0_60 + R23_PC264
                            end
                          end
                          -- DECOMPILER ERROR at PC452: Confused about usage of register: R15 in 'UnsetPending'
                          ...
                          do
                            ...
                            if safeJsonSerialize(l_0_10, 150, nil, true) then
                              ...
                              if l_0_10 then
                                set_research_data("Error", (MpCommon.Base64Encode)(R22_PC484), R22_PC484)
                                return mp.INFECTED
                              end
                            end
                            do return mp.CLEAN end
                            -- DECOMPILER ERROR at PC493: freeLocal<0 in 'ReleaseLocals'
