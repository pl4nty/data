...
-- Command line: lua\!InfrastructureShared\!#ALFLUALinuxContextualCommonPath\1.luac 
...
if l_0_0 == mp.SCANREASON_ONOPEN or l_0_0 == mp.SCANREASON_ONMODIFIEDHANDLECLOSE then
  ...
  for l_0_6 = 1, #l_0_1 do
    ...
    -- DECOMPILER ERROR at PC49: Overwrote pending register: R10 in 'AssignReg'

    -- DECOMPILER ERROR at PC50: Overwrote pending register: R11 in 'AssignReg'
