...
if (mp.get_contextdata)(mp.CONTEXT_DATA_PROCESS_ID) == 4 then
  ...
  do
    ...
    do
      ...
      l_0_4 = (string.lower)(l_0_8 + "\\" + (string.lower)(l_0_11 .. "\\" .. l_0_9))
      do
        local l_0_12, l_0_13, l_0_15, l_0_18, l_0_22, l_0_26, l_0_30, l_0_34, l_0_35, l_0_37, l_0_40, l_0_42, l_0_44, l_0_47, l_0_49, l_0_52, l_0_56 = tonumber(GetRqValueByKeyNS("BAS_SB_Coverage", "BAS_SB_EncryptProcs_Tel", l_0_4 + "\\OriginalNonExecFiles")) or 0
        do
          local l_0_14, l_0_16, l_0_19, l_0_23, l_0_27 = , tonumber(GetRqValueByKeyNS("BAS_SB_Coverage", "BAS_SB_EncryptProcs_Tel", l_0_4 + "\\RelatedNonExecFiles")) or 0
          do
            local l_0_17, l_0_20, l_0_24 = , tonumber(GetRqValueByKeyNS("BAS_SB_Coverage", "BAS_SB_EncryptProcs_Tel", l_0_4 + "\\SmbNonExecFiles")) or 0
            do
              local l_0_21, l_0_25, l_0_29, l_0_33 = , tonumber(GetRqValueByKeyNS("BAS_SB_Coverage", "BAS_SB_EncryptProcs_Tel", l_0_4 + "\\RestNonExecFiles")) or 0
              if (((GetRqValueByKeyNS("BAS_SB_Coverage", "BAS_SB_OriginalNonExecFiles_Tel", l_0_3) and not GetRqValueByKeyNS("BAS_SB_Coverage", "BAS_SB_RelatedNonExecFiles_Tel", l_0_3)) or GetRqValueByKeyNS("BAS_SB_Coverage", "BAS_SB_EncryptSmbNonExecFiles_Tel", l_0_3)) and not GetRqValueByKeyNS("BAS_SB_Coverage", "BAS_SB_EncryptRestNonExecFiles_Tel", l_0_3)) or l_0_5 then
                ...
                do
                  if GetRqValueByKeyNS("BAS_SB_Coverage", "BAS_SB_OriginalProcs_Tel", l_0_4) or GetRqValueByKeyNS("BAS_SB_Coverage", "BAS_SB_RelatedProcs_Tel", l_0_4) then
                    ...
                    local l_0_31, l_0_36, l_0_38, l_0_41, l_0_43, l_0_45, l_0_48, l_0_50, l_0_53, l_0_57 = , 1
                  else
                    do
                      UpdateRqStrValueByKeyNS("BAS_SB_Coverage", "BAS_SB_EncryptRestNonExecFiles_Tel", l_0_3, "1")
                      do
                        local l_0_55, l_0_59 = nil
                        -- DECOMPILER ERROR at PC357: Confused about usage of register: R6 in 'UnsetPending'

                        -- DECOMPILER ERROR at PC359: Confused about usage of register: R7 in 'UnsetPending'

                        -- DECOMPILER ERROR at PC361: Confused about usage of register: R8 in 'UnsetPending'

                        -- DECOMPILER ERROR at PC363: Confused about usage of register: R6 in 'UnsetPending'
                        ...
                        -- DECOMPILER ERROR at PC366: Confused about usage of register: R7 in 'UnsetPending'
                        ...
                        -- DECOMPILER ERROR at PC370: Confused about usage of register: R7 in 'UnsetPending'

                        -- DECOMPILER ERROR at PC371: Confused about usage of register: R8 in 'UnsetPending'

                        if l_0_55 >= 2 or l_0_59 >= 3 or l_0_38 >= 4 or l_0_55 + l_0_59 >= 4 or l_0_55 + l_0_59 + l_0_38 >= 6 or l_0_55 + l_0_59 + l_0_38 + 1 >= 8 then
                          if l_0_5 then
                            (mp.ReportLowfi)(l_0_3, 1683897020)
                            return mp.INFECTED
                          else
                            ;
                            (mp.ReportLowfi)(l_0_3, 3472954176)
                            return mp.INFECTED
                          end
                        end
                        return mp.CLEAN
