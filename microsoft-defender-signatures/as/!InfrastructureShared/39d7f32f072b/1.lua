...
-- Command line: lua\!InfrastructureShared\39d7f32f072b\1.luac 
...
do
  ...
  do
    if (mp.GetParentProcInfo)() and ((mp.GetParentProcInfo)()).image_path then
      local l_0_4 = nil
      if (string.find)((string.lower)(((mp.GetParentProcInfo)()).image_path), "\\msbuild.exe", 1, true) or (string.find)((string.lower)(((mp.GetParentProcInfo)()).image_path), "\\devenv.exe", 1, true) or (string.find)((string.lower)(((mp.GetParentProcInfo)()).image_path), "\\dotnet.exe", 1, true) or (string.find)((string.lower)(((mp.GetParentProcInfo)()).image_path), "\\visual studio\\", 1, true) or (string.find)((string.lower)(((mp.GetParentProcInfo)()).image_path), "\\jetbrains\\", 1, true) then
        return mp.CLEAN
      end
    end
    do
      ...
      TrackPidAndTechniqueBM("CMDHSTR", "T1127.001", "SuspVbcCompileTarget")
      return mp.INFECTED
    end
  end
end
