...
-- Command line: lua\!InfrastructureShared\!#LUAAIDiscovery_nanobot_json\1.luac 
...
do
  ...
  do
    ...
    -- DECOMPILER ERROR at PC282: Confused about usage of register R13 for local variables in 'ReleaseLocals'
