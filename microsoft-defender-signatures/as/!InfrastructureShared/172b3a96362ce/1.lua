...
-- Command line: lua\!InfrastructureShared\172b3a96362ce\1.luac 

-- params : ...
-- function num : 0
if not (this_sigattrlog[7]).matched or (this_sigattrlog[7]).utf8p1 == nil or (this_sigattrlog[7]).utf8p2 == nil then
  return mp.CLEAN
end
local l_0_0 = (string.lower)((this_sigattrlog[7]).utf8p1)
local l_0_1 = (string.lower)((this_sigattrlog[7]).utf8p2)
local l_0_2 = {}
...
if l_0_4 ~= nil and l_0_0 == l_0_4 then
  do
    ...
    TrackPidAndTechniqueBM("BM", "T1574.001", "CloudPlaceholderEoP")
