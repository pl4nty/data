...
local l_0_6 = function(l_1_0)
  -- function num : 0_0
  if (string.match)(l_1_0, "^%s*(.-)%s*$") or not (string.match)(l_1_0, "^\"(.-)\"$") then
    l_1_0 = (string.gsub)(l_1_0, "%%(%x%x)", function(l_2_0)
    -- function num : 0_0_0
    ...
    local l_1_1 = (string.match)(l_1_0, "^file:///(.+)$")
    if isnull(l_1_1) then
      l_1_1 = (string.match)(l_1_0, "^file://localhost/(.+)$")
    end
    if isnull(l_1_1) then
      l_1_1 = (string.match)(l_1_0, "^file://(.+)$")
    end
    if isnull(l_1_1) then
      l_1_1 = (string.match)(l_1_0, "^file:\"(.-)\"$")
    end
    if isnull(l_1_1) then
      l_1_1 = (string.match)(l_1_0, "^([a-z]:[/\\].+)$")
    end
    if isnull(l_1_1) then
      return nil
    end
    local l_1_2 = string.lower
    do
      local l_1_3, l_1_4, l_1_5, l_1_6 = (string.gsub)(l_1_1, "/", "\\"), .end
      do return l_1_2(l_1_3, l_1_4, l_1_5, l_1_6) end
      -- DECOMPILER ERROR at PC87: Confused about usage of register R3 for local variables in 'ReleaseLocals'
