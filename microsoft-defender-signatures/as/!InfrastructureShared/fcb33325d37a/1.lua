...
if (this_sigattrlog[4]).matched then
                ...
                if l_0_18 and l_0_19 then
                  do
                    if l_0_19.value then
                      local l_0_20 = {}
                      -- DECOMPILER ERROR at PC143: No list found for R20 , SetList fails
                    ...
                    for l_0_24,l_0_25 in ipairs(l_0_19) do
                      if (string.find)(l_0_25.value, "UnsignedFile", 1, true) and FiletimeToDaysElapsed(l_0_25.insert_time) < 2 then
                        ...
                        if l_0_26 then
                          ...
                          local l_0_28 = l_0_26
                          local l_0_29 = {}
                          -- DECOMPILER ERROR at PC179: No list found for R28 , SetList fails

                          -- DECOMPILER ERROR at PC183: Overwrote pending register: R2 in 'AssignReg'

                        end
                        do
                          -- DECOMPILER ERROR at PC184: Overwrote pending register: R26 in 'AssignReg'

                          -- DECOMPILER ERROR at PC188: Overwrote pending register: R29 in 'AssignReg'
                    ...
                    -- DECOMPILER ERROR at PC214: Confused about usage of register R20 for local variables in 'ReleaseLocals'
                    ...
                    if l_0_18 and l_0_19 then
                      do
                        ...
                        -- DECOMPILER ERROR at PC233: Overwrote pending register: R21 in 'AssignReg'
                        ...
                        for l_0_41,l_0_42 in l_0_35 do
                          ...
                          -- DECOMPILER ERROR at PC244: Overwrote pending register: R25 in 'AssignReg'
                          ...
                          if l_0_41 < 2 then
                            ...
                            if l_0_41 then
                              ...
                              local l_0_45 = nil
                              local l_0_46 = nil
                              -- DECOMPILER ERROR at PC256: Overwrote pending register: R31 in 'AssignReg'
                            ...
                            do
                              if l_0_42 then
                                l_0_42 = string
                                l_0_42 = l_0_42.find
                                -- DECOMPILER ERROR at PC264: Overwrote pending register: R27 in 'AssignReg'

                                -- DECOMPILER ERROR at PC266: Overwrote pending register: R29 in 'AssignReg'

                                l_0_42 = l_0_42(l_0_43, "FileAttributes", l_0_45, true)
                                if l_0_42 then
                                  l_0_42 = string
                                  l_0_42 = l_0_42.match
                                  -- DECOMPILER ERROR at PC273: Overwrote pending register: R27 in 'AssignReg'

                                  l_0_42 = l_0_42(l_0_43, "%[(.*)%]")
                                  local l_0_47 = nil
                                  -- DECOMPILER ERROR at PC276: Overwrote pending register: R27 in 'AssignReg'

                                  -- DECOMPILER ERROR at PC277: Overwrote pending register: R27 in 'AssignReg'
                                  ...
                                  for l_0_51 in l_0_43 do
                                    ...
                                    -- DECOMPILER ERROR at PC285: Overwrote pending register: R2 in 'AssignReg'
                                ...
                                do
                                  if l_0_49 == "SLF:HighRiskHasMotW" then
                                    l_0_10.score = l_0_2
                                    -- DECOMPILER ERROR at PC289: Confused about usage of register R28 for local variables in 'ReleaseLocals'

                                    do break end
                                    -- DECOMPILER ERROR at PC290: Confused about usage of register R27 for local variables in 'ReleaseLocals'
  ...
  do
    ...
    local l_0_54 = nil
    local l_0_55 = nil
    if contains(l_0_0, {"defender", "msmpeng", l_0_10}) then
      do
        (bm.trigger_sig)("SetupMode_Block", "script_in_cmd")
        -- DECOMPILER ERROR at PC331: Confused about usage of register R24 for local variables in 'ReleaseLocals'

        -- DECOMPILER ERROR at PC331: Overwrote pending register: R1 in 'AssignReg'

        -- DECOMPILER ERROR at PC332: Overwrote pending register: R1 in 'AssignReg'
