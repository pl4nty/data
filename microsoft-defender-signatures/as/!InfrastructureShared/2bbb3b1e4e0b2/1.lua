...
-- Command line: lua\!InfrastructureShared\2bbb3b1e4e0b2\1.luac 
...
do
  ...
  if ((this_sigattrlog[7]).matched and (this_sigattrlog[7]).utf8p2 ~= nil and (this_sigattrlog[7]).utf8p2 ~= "" and (this_sigattrlog[7]).utf8p2 == nil) or (this_sigattrlog[7]).utf8p2 == "" then
    return mp.CLEAN
  end
  local l_0_4 = nil
