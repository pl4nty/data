...
-- Command line: lua\!InfrastructureShared\11bb322c1a123\1.luac 
      ...
      if not l_0_4:match("\\device\\vhdharddisk.-\\(.*)") then
        ...
        if l_0_6 and l_0_7 then
          do
            if l_0_7.value then
              local l_0_10 = {}
              -- DECOMPILER ERROR at PC144: No list found for R10 , SetList fails
            ...
            for l_0_14,l_0_15 in ipairs(l_0_7) do
              if (string.find)(l_0_15.value, "UnsignedFile", 1, true) then
                ...
                if l_0_16 then
                  ...
                  local l_0_18 = l_0_16
                  local l_0_19 = {}
                  -- DECOMPILER ERROR at PC176: No list found for R18 , SetList fails

                  -- DECOMPILER ERROR at PC181: Overwrote pending register: R16 in 'AssignReg'

                  -- DECOMPILER ERROR at PC184: Overwrote pending register: R19 in 'AssignReg'

                  -- DECOMPILER ERROR at PC185: Overwrote pending register: R20 in 'AssignReg'

                  -- DECOMPILER ERROR at PC186: Overwrote pending register: R21 in 'AssignReg'

                  -- DECOMPILER ERROR at PC191: Overwrote pending register: R9 in 'AssignReg'

                end
                do
                  -- DECOMPILER ERROR at PC192: Overwrote pending register: R16 in 'AssignReg'

                  -- DECOMPILER ERROR at PC194: Overwrote pending register: R17 in 'AssignReg'

                  -- DECOMPILER ERROR at PC195: Overwrote pending register: R18 in 'AssignReg'

                  if (l_0_17 and not l_0_17) or (l_0_17.find)(l_0_18, l_0_19, 1, true) then
                    local l_0_20 = (string.match)(l_0_15.value, "%[(.*)%]")
                    for l_0_24 in (string.gmatch)(l_0_20, "([^|]+)") do
                      -- DECOMPILER ERROR at PC214: Overwrote pending register: R22 in 'AssignReg'

                      -- DECOMPILER ERROR at PC221: Overwrote pending register: R9 in 'AssignReg'

                      -- DECOMPILER ERROR at PC224: Overwrote pending register: R9 in 'AssignReg'
                ...
                do
                  ...
                  if (l_0_8.Dll_PrevFileSize == -1 or l_0_8.Dll_PrevFileSize == 0) and l_0_8.Dll_FileSize > 0 then
                    ...
                    if l_0_8.Dll_FileSize > 0 then
                      ...
                      if l_0_8.Dll_PrevFileSize * 2 < l_0_8.Dll_FileSize or l_0_8.Dll_FileSize < l_0_8.Dll_PrevFileSize / 2 then
                        ...
                        l_0_8.FileSizeDiffRatio = l_0_8.Dll_FileSize * 100 / l_0_8.Dll_PrevFileSize
                        -- DECOMPILER ERROR at PC385: Overwrote pending register: R9 in 'AssignReg'

                      end
                    end
                  end
                  if (l_0_8.FileSizeDiffRatio >= 30 or l_0_8.Dll_PrevFileSize == -1) and not l_0_29 then
                  ...
                  if l_0_8.Dll_VersionInfo == "" then
                    do
                      ...
                      -- DECOMPILER ERROR at PC439: Confused about usage of register: R24 in 'UnsetPending'

                      -- DECOMPILER ERROR at PC444: Confused about usage of register: R24 in 'UnsetPending'

                      do
                        local l_0_45 = nil
                        l_0_8.Dll_VersionInfo = (l_0_41.OriginalFilename or "") .. "|" .. (l_0_41.CompanyName or "") .. "|" .. (l_0_41.FileDescription or "")
                        -- DECOMPILER ERROR at PC453: Confused about usage of register: R25 in 'UnsetPending'
  ...
  return false
                        ...
                        if not l_0_48 then
                          ...
                          do
                            ...
                            if l_0_8.Dll_PrevVersionInfo ~= "||" then
                              local l_0_54 = l_0_2:match("^(.*)\\")
                              local l_0_55 = l_0_0:match("^(.*)\\")
                              if l_0_54 == l_0_55 then
                                l_0_8.SameDirectory = true
                                -- DECOMPILER ERROR at PC531: Overwrote pending register: R9 in 'AssignReg'

                              end
                              local l_0_56, l_0_57 = IsKeyInRollingQueue("SYSTEM_DLLs", l_0_3)
                              -- DECOMPILER ERROR at PC540: Unhandled construct in 'MakeBoolean' P1
                              ...
                              do
                                ...
                                if (sysio.IsFileExists)("c:\\Windows\\System32\\" .. l_0_3) then
                                  ...
                                  -- DECOMPILER ERROR at PC554: Overwrote pending register: R9 in 'AssignReg'

                                else
                                  if (sysio.IsFileExists)("c:\\Windows\\SysWOW64\\" .. l_0_3) then
                                    l_0_58 = "SysWOW64"
                                    l_0_8.POTENTIAL_SIDE_LOADING = "SysWOW64"
                                    -- DECOMPILER ERROR at PC566: Overwrote pending register: R9 in 'AssignReg'

                                  end
                                end
                                AppendToRollingQueue("SYSTEM_DLLs", l_0_3, l_0_58, 31104000, 1000)
                                -- DECOMPILER ERROR at PC583: Overwrote pending register: R9 in 'AssignReg'
                                ...
                                if not l_0_29 then
                                  if (MpCommon.StringRegExpSearch)("\\\\(desktop|download|onedrive|document|picture)", l_0_2) then
                                    ...
                                    local l_0_60 = l_0_2
                                    local l_0_61 = {}
                                    -- DECOMPILER ERROR at PC589: No list found for R33 , SetList fails

                                    -- DECOMPILER ERROR at PC593: Overwrote pending register: R9 in 'AssignReg'

                                    -- DECOMPILER ERROR at PC594: Overwrote pending register: R31 in 'AssignReg'

                                    -- DECOMPILER ERROR at PC597: Overwrote pending register: R34 in 'AssignReg'

                                    if (not l_0_59 or l_0_59) and l_0_60 then
                                      return mp.CLEAN
                                    end
                                    -- DECOMPILER ERROR at PC608: Overwrote pending register: R9 in 'AssignReg'

                                    -- DECOMPILER ERROR at PC611: Overwrote pending register: R9 in 'AssignReg'

                                    if ((l_0_59 and not l_0_61) or not l_0_8.Known_VulnerableDll) and not l_0_8.POTENTIAL_SIDE_LOADING then
                                      return mp.CLEAN
                                    end
                                    -- DECOMPILER ERROR at PC625: Overwrote pending register: R35 in 'AssignReg'
                                    ...
                                    do
                                      do
                                        ...
                                        -- DECOMPILER ERROR at PC662: Overwrote pending register: R31 in 'AssignReg'

                                        do return l_0_59.CLEAN end
                                        -- DECOMPILER ERROR at PC665: freeLocal<0 in 'ReleaseLocals'
