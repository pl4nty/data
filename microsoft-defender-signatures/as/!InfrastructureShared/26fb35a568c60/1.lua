...
-- Command line: lua\!InfrastructureShared\26fb35a568c60\1.luac 
    ...
    if (sysio.GetFileSize)(l_0_4) <= 65536 or not 65536 then
      ...
      do
        do
          ...
          if (string.find)(l_0_9, "sdbf", "msxsl.exe", true) ~= nil and (string.find)(l_0_9, "n\000t\000d\000l\000l\000.\000d\000l\000l\000", 1, true) ~= nil then
