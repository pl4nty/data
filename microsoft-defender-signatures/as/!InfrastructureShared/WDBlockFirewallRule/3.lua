...
-- Command line: lua\!InfrastructureShared\WDBlockFirewallRule\3.luac 
...
Infrastructure_ScanWDFirewallBlockRules = function()
  ...
  l_1_0["nissrv.exe"] = true
  l_1_0["mpdefendercoreservice.exe"] = true
  l_1_0["sensendr.exe"] = true
  l_1_0["sensetvm.exe"] = true
  l_1_0["smartscreen.exe"] = true
  local l_1_1 = {}
  l_1_1.sense = true
  ...
  -- DECOMPILER ERROR at PC112: Confused about usage of register R6 for local variables in 'ReleaseLocals'
