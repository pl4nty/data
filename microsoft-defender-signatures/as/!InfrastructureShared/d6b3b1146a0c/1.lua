...
if (this_sigattrlog[5]).matched and (this_sigattrlog[5]).utf8p2 ~= nil then
  ...
  local l_0_1 = {}
  -- DECOMPILER ERROR at PC56: No list found for R1 , SetList fails
  ...
  do
    ...
    -- DECOMPILER ERROR at PC111: Overwrote pending register: R0 in 'AssignReg'

    -- DECOMPILER ERROR at PC115: Unhandled construct in 'MakeBoolean' P3
