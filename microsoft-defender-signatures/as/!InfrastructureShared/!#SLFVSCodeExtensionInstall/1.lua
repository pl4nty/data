...
-- Command line: lua\!InfrastructureShared\!#SLFVSCodeExtensionInstall\1.luac 
...
if l_0_3:find("\\extensions\\", 1, true) == nil then
  return mp.CLEAN
end
return mp.INFECTED
