...
-- Command line: lua\!InfrastructureShared\181b350c23739\1.luac 
...
do
  ...
  if (this_sigattrlog[7]).matched and (this_sigattrlog[7]).utf8p2 ~= nil then
    ...
    if (sysio.IsFileExists)((this_sigattrlog[7]).utf8p2) and (mp.IsKnownFriendlyFile)((this_sigattrlog[7]).utf8p2, true, false) == false then
      (bm.add_threat_file)((this_sigattrlog[7]).utf8p2)
    end
