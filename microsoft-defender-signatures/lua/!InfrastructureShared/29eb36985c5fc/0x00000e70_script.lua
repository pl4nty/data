...
-- Command line: lua\!InfrastructureShared\29eb36985c5fc\0x00000e70_luac 
...
do
  ...
  return l_2_1
            ...
            local l_0_10 = {SIG_CONTEXT = "BM", CONTENT_SOURCE = "SUSAPD-A", PROCESS_CONTEXT = "powershell.exe", FILELESS = "true", CMDLINE_URL = "true"}
