...
-- Command line: lua\!InfrastructureShared\1b7b36bba7c4a\0x000003b3_luac 
      ...
      do
        ...
        do
          if (not (this_sigattrlog[5]).matched or (this_sigattrlog[5]).utf8p2 == nil or (this_sigattrlog[6]).matched) and (this_sigattrlog[6]).utf8p2 ~= nil then
            local l_0_8, l_0_11, l_0_14, l_0_19, l_0_20 = , (this_sigattrlog[2]).utf8p2
          else
          end
          if not (this_sigattrlog[7]).matched or (this_sigattrlog[7]).utf8p2 == nil or (this_sigattrlog[7]).utf8p2 then
            do
              if (this_sigattrlog[8]).matched and (this_sigattrlog[8]).utf8p1 ~= nil then
                local l_0_12, l_0_15, l_0_16, l_0_17 = (this_sigattrlog[8]).utf8p1
              end
