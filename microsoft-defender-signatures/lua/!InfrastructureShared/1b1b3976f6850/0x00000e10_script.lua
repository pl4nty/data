...
-- Command line: lua\!InfrastructureShared\1b1b3976f6850\0x00000e10_luac 
...
do
  ...
  if (l_0_8.urls)[l_0_0] and ((l_0_8.urls)[l_0_0]).determination == 2 and ((l_0_8.urls)[l_0_0]).confidence >= 60 then
    return mp.INFECTED
  end
  return mp.CLEAN
end
