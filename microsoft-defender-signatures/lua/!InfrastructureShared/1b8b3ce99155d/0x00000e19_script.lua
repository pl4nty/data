...
-- Command line: lua\!InfrastructureShared\1b8b3ce99155d\0x00000e19_luac 
...
for l_0_4 = mp.SIGATTR_LOG_SZ, 1, -1 do
  ...
  if l_0_5.matched and l_0_5.attribute == 16400 and l_0_5.utf8p2 then
    ...
    local l_0_7 = "(aduser|adgroup|dir|net|nltest|qwinsta|quser|reg\\.exe|tasklist|whoami)"
    ...
    if l_0_8 then
      ...
      AppendToRollingQueue("PFApp_Pid_ExploratoryCommands", l_0_0.ppid, l_0_6, 1800, 100, 0)
    end
  end
end
return mp.INFECTED
