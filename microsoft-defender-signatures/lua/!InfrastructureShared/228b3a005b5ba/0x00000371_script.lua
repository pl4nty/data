...
-- Command line: lua\!InfrastructureShared\228b3a005b5ba\0x00000371_luac 
...
if (string.find)(l_0_2, l_0_4, 3, true) then
  TrackPidAndTechniqueBM("BM", "T1036.005", "DefenseEvasion_Masquerading_MatchLegitimateNameLocation_cp")
  addRelatedProcess()
  reportRelatedBmHits()
