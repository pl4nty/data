...
-- Command line: lua\!InfrastructureShared\af4b324b28b65\0x000000d8_luac 
...
do
  ...
  l_0_12 = l_0_12({Process = l_0_1, DLL = l_0_0, DLLHidden = l_0_11, ProcessCreateTime = l_0_6, DLLCreateTime = l_0_7})
  ;
