...
-- Command line: lua\!InfrastructureShared\!#ALFLinuxFileChangeInRestrictedPath\0x00000b6e_luac 
...
for l_0_7,l_0_8 in ("/ansible")("/snap/") do
...
do
  ...
  for l_0_13,l_0_14 in ("/var/tmp/")("/tmp/") do
    ...
    if ("/srv/ftp/")("/var/spool/", 1, #l_0_14) == l_0_14 then
      return mp.INFECTED
    end
  end
