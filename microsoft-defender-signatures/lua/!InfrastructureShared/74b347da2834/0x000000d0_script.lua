...
-- Command line: lua\!InfrastructureShared\74b347da2834\0x000000d0_luac 
...
if (this_sigattrlog[1]).matched and (this_sigattrlog[1]).utf8p2 ~= nil then
  ...
  if IsHostAttackServerCloudChk(l_0_2.host, "Behavior:Win32/ActiveConnToAttackerServer.E!blk", l_0_0.image_path, l_0_0.command_line, "RDP") then
