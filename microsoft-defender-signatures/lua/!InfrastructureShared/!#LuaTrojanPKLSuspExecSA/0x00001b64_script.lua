...
-- Command line: lua\!InfrastructureShared\!#LuaTrojanPKLSuspExecSA\0x00001b64_luac 
...
if contains(l_0_4, {"\\jedi\\", "CPython-", ":\\Program Files", "\\search-structural\\pycode\\"}) then
  return mp.CLEAN
end
