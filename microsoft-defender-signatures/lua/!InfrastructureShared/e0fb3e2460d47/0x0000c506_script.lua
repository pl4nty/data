...
-- Command line: lua\!InfrastructureShared\e0fb3e2460d47\0x0000c506_luac 
                                                                                  ...
                                                                                  if (this_sigattrlog[59]).matched then
                                                                                    ...
                                                                                    if (this_sigattrlog[60]).matched then
                                                                                      ...
                                                                                      if (this_sigattrlog[61]).matched then
                                                                                        l_0_0 = 54
                                                                                        l_0_1 = (this_sigattrlog[61]).utf8p1
                                                                                      else
                                                                                        if (this_sigattrlog[62]).matched then
                                                                                          l_0_0 = 55
                                                                                          l_0_1 = (this_sigattrlog[62]).utf8p1
                                                                                        else
                                                                                          if (this_sigattrlog[63]).matched then
                                                                                            l_0_0 = 58
                                                                                            l_0_1 = (this_sigattrlog[63]).utf8p1
                                                                                          else
                                                                                            if (this_sigattrlog[64]).matched then
                                                                                              l_0_0 = 59
                                                                                              l_0_1 = (this_sigattrlog[64]).utf8p1
                                                                                            else
...
l_0_6 = l_0_6()
-- DECOMPILER ERROR at PC853: Overwrote pending register: R8 in 'AssignReg'

l_0_8 = l_0_8(R9_PC855)
...
-- DECOMPILER ERROR at PC883: Confused about usage of register R8 for local variables in 'ReleaseLocals'
