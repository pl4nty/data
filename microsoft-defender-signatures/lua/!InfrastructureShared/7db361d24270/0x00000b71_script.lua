...
-- Command line: lua\!InfrastructureShared\7db361d24270\0x00000b71_luac 
  ...
  do
    ...
    do
      if (not (this_sigattrlog[4]).matched or (this_sigattrlog[4]).wp2 == nil or (this_sigattrlog[5]).matched) and (this_sigattrlog[5]).wp2 ~= nil then
        local l_0_2, l_0_3, l_0_4, l_0_5, l_0_6, l_0_7, l_0_8, l_0_9, l_0_10, l_0_11, l_0_12, l_0_13, l_0_14, l_0_15, l_0_16, l_0_17, l_0_18, l_0_19, l_0_20, l_0_21, l_0_22, l_0_23, l_0_24, l_0_25, l_0_26, l_0_27, l_0_28, l_0_29, l_0_30, l_0_31, l_0_32, l_0_33, l_0_34, l_0_35, l_0_36, l_0_37, l_0_38, l_0_39, l_0_40, l_0_41, l_0_42, l_0_43, l_0_44, l_0_45 = (string.lower)((this_sigattrlog[4]).utf8p2)
      else
      end
      ...
      if not (this_sigattrlog[6]).matched or (this_sigattrlog[6]).wp2 == nil or (string.lower)((this_sigattrlog[6]).utf8p2) then
        -- DECOMPILER ERROR at PC170: Unhandled construct in 'MakeBoolean' P3

        -- DECOMPILER ERROR at PC170: Unhandled construct in 'MakeBoolean' P3

        if ((string.find)((string.lower)((this_sigattrlog[6]).utf8p2), "copy-as-is", 1, true) and (string.find)((string.lower)((this_sigattrlog[6]).utf8p2), "/usr/share/rear", 1, true)) or not (string.find)((string.lower)((this_sigattrlog[6]).utf8p2), "/opt/conjur/backup/", 1, true) or (string.find)((string.lower)((this_sigattrlog[6]).utf8p2), "/foreman", 1, true) then
          return mp.CLEAN
        end
