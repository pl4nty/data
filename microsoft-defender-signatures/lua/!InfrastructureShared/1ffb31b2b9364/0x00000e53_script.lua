...
-- Command line: lua\!InfrastructureShared\1ffb31b2b9364\0x00000e53_luac 
...
if l_0_0 or l_0_1 then
    ...
    if (this_sigattrlog[8]).matched and not isnull((this_sigattrlog[8]).utf8p2) then
      ...
      if (this_sigattrlog[9]).matched and not isnull((this_sigattrlog[9]).utf8p2) then
        ...
        if (this_sigattrlog[10]).matched and not isnull((this_sigattrlog[10]).utf8p2) then
          ...
          if (this_sigattrlog[11]).matched and not isnull((this_sigattrlog[11]).utf8p2) then
            l_0_2 = (this_sigattrlog[11]).utf8p2
          else
            if (this_sigattrlog[12]).matched and not isnull((this_sigattrlog[12]).utf8p2) then
  ...
  if l_0_2 then
    ...
    if not isValidLocalDomain(l_0_4) then
      ...
      l_0_5.CONTENT_SOURCE = "SusGolang_B_SLIVER_C2"
      if (string.match)(l_0_4, "^https?://") then
        ...
        local l_0_9 = {}
        -- DECOMPILER ERROR at PC153: No list found for R9 , SetList fails
