...
-- Command line: lua\!InfrastructureShared\7db3b9d16a5d\0x00000e30_luac 
...
do
  ...
  return l_1_1
    ...
    for l_0_9,l_0_10 in ipairs(l_0_5) do
      local l_0_6 = {SIG_CONTEXT = "BM", CONTENT_SOURCE = "MSHTA_SCHTASKS_OFN", PROCESS_CONTEXT = "schtasks.exe", FILELESS = "true", CMDLINE_URL = "true"}
