...
-- Command line: lua\!InfrastructureShared\abb3f4c86b17\0x000000d7_luac 
...
local l_0_5, l_0_6, l_0_7 = ("NdrClientCall3")(this_sigattrlog[1], l_0_0)
;
(bm.add_related_string)((string.format)("%s_Debug", l_0_0), (this_sigattrlog[1]).utf8p2, bm.RelatedStringBMReport)
