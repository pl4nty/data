...
-- Command line: lua\!InfrastructureShared\536b316dcfed4\0x00000665_luac 
...
do
  ...
  if not (this_sigattrlog[28]).matched or (this_sigattrlog[28]).utf8p2 == nil or (string.lower)((this_sigattrlog[28]).utf8p2) then
    local l_0_3 = nil
