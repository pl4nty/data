...
-- Command line: lua\!InfrastructureShared\69b354abdca6\0x00001dd7_luac 
      ...
      for l_0_8,l_0_9 in ipairs(l_0_4) do
        ...
        do
          if R8_PC37.image_path == nil then
            local l_0_11, l_0_13, l_0_15 = (mp.bitand)(R8_PC37.reason_ex, 1) ~= 1 or not IsTacticObservedForPid(R8_PC37.ppid, "dbservice_childproc") or "none"
          end
