...
-- Command line: lua\!InfrastructureShared\TechniqueTracker\0x000012ef_luac 
...
IsLegacyOrgMachine = function()
  ...
  l_61_0[l_61_1] = true
  l_61_1 = "e0c103d7-e635-4e0e-b800-9b31892842f4"
  l_61_0[l_61_1] = true
  l_61_1 = "e9323610-6354-4b09-a4aa-2307494bba43"
  l_61_0[l_61_1] = true
  l_61_1 = "0e2eb614-0a43-4328-9264-41c261c891b6"
  l_61_0[l_61_1] = true
  l_61_1 = versioning
...
IsExcludedHostCheck = function(l_74_0)
  -- function num : 0_73
  if l_74_0 == nil or l_74_0 == "" then
    return true
  end
  l_74_0 = l_74_0:lower()
  local l_74_1 = {}
  l_74_1["encrypted-tbn0.gstatic.com"] = true
  l_74_1["img.freepik.com"] = true
  l_74_1["api.engage.cloud.microsoft"] = true
  l_74_1["image.shutterstock.com"] = true
  l_74_1["cdn-icons-png.flaticon.com"] = true
  l_74_1["loop.cloud.microsoft"] = true
  l_74_1[";lanmanredirector"] = true
  l_74_1["login.microsoftonline.com"] = true
  l_74_1["login.live.com"] = true
  l_74_1["about:internet"] = true
  l_74_1["google.com"] = true
  return l_74_1[l_74_0]
end

TrackAttackerServer = function(l_75_0, l_75_1)
  -- function num : 0_74
  if not l_75_1 then
    l_75_1 = 3600
  end
  ...
  if l_75_2.host and l_75_2.host ~= "" then
    if GetRollingQueueKeyValue("SuspAttackServer", l_75_2.host) == nil then
      local l_75_3 = tostring(l_75_2.path)
    else
      do
        -- DECOMPILER ERROR at PC23: Confused about usage of register: R3 in 'UnsetPending'

        do
          local l_75_4, l_75_5 = l_75_3 .. "|" .. tostring(l_75_2.path)
          -- DECOMPILER ERROR at PC32: Confused about usage of register: R3 in 'UnsetPending'

          AppendToRollingQueue("SuspAttackServer", l_75_2.host, l_75_4, 3600)
        end
      end
    end
  end
...
IsHostAttackServerCloudChk = function(l_76_0, l_76_1, l_76_2, l_76_3, l_76_4)
  -- function num : 0_75
  if not l_76_0 then
    return false
  end
  local l_76_5 = ExtractPartsFromUri(l_76_0)
  if l_76_5.host and l_76_5.host ~= "" then
    l_76_0 = l_76_5.host
  end
  if IsKeyInRollingQueue("CleanHostCache", l_76_0) then
    return false
  end
  if IsExcludedHostCheck(l_76_0) then
    return false
  end
  local l_76_6 = IsKeyInRollingQueue("SuspAttackServer", l_76_5.host, false)
  if l_76_6 then
    return l_76_6
  end
  local l_76_7 = {}
  l_76_7.SIG_CONTEXT = "ATTACKSERVER"
  l_76_7.TAG = "NOLOOKUP"
  if l_76_1 ~= nil and l_76_1 ~= "" then
    l_76_7.CONTENT_SOURCE = l_76_1
  end
  if l_76_2 ~= nil and l_76_2 ~= "" then
    l_76_7.PROCESS_CONTEXT = l_76_2
  end
  if l_76_3 ~= nil and l_76_3 ~= "" then
    l_76_7.PROCESS_CMDLINE = l_76_3
  end
  if l_76_4 ~= nil and l_76_4 ~= "" then
    l_76_7.SCENARIO = l_76_4
  end
  local l_76_8 = SafeGetUrlReputation
  local l_76_9 = {}
  ...
  l_76_8 = l_76_8(l_76_9, l_76_0, false, 2000)
  l_76_9 = l_76_8.urls
  l_76_9 = l_76_9[l_76_0]
  if l_76_9 then
    l_76_9 = l_76_8.urls
    l_76_9 = l_76_9[l_76_0]
    l_76_9 = l_76_9.determination
    if l_76_9 == 2 then
      l_76_9 = TrackAttackerServer
      l_76_9(l_76_0)
      l_76_9 = true
      return l_76_9
    else
      l_76_9 = AppendToRollingQueue
      l_76_9("CleanHostCache", l_76_0, true, 36000)
    end
    l_76_9 = false
    return l_76_9
  end
...
IsHostAttackServer = function(l_77_0, l_77_1)
  -- function num : 0_76
  local l_77_2 = false
  if not l_77_1 then
    l_77_1 = false
  end
  local l_77_3 = ExtractPartsFromUri(l_77_0)
  if l_77_3.host and l_77_3.host ~= "" then
    if not l_77_1 then
      l_77_1 = false
    end
    if IsExcludedHostCheck(l_77_3.host) then
      return false
    end
    l_77_2 = IsKeyInRollingQueue("SuspAttackServer", l_77_3.host, l_77_1)
    return l_77_2
  end
  return false
end

IsDiscoveryCollectionThresholdMetLinux = function(l_78_0)
  -- function num : 0_77
  if l_78_0 == nil then
    return false
  end
  do
    if ((((((((((((((IsTechniqueObservedForPid(l_78_0, "T1057") or IsTacticObservedForPid(l_78_0, "Discovery_Process")) and IsTechniqueObservedForPid(l_78_0, "T1552")) or IsTacticObservedForPid(l_78_0, "CredentialAccess")) and IsTechniqueObservedForPid(l_78_0, "T1083")) or IsTacticObservedForPid(l_78_0, "Discovery_FileAndDirectoryDiscovery")) and IsTechniqueObservedForPid(l_78_0, "T1074")) or IsTacticObservedForPid(l_78_0, "Collection_DataStaged")) and IsTechniqueObservedForPid(l_78_0, "T1049")) or IsTacticObservedForPid(l_78_0, "Discovery_NetworkConnectionsDiscovery")) and IsTechniqueObservedForPid(l_78_0, "T1033")) or IsTacticObservedForPid(l_78_0, "Discovery_SystemOwnerUserDiscovery")) and IsTechniqueObservedForPid(l_78_0, "T1518")) or IsTacticObservedForPid(l_78_0, "Discovery_SoftwareDiscovery")) and IsTechniqueObservedForPid(l_78_0, "T1082")) or IsTacticObservedForPid(l_78_0, "Discovery_SystemInfoDiscovery") then
      local l_78_1 = 0 + 15 + 16 + 15 + 15 + 15 + 8 + 8 + 8
    end
    ...
    if 45 <= l_78_1 and l_78_1 <= 100 then
      return true
    end
    return false
  end
...
IsDetectionThresholdMetLinuxWrapper = function(l_79_0, l_79_1, l_79_2, l_79_3, l_79_4)
  -- function num : 0_78
  local l_79_5 = 0
  local l_79_6 = true
  local l_79_7 = nil
  if IsDetectionThresholdMetLinux(l_79_0) then
    return true
  end
  if l_79_6 then
    local l_79_8 = GetTacticsTableForPid(l_79_0)
    local l_79_9 = GetTechniquesTableForPid(l_79_0)
    if l_79_8 == nil or l_79_9 == nil then
      return false
    end
    for l_79_13,l_79_14 in pairs(l_79_8) do
      if l_79_13 ~= nil then
        if l_79_7 == nil then
          l_79_7 = l_79_13:lower()
        else
          l_79_7 = l_79_7 .. " | " .. l_79_13:lower()
        end
      end
      if l_79_14 ~= nil then
        l_79_5 = l_79_5 + l_79_14
      end
    end
    if l_79_7 ~= nil then
      if l_79_7:find("collection", 1, true) and l_79_7:find("discovery", 1, true) and l_79_7:find("exfiltration", 1, true) then
        return true
      end
      if (l_79_7:find("initialaccess", 1, true) or l_79_7:find("collection", 1, true) or l_79_7:find("discovery", 1, true) or l_79_7:find("execution", 1, true) or l_79_7:find("credentialaccess", 1, true) or l_79_7:find("defenseevasion", 1, true) or l_79_7:find("lateralmovement", 1, true) or l_79_7:find("privilegeescalation", 1, true)) and l_79_7:find("persistence", 1, true) and (l_79_7:find("exfiltration", 1, true) or l_79_7:find("commandandcontrol", 1, true)) then
        return true
      end
      if ((not l_79_7:find("collection", 1, true) and not l_79_7:find("discovery", 1, true) and not l_79_7:find("execution", 1, true)) or (not l_79_7:find("credentialaccess", 1, true) and not l_79_7:find("defenseevasion", 1, true) and not l_79_7:find("lateralmovement", 1, true)) or (l_79_7:find("persistence", 1, true) or l_79_7:find("exfiltration", 1, true) or l_79_7:find("commandandcontrol", 1, true))) then
        return true
      end
      if (l_79_7:find("initialaccess", 1, true) or l_79_7:find("collection", 1, true) or l_79_7:find("discovery", 1, true) or l_79_7:find("execution", 1, true) or l_79_7:find("credentialaccess", 1, true) or l_79_7:find("defenseevasion", 1, true) or l_79_7:find("lateralmovement", 1, true) or l_79_7:find("privilegeescalation", 1, true)) and l_79_7:find("exfiltration", 1, true) and l_79_7:find("commandandcontrol", 1, true) then
        return true
      end
    end
    do
      do
        if ((((((((((not l_79_7:find("initialaccess", 1, true) or l_79_7:find("execution", 1, true)) and not l_79_7:find("persistence", 1, true)) or l_79_7:find("privilegeescalation", 1, true)) and not l_79_7:find("defenseevasion", 1, true)) or l_79_7:find("credentialaccess", 1, true)) and not l_79_7:find("discovery", 1, true)) or l_79_7:find("lateralmovement", 1, true)) and not l_79_7:find("collection", 1, true)) or l_79_7:find("commandandcontrol", 1, true)) and not l_79_7:find("exfiltration", 1, true)) or l_79_7:find("impact", 1, true) then
          local l_79_15 = 0 + 1 + 1 + 2 + 1 + 1 + 1 + 1 + 2 + 1 + 2 + 2 + 2
        end
        ...
        if 4 <= l_79_15 and l_79_15 <= 17 then
          return true
        end
        return false
      end
...
TT_SendTechniqueIntents = function(l_80_0)
  -- function num : 0_79
  TT_SendBMSigTrigger(l_80_0, "send_ttdata", "send_ttdata", 30)
end

TT_IsProdCriticalService = function(l_81_0)
  -- function num : 0_80
  if l_81_0:find("veeam.backup", 1, true) or l_81_0:find("backupexec", 1, true) or l_81_0:find("netbackup", 1, true) then
    return true
  end
  if l_81_0:find("msexchange", 1, true) or l_81_0:find("microsoft.exchange", 1, true) or l_81_0:find("acronis", 1, true) then
    return true
  end
  if l_81_0:find("veeamenterprise", 1, true) or l_81_0:find("oracle", 1, true) or l_81_0:find("sqlagent", 1, true) then
    return true
  end
  local l_81_1 = {}
  l_81_1.acronisagent = true
  l_81_1.acrsch2svc = true
  l_81_1.avpsus = true
  l_81_1["bmr boot service"] = true
  l_81_1["bmr mtftp service"] = true
  l_81_1.caarcupdatesvc = true
  l_81_1.casad2dwebsvc = true
  l_81_1.ccevtmgr = true
  l_81_1.ccsetmgr = true
  l_81_1.defwatch = true
  l_81_1.dns = true
  l_81_1.dnssvc = true
  l_81_1.eventlog = true
  l_81_1.gxblr = true
  l_81_1.gxcimgr = true
  l_81_1.gxcvd = true
  l_81_1.gxfwd = true
  l_81_1.gxvss = true
  l_81_1.intuit = true
  l_81_1["intuit.quickbooks.fcs"] = true
  l_81_1.mcafeedlpagentservice = true
  l_81_1.memtas = true
  l_81_1.mepocs = true
  l_81_1.mfewc = true
  l_81_1.mpssvc = true
  l_81_1["msdtc.exe"] = true
  l_81_1.msdtc = true
  l_81_1["msexchange transport logsearch"] = true
  l_81_1.msexchangeantispamupdate = true
  l_81_1.msexchangecompliance = true
  l_81_1.msexchangedagmgmt = true
  l_81_1.msexchangedelivery = true
  l_81_1.msexchangediagnostics = true
  l_81_1.msexchangeedgesync = true
  l_81_1.msexchangefastsearch = true
  l_81_1.msexchangefrontendtransport = true
  l_81_1.msexchangehm = true
  l_81_1.msexchangehmrecovery = true
  l_81_1.msexchangeimap4 = true
  l_81_1.msexchangeimap4be = true
  l_81_1.msexchangeis = true
  l_81_1.msexchangemailboxassistants = true
  l_81_1.msexchangemailboxreplication = true
  l_81_1.msexchangenotificationsbroker = true
  l_81_1.msexchangepop3 = true
  l_81_1.msexchangepop3be = true
  l_81_1.msexchangerepl = true
  l_81_1.msexchangerpc = true
  l_81_1.msexchangeservicehost = true
  l_81_1.msexchangesubmission = true
  l_81_1.msexchangethrottling = true
  l_81_1.msexchangetransport = true
  l_81_1.msexchangeum = true
  l_81_1.msexchangeumcr = true
  l_81_1.msmpeng = true
  l_81_1.mssense = true
  l_81_1.mspub = true
  l_81_1.mssqlserver = true
  l_81_1.mssqlsvc = true
  l_81_1.mysql = true
  l_81_1.mysql80 = true
  l_81_1.pdvfsservice = true
  l_81_1.perfhost = true
  l_81_1.pop3svc = true
  l_81_1.profsvc = true
  l_81_1.qbcfmonitorservice = true
  l_81_1.qbfcservice = true
  l_81_1.qbidpservice = true
  l_81_1.rtvscan = true
  l_81_1.samss = true
  l_81_1["sacsvr.exe"] = true
  l_81_1.savroam = true
  l_81_1["savservice.exe"] = true
  l_81_1.sdrsvc = true
  l_81_1.sense = true
  l_81_1.sophos = true
  l_81_1.sql = true
  l_81_1["sqlagent.exe"] = true
  l_81_1["sqlbrowser.exe"] = true
  l_81_1.sqlbrowser = true
  l_81_1["sqlceip.exe"] = true
  l_81_1.sqlserveragent = true
  l_81_1["sqlservr.exe"] = true
  l_81_1.sqltelemetry = true
  l_81_1["sqlwriter.exe"] = true
  l_81_1.sqlwriter = true
  l_81_1.stc_raw_agent = true
  l_81_1.usermanager = true
  l_81_1.vboxdrv = true
  l_81_1.vds = true
  l_81_1["veeam.guest.interaction.proxy.exe"] = true
  l_81_1.veeam = true
  l_81_1.veeamcatalogsvc = true
  l_81_1.veeamcloudsvc = true
  l_81_1.veeamdeploymentservice = true
  l_81_1["veeamdeploymentsvc.exe"] = true
  l_81_1.veeamdeploysvc = true
  l_81_1["veeamfilesysvsssvc.exe"] = true
  l_81_1["veeamnfssvc.exe"] = true
  l_81_1.veeamnfssvc = true
  l_81_1["veeamtransportsvc.exe"] = true
  l_81_1.veeamtransportsvc = true
  l_81_1.vmcompute = true
  l_81_1.vmms = true
  l_81_1["vmwp.exe"] = true
  l_81_1.vsnapvss = true
  l_81_1.vss = true
  l_81_1.vsssvc = true
  l_81_1.webthreatdefsvc = true
  l_81_1.wecsvc = true
  l_81_1.wer = true
  l_81_1.wersvc = true
  l_81_1.windefend = true
  l_81_1.w3svc = true
  l_81_1["w3wp.exe"] = true
  l_81_1.yoobackup = true
  l_81_1.yooit = true
  if l_81_1[l_81_0] then
    return true
  end
  return false
end

Has_NetworkLogonSuccess = function(l_82_0)
  -- function num : 0_81
  if not l_82_0 then
    l_82_0 = false
  end
  local l_82_1 = GetRollingQueue("has_networklogonsuccess")
  if not l_82_1 then
    return false
  end
  if l_82_0 then
    local l_82_2 = safeJsonSerialize(l_82_1)
    if l_82_2 ~= nil then
      l_82_2 = (MpCommon.Base64Encode)(l_82_2)
      ;
      (bm.add_related_string)("NetworkLogonSuccess", l_82_2, bm.RelatedStringBMReport)
    end
  else
    do
      do
        local l_82_3 = safeJsonSerialize(l_82_1)
        if l_82_3 ~= nil then
          l_82_3 = (MpCommon.Base64Encode)(l_82_3)
          set_research_data("NetworkLogonSuccess", l_82_3, false)
        end
        return true
      end
    end
...
isLolBasFilename = function(l_83_0, l_83_1)
  -- function num : 0_82
  if l_83_0 == nil or #l_83_0 <= 5 then
    return 
  end
  l_83_0 = (string.lower)(l_83_0)
  local l_83_2 = {}
  l_83_2["addinutil.exe"] = "binaries"
  l_83_2["appinstaller.exe"] = "binaries"
  l_83_2["aspnet_compiler.exe"] = "binaries"
  l_83_2["at.exe"] = "binaries"
  l_83_2["atbroker.exe"] = "binaries"
  l_83_2["bash.exe"] = "binaries"
  l_83_2["bitsadmin.exe"] = "binaries"
  l_83_2["certoc.exe"] = "binaries"
  l_83_2["certreq.exe"] = "binaries"
  l_83_2["certutil.exe"] = "binaries"
  l_83_2["cmd.exe"] = "binaries"
  l_83_2["cmdkey.exe"] = "binaries"
  l_83_2["cmdl32.exe"] = "binaries"
  l_83_2["cmstp.exe"] = "binaries"
  l_83_2["colorcpl.exe"] = "binaries"
  l_83_2["computerdefaults.exe"] = "binaries"
  l_83_2["configsecuritypolicy.exe"] = "binaries"
  l_83_2["conhost.exe"] = "binaries"
  l_83_2["control.exe"] = "binaries"
  l_83_2["csc.exe"] = "binaries"
  l_83_2["cscript.exe"] = "binaries"
  l_83_2["customshellhost.exe"] = "binaries"
  l_83_2["datasvcutil.exe"] = "binaries"
  l_83_2["desktopimgdownldr.exe"] = "binaries"
  l_83_2["devicecredentialdeployment.exe"] = "binaries"
  l_83_2["dfsvc.exe"] = "binaries"
  l_83_2["diantz.exe"] = "binaries"
  l_83_2["diskshadow.exe"] = "binaries"
  l_83_2["dnscmd.exe"] = "binaries"
  l_83_2["esentutl.exe"] = "binaries"
  l_83_2["eventvwr.exe"] = "binaries"
  l_83_2["expand.exe"] = "binaries"
  l_83_2["explorer.exe"] = "binaries"
  l_83_2["extexport.exe"] = "binaries"
  l_83_2["extrac32.exe"] = "binaries"
  l_83_2["findstr.exe"] = "binaries"
  l_83_2["finger.exe"] = "binaries"
  l_83_2["fltmc.exe"] = "binaries"
  l_83_2["forfiles.exe"] = "binaries"
  l_83_2["fsutil.exe"] = "binaries"
  l_83_2["ftp.exe"] = "binaries"
  l_83_2["gpscript.exe"] = "binaries"
  l_83_2["hh.exe"] = "binaries"
  l_83_2["imewdbld.exe"] = "binaries"
  l_83_2["ie4uinit.exe"] = "binaries"
  l_83_2["iediagcmd.exe"] = "binaries"
  l_83_2["ieexec.exe"] = "binaries"
  l_83_2["ilasm.exe"] = "binaries"
  l_83_2["infdefaultinstall.exe"] = "binaries"
  l_83_2["installutil.exe"] = "binaries"
  l_83_2["jsc.exe"] = "binaries"
  l_83_2["ldifde.exe"] = "binaries"
  l_83_2["makecab.exe"] = "binaries"
  l_83_2["mavinject.exe"] = "binaries"
  l_83_2["microsoft.workflow.compiler.exe"] = "binaries"
  l_83_2["mmc.exe"] = "binaries"
  l_83_2["mpcmdrun.exe"] = "binaries"
  l_83_2["msbuild.exe"] = "binaries"
  l_83_2["msconfig.exe"] = "binaries"
  l_83_2["msdt.exe"] = "binaries"
  l_83_2["msedge.exe"] = "binaries"
  l_83_2["mshta.exe"] = "binaries"
  l_83_2["msiexec.exe"] = "binaries"
  l_83_2["netsh.exe"] = "binaries"
  l_83_2["ngen.exe"] = "binaries"
  l_83_2["odbcconf.exe"] = "binaries"
  l_83_2["offlinescannershell.exe"] = "binaries"
  l_83_2["onedrivestandaloneupdater.exe"] = "binaries"
  l_83_2["pcalua.exe"] = "binaries"
  l_83_2["pcwrun.exe"] = "binaries"
  l_83_2["pktmon.exe"] = "binaries"
  l_83_2["pnputil.exe"] = "binaries"
  l_83_2["presentationhost.exe"] = "binaries"
  l_83_2["print.exe"] = "binaries"
  l_83_2["printbrm.exe"] = "binaries"
  l_83_2["provlaunch.exe"] = "binaries"
  l_83_2["psr.exe"] = "binaries"
  l_83_2["rasautou.exe"] = "binaries"
  l_83_2["rdrleakdiag.exe"] = "binaries"
  l_83_2["reg.exe"] = "binaries"
  l_83_2["regasm.exe"] = "binaries"
  l_83_2["regedit.exe"] = "binaries"
  l_83_2["regini.exe"] = "binaries"
  l_83_2["register-cimprovider.exe"] = "binaries"
  l_83_2["regsvcs.exe"] = "binaries"
  l_83_2["regsvr32.exe"] = "binaries"
  l_83_2["replace.exe"] = "binaries"
  l_83_2["rpcping.exe"] = "binaries"
  l_83_2["rundll32.exe"] = "binaries"
  l_83_2["runexehelper.exe"] = "binaries"
  l_83_2["runonce.exe"] = "binaries"
  l_83_2["runscripthelper.exe"] = "binaries"
  l_83_2["sc.exe"] = "binaries"
  l_83_2["schtasks.exe"] = "binaries"
  l_83_2["scriptrunner.exe"] = "binaries"
  l_83_2["setres.exe"] = "binaries"
  l_83_2["settingsynchost.exe"] = "binaries"
  l_83_2["ssh.exe"] = "binaries"
  l_83_2["stordiag.exe"] = "binaries"
  l_83_2["syncappvpublishingserver.exe"] = "binaries"
  l_83_2["tar.exe"] = "binaries"
  l_83_2["ttdinject.exe"] = "binaries"
  l_83_2["tttracer.exe"] = "binaries"
  l_83_2["unregmp2.exe"] = "binaries"
  l_83_2["vbc.exe"] = "binaries"
  l_83_2["verclsid.exe"] = "binaries"
  l_83_2["wab.exe"] = "binaries"
  l_83_2["wbadmin.exe"] = "binaries"
  l_83_2["winget.exe"] = "binaries"
  l_83_2["wlrmdr.exe"] = "binaries"
  l_83_2["wmic.exe"] = "binaries"
  l_83_2["workfolders.exe"] = "binaries"
  l_83_2["wscript.exe"] = "binaries"
  l_83_2["wsreset.exe"] = "binaries"
  l_83_2["wuauclt.exe"] = "binaries"
  l_83_2["xwizard.exe"] = "binaries"
  l_83_2["msedge_proxy.exe"] = "binaries"
  l_83_2["msedgewebview2.exe"] = "binaries"
  l_83_2["wt.exe"] = "binaries"
  l_83_2["advpack.dll"] = "libraries"
  l_83_2["desk.cpl"] = "libraries"
  l_83_2["dfshim.dll"] = "libraries"
  l_83_2["ieadvpack.dll"] = "libraries"
  l_83_2["ieframe.dll"] = "libraries"
  l_83_2["mshtml.dll"] = "libraries"
  l_83_2["pcwutl.dll"] = "libraries"
  l_83_2["scrobj.dll"] = "libraries"
  l_83_2["setupapi.dll"] = "libraries"
  l_83_2["shdocvw.dll"] = "libraries"
  l_83_2["shell32.dll"] = "libraries"
  l_83_2["shimgvw.dll"] = "libraries"
  l_83_2["syssetup.dll"] = "libraries"
  l_83_2["url.dll"] = "libraries"
  l_83_2["zipfldr.dll"] = "libraries"
  l_83_2["comsvcs.dll"] = "libraries"
  l_83_2["acccheckconsole.exe"] = "othermsbinaries"
  l_83_2["adplus.exe"] = "othermsbinaries"
  l_83_2["agentexecutor.exe"] = "othermsbinaries"
  l_83_2["appcert.exe"] = "othermsbinaries"
  l_83_2["appvlp.exe"] = "othermsbinaries"
  l_83_2["bginfo.exe"] = "othermsbinaries"
  l_83_2["cdb.exe"] = "othermsbinaries"
  l_83_2["coregen.exe"] = "othermsbinaries"
  l_83_2["createdump.exe"] = "othermsbinaries"
  l_83_2["csi.exe"] = "othermsbinaries"
  l_83_2["defaultpack.exe"] = "othermsbinaries"
  l_83_2["devinit.exe"] = "othermsbinaries"
  l_83_2["devtoolslauncher.exe"] = "othermsbinaries"
  l_83_2["dnx.exe"] = "othermsbinaries"
  l_83_2["dotnet.exe"] = "othermsbinaries"
  l_83_2["dsdbutil.exe"] = "othermsbinaries"
  l_83_2["dtutil.exe"] = "othermsbinaries"
  l_83_2["dump64.exe"] = "othermsbinaries"
  l_83_2["dumpminitool.exe"] = "othermsbinaries"
  l_83_2["dxcap.exe"] = "othermsbinaries"
  l_83_2["excel.exe"] = "othermsbinaries"
  l_83_2["fsi.exe"] = "othermsbinaries"
  l_83_2["fsianycpu.exe"] = "othermsbinaries"
  l_83_2["mftrace.exe"] = "othermsbinaries"
  l_83_2["microsoft.nodejstools.pressanykey.exe"] = "othermsbinaries"
  l_83_2["msaccess.exe"] = "othermsbinaries"
  l_83_2["msdeploy.exe"] = "othermsbinaries"
  l_83_2["msohtmed.exe"] = "othermsbinaries"
  l_83_2["mspub.exe"] = "othermsbinaries"
  l_83_2["msxsl.exe"] = "othermsbinaries"
  l_83_2["ntdsutil.exe"] = "othermsbinaries"
  l_83_2["openconsole.exe"] = "othermsbinaries"
  l_83_2["powerpnt.exe"] = "othermsbinaries"
  l_83_2["procdump.exe"] = "othermsbinaries"
  l_83_2["protocolhandler.exe"] = "othermsbinaries"
  l_83_2["rcsi.exe"] = "othermsbinaries"
  l_83_2["remote.exe"] = "othermsbinaries"
  l_83_2["sqldumper.exe"] = "othermsbinaries"
  l_83_2["sqlps.exe"] = "othermsbinaries"
  l_83_2["sqltoolsps.exe"] = "othermsbinaries"
  l_83_2["squirrel.exe"] = "othermsbinaries"
  l_83_2["te.exe"] = "othermsbinaries"
  l_83_2["teams.exe"] = "othermsbinaries"
  l_83_2["testwindowremoteagent.exe"] = "othermsbinaries"
  l_83_2["tracker.exe"] = "othermsbinaries"
  l_83_2["update.exe"] = "othermsbinaries"
  l_83_2["vsdiagnostics.exe"] = "othermsbinaries"
  l_83_2["vsiisexelauncher.exe"] = "othermsbinaries"
  l_83_2["visio.exe"] = "othermsbinaries"
  l_83_2["visualuiaverifynative.exe"] = "othermsbinaries"
  l_83_2["vslaunchbrowser.exe"] = "othermsbinaries"
  l_83_2["vshadow.exe"] = "othermsbinaries"
  l_83_2["vsjitdebugger.exe"] = "othermsbinaries"
  l_83_2["wfc.exe"] = "othermsbinaries"
  l_83_2["winproj.exe"] = "othermsbinaries"
  l_83_2["winword.exe"] = "othermsbinaries"
  l_83_2["wsl.exe"] = "othermsbinaries"
  l_83_2["devtunnel.exe"] = "othermsbinaries"
  l_83_2["vsls-agent.exe"] = "othermsbinaries"
  l_83_2["vstest.console.exe"] = "othermsbinaries"
  l_83_2["winfile.exe"] = "othermsbinaries"
  l_83_2["xsd.exe"] = "othermsbinaries"
  l_83_2["cl_loadassembly.ps1"] = "scripts"
  l_83_2["cl_mutexverifiers.ps1"] = "scripts"
  l_83_2["cl_invocation.ps1"] = "scripts"
  l_83_2["launch-vsdevshell.ps1"] = "scripts"
  l_83_2["manage-bde.wsf"] = "scripts"
  l_83_2["pubprn.vbs"] = "scripts"
  l_83_2["syncappvpublishingserver.vbs"] = "scripts"
  l_83_2["utilityfunctions.ps1"] = "scripts"
  l_83_2["winrm.vbs"] = "scripts"
  l_83_2["pester.bat"] = "scripts"
  local l_83_3 = l_83_2[l_83_0]
  if l_83_3 == nil then
    return false
  end
  if l_83_1 == nil then
  ...
  l_83_1 = (string.lower)(l_83_1)
  if l_83_1 == l_83_3 then
    return true
  end
  return false
end
...
getOrgIdScrubbed = function()
  -- function num : 0_83
  local l_84_0 = (versioning.GetOrgID)()
  if l_84_0 ~= nil and #l_84_0 > 20 then
    return "PII_" .. (string.lower)(l_84_0)
  end
  return 
end
