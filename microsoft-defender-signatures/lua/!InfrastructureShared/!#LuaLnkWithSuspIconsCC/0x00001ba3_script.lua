...
-- Command line: lua\!InfrastructureShared\!#LuaLnkWithSuspIconsCC\0x00001ba3_luac 

-- params : ...
-- function num : 0
if not (mp.get_mpattribute)("Lua:LNK_Settings!RunMinimized") and not (mp.get_mpattribute)("Lua:FileOnIsoRoot") then
  return mp.CLEAN
end
            ...
            do
              do
                ...
                if not contains(l_0_18, {"odbcconf", "rundll32", "regsvr", "powershell", "calc", "wscript", "cscript", "mshta"}) or true == true then
                  ...
                  -- DECOMPILER ERROR at PC229: Confused about usage of register: R10 in 'UnsetPending'
