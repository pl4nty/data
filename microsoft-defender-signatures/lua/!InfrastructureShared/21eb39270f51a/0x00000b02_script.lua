...
-- Command line: lua\!InfrastructureShared\21eb39270f51a\0x00000b02_luac 
...
do
  ...
  do
    if (this_sigattrlog[11]).matched and (this_sigattrlog[11]).utf8p2 ~= nil then
      local l_0_2, l_0_4, l_0_7, l_0_11, l_0_13, l_0_16, l_0_20, l_0_23, l_0_27 = , (this_sigattrlog[11]).utf8p2
    end
    do
      if (this_sigattrlog[12]).matched and (this_sigattrlog[12]).utf8p2 ~= nil then
        local l_0_5, l_0_8, l_0_14, l_0_17, l_0_21, l_0_24, l_0_28 = , (this_sigattrlog[12]).utf8p2
      end
      do
        if (this_sigattrlog[13]).matched and (this_sigattrlog[13]).utf8p2 ~= nil then
          local l_0_9, l_0_18, l_0_25, l_0_29 = , (this_sigattrlog[13]).utf8p2
        end
