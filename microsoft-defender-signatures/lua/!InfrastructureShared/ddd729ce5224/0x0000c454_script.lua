...
-- Command line: lua\!InfrastructureShared\ddd729ce5224\0x0000c454_luac 
...
local l_0_8 = l_0_6
l_0_7 = l_0_7(l_0_8, {"powershell.exe", "cmd.exe", "mshta.exe", "curl.exe", "msiexec.exe"})
if not l_0_7 then
  l_0_7 = mp
  l_0_7 = l_0_7.CLEAN
  return l_0_7
...
if ExtractPartsFromUri(R9_PC139) == "" or ExtractPartsFromUri(R9_PC139) == nil then
  R9_PC139 = mp
  R9_PC139 = R9_PC139.CLEAN
  return R9_PC139
end
R9_PC139 = (ExtractPartsFromUri(R9_PC139)).host
if R9_PC139 ~= "" then
  R9_PC139 = (ExtractPartsFromUri(R9_PC139)).host
end
if R9_PC139 == nil then
  R9_PC139 = mp
  R9_PC139 = R9_PC139.CLEAN
  return R9_PC139
end
R9_PC139 = split
R9_PC139 = R9_PC139((ExtractPartsFromUri(R9_PC139)).host, "%.")
local l_0_9 = nil
if not R9_PC139 then
  return mp.CLEAN
end
local l_0_10 = nil
if not "." .. tostring(R9_PC139[#R9_PC139]) then
  return mp.CLEAN
end
-- DECOMPILER ERROR at PC177: Confused about usage of register: R10 in 'UnsetPending'

if isSuspTLD("." .. tostring(R9_PC139[#R9_PC139])) then
  return mp.INFECTED
end
return mp.CLEAN
