...
-- Command line: lua\!InfrastructureShared\!#LuaContextPossibleXorScriptFileInOverlayC\0x00000277_luac 
...
local l_0_3 = function(l_1_0)
  ...
  for l_1_4 = 0, 255 do
    local l_1_5 = (string.char)((mp.bitxor)(102, l_1_4)) .. (string.char)((mp.bitxor)(111, l_1_4)) .. (string.char)((mp.bitxor)(114, l_1_4)) .. (string.char)((mp.bitxor)(101, l_1_4)) .. (string.char)((mp.bitxor)(97, l_1_4)) .. (string.char)((mp.bitxor)(99, l_1_4)) .. (string.char)((mp.bitxor)(104, l_1_4))
...
if l_0_5 == 0 then
  (mp.set_mpattribute)("Lua:Context/ScriptFileInOverlay.C")
else
  if l_0_5 >= 1 and l_0_5 <= 255 then
    local l_0_6 = (string.format)("0x%x", l_0_5)
    ;
    (mp.set_mpattribute)("Lua:Context/PossibleXorScriptFileInOverlay.C!" .. tostring(l_0_6))
    ;
