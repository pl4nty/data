...
-- Command line: lua\!InfrastructureShared\!#LuaLuaGPOBlockerFilter\0x000007a4_luac 
    ...
    for l_1_10,l_1_11 in ipairs(l_1_2) do
      if (l_1_11.key):find(l_1_5) or (l_1_11.key):find(l_1_6) then
        ...
        if l_1_13 then
          ...
          if l_1_13 then
            AppendToRollingQueue("gpo_broad_exclusion", (string.lower)(l_1_12), true, 94608000, 100)
          end
        end
        l_1_13 = l_1_11.key
        l_1_13, l_1_14 = l_1_13:find, l_1_13
    ...
    if l_3_0 == "Properties" and l_3_1.key and ((l_3_1.key):find(l_3_3) or (l_3_1.key):find(l_3_4)) then
      ...
      if l_3_6 then
        ...
        if l_3_6 then
          ...
          l_3_8("gpo_broad_exclusion", (string.lower)(l_3_5), true, 94608000, 100)
        end
      end
      l_3_6 = l_3_1.key
      l_3_6, l_3_7 = l_3_6:find, l_3_6
...
, function(l_6_0)
    -- function num : 0_2_2 , upvalues : l_3_5, l_3_16, l_3_12, l_3_13, l_3_6, l_3_7, l_3_8, l_3_9, l_3_10, l_3_11
    if not l_3_5 then
      return 
    end
...
) or not next(l_3_14) then
        return nil
      end
      do return l_3_14 end
