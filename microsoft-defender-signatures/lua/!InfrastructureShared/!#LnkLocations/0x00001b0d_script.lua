...
-- Command line: lua\!InfrastructureShared\!#LnkLocations\0x00001b0d_luac 

-- params : ...
-- function num : 0
if (mp.get_mpattribute)("BM_LNK_FILE") == false and (mp.get_mpattribute)("PACKED_WITH:[CMDEmbedded]") == false then
  return mp.CLEAN
end
