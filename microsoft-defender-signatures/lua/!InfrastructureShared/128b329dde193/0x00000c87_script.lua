...
-- Command line: lua\!InfrastructureShared\128b329dde193\0x00000c87_luac 
  ...
  do
    ...
    do
      ...
      if (this_sigattrlog[7]).matched then
        ...
        l_0_10("TelemetryData", R5_PC69, bm.RelatedStringBMReport)
        l_0_10 = versioning
        l_0_10 = l_0_10.IsSeville
        l_0_10 = l_0_10()
        if l_0_10 then
          l_0_10 = l_0_8.friendly
          if not l_0_10 then
            l_0_10 = bm
            l_0_10 = l_0_10.trigger_sig
            -- DECOMPILER ERROR at PC94: Overwrote pending register: R5 in 'AssignReg'

            l_0_10("UEFILogo.E", R5_PC69)
          end
        end
        l_0_10 = mp
