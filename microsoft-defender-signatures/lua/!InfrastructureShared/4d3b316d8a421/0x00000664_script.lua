...
-- Command line: lua\!InfrastructureShared\4d3b316d8a421\0x00000664_luac 
...
do
  ...
  if not (this_sigattrlog[27]).matched or (this_sigattrlog[27]).utf8p1 == nil or (string.lower)((this_sigattrlog[27]).utf8p1) then
    local l_0_3 = nil
    ...
    do
      do
        if l_0_3:find("windowspowershell\\v1.0\\", 1, true) or l_0_3:find("documents\\powershell\\", 1, true) then
          ...
          TrackPidAndTechniqueBM((this_sigattrlog[26]).ppid, "T1546.013", "posh_profile_modify")
          return mp.INFECTED
        end
        return mp.CLEAN
      end
