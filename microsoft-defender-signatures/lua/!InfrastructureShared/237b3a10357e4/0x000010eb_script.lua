...
-- Command line: lua\!InfrastructureShared\237b3a10357e4\0x000010eb_luac 
...
if (this_sigattrlog[15]).matched and (this_sigattrlog[15]).utf8p1 ~= nil then
  l_0_8 = (string.lower)((this_sigattrlog[15]).utf8p1)
end
if l_0_8 ~= nil then
  ...
  if (sysio.IsFileExists)(l_0_8) and not (mp.IsKnownFriendlyFile)(l_0_8, true, false) then
    ...
    AddResearchData((this_sigattrlog[15]).ppid, true)
    return mp.INFECTED
  end
end
return mp.CLEAN
