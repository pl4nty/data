...
-- Command line: lua\!InfrastructureShared\103b3f59f763c\0x00000796_luac 
...
do
  ...
  do
    ...
    do return l_0_9 end
    -- DECOMPILER ERROR at PC127: Confused about usage of register R5 for local variables in 'ReleaseLocals'
