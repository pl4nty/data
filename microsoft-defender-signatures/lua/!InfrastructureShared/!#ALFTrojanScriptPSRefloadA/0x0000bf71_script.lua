...
-- Command line: lua\!InfrastructureShared\!#ALFTrojanScriptPSRefloadA\0x0000bf71_luac 
...
do
  if l_0_1 ~= nil then
    ...
    if l_0_2 and ((string.find)(l_0_2, "wscript.exe", 1, true) or (string.find)(l_0_2, "csript.exe", 1, true)) then
      return mp.INFECTED
    end
  end
  return mp.CLEAN
