...
-- Command line: lua\!InfrastructureShared\1d5b3985816bf\0x000003b2_luac 
      ...
      do
        ...
        do
          if (not (this_sigattrlog[6]).matched or (this_sigattrlog[6]).utf8p2 == nil or (this_sigattrlog[7]).matched) and (this_sigattrlog[7]).utf8p2 ~= nil then
            local l_0_8, l_0_11, l_0_15, l_0_18 = , (this_sigattrlog[3]).utf8p2
          else
          end
          if not (this_sigattrlog[8]).matched or (this_sigattrlog[8]).utf8p2 == nil or (this_sigattrlog[8]).utf8p2 then
            if (this_sigattrlog[9]).matched and (this_sigattrlog[9]).utf8p1 ~= nil and (this_sigattrlog[9]).utf8p2 ~= nil then
              local l_0_12, l_0_13, l_0_16 = (this_sigattrlog[9]).utf8p1
