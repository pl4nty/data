...
-- Command line: lua\!InfrastructureShared\Unknowcategory\0x00000eca_luac 
...
if (this_sigattrlog[5]).matched then
  l_0_7 = (string.lower)((this_sigattrlog[5]).utf8p2)
else
  if (this_sigattrlog[6]).matched then
    l_0_7 = (string.lower)((this_sigattrlog[6]).utf8p2)
  else
    if (this_sigattrlog[7]).matched then
      l_0_7 = (string.lower)((this_sigattrlog[7]).utf8p2)
    else
      if (this_sigattrlog[8]).matched then
        l_0_7 = (string.lower)((this_sigattrlog[8]).utf8p2)
      end
    end
  end
end
...
if (this_sigattrlog[9]).matched then
  l_0_8 = (string.lower)((this_sigattrlog[9]).utf8p1)
else
  if (this_sigattrlog[10]).matched then
    l_0_8 = (string.lower)((this_sigattrlog[10]).utf8p1)
  else
    if (this_sigattrlog[11]).matched then
      l_0_8 = (string.lower)((this_sigattrlog[11]).utf8p1)
    else
      if (this_sigattrlog[12]).matched then
        l_0_8 = (string.lower)((this_sigattrlog[12]).utf8p1)
      end
    end
  end
end
