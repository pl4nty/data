...
-- Command line: lua\!InfrastructureShared\Unknowcategory\0x0000022a_luac 
...
do
  ...
  if l_0_0 ~= nil then
    ...
    if ((sysio.GetPEVersionInfo)(l_0_4) and (sysio.GetPEVersionInfo)(l_0_4) == nil) or (string.lower)(((sysio.GetPEVersionInfo)(l_0_4)).OriginalFilename) ~= "filesyncclient.dll" then
      do
