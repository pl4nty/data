...
-- Command line: lua\!InfrastructureShared\Unknowcategory\0x00001c32_luac 
...
GetRuleInfo = function()
  ...
  l_1_0.NotificationDedupingInterval = 28800
...
GetPathExclusions = function()
  ...
  l_3_0["%programfiles(x86)%\\Tanium\\Tanium Client"] = 2
  ...
  l_3_0["%programfiles(x86)%\\Common Files\\Adobe\\ARM\\*\\AdobeARM.exe"] = 2
  ...
  l_3_0["%programfiles%\\BMC*\\Client Management\\Client\\bin\\mtxagent.exe"] = 2
  ...
  l_3_0["%programfiles%\\SecureWorks\\Taegis Agent\\TaegisSvc.x??.exe"] = 2
  l_3_0["%programfiles%\\VMware\\Endpoint Telemetry Service\\vmwetlm.exe"] = 2
  ...
  l_3_0["%windir%\\system32\\inetsrv\\w3wp.exe"] = 2
  ...
  l_3_0["%windir%\\AdminArsenal\\PDQDeployRunner\\service-1\\PDQDeployRunner-1.exe"] = 2
