...
-- Command line: lua\!InfrastructureShared\Unknowcategory\0x0000c4f2_luac 
...
local l_0_1 = function(l_2_0)
  ...
  l_2_1.ReadString = function(l_6_0)
    ...
    l_6_0.i = l_6_0.i + 1
    local l_6_2 = l_2_0:sub(l_6_0.i, l_6_0.i + l_6_1 - 1)
...
do
  ...
  for l_0_13,l_0_14 in pairs(l_0_9) do
    ...
    do
      ...
      if not l_0_16 then
        if l_0_15.CompressedSize > 0 then
          local l_0_21 = nil
          local l_0_22 = "CWSHACK\000x\156"
          ;
          (mp.vfo_add_buffer)(l_0_22 .. (mp.readfile)(l_0_15.Offset, l_0_15.Size), l_0_15.RelativePath .. "-[DotNetCompressed]", mp.ADD_VFO_TAKE_ACTION_ON_DAD)
        else
          do
            do
              ;
