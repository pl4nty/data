...
-- Command line: lua\!InfrastructureShared\Unknowcategory\0x00001c38_luac 
...
Infrastructure_NotSystemFolder = function(l_78_0)
  ...
  if l_78_0 then
    ...
    if l_78_1 then
      local l_78_2 = 210
      if (MpCommon.NidSearch)(l_78_2, (crypto.CRC32Buffer)(-1, (string.lower)(l_78_1), 0, (string.len)(l_78_1))) ~= true or l_78_2 ~= "#CleanFolder" then
        return l_78_0
      end
    end
  end
...
Infrastructure_NotUserSystemFolder = function(l_79_0)
  ...
  if l_79_0 then
    ...
    if l_79_1 and l_79_1 ~= "\\" then
      local l_79_2 = 210
      if (MpCommon.NidSearch)(l_79_2, (crypto.CRC32Buffer)(-1, (string.lower)(l_79_1), 0, (string.len)(l_79_1))) ~= true or l_79_2 ~= "#CleanFolder" then
        return l_79_0
      end
    end
  end
...
Infrastructure_CurrentThreatResourceScanFolder = function()
  -- function num : 0_80
  local l_81_0 = (MpDetection.GetCurrentThreat)()
  if l_81_0 == nil or l_81_0 == "" then
    return 
  end
  local l_81_1 = nil
  for l_81_5,l_81_6 in pairs(l_81_0.Resources) do
    ...
    if l_81_6.Schema == "file" or l_81_6.Schema == "process" then
      l_81_1 = Infrastructure_SplitThreatPath(l_81_6.Path)
      if l_81_1 and (sysio.IsFolderExists)(l_81_1) then
        (MpDetection.ScanResource)("folder://" .. l_81_1)
      end
    end
  end
end

Infrastructure_DetectionReportFolder = function(l_82_0, l_82_1, l_82_2)
  -- function num : 0_81
  if l_82_0 == nil or l_82_1 == nil or l_82_2 ~= true and l_82_2 ~= false then
    return false
  end
  local l_82_3, l_82_4, l_82_5 = Infrastructure_SplitThreatPath(l_82_1)
  if l_82_3 then
    local l_82_6 = l_82_3:gsub("^\\\\%?\\", "")
    if l_82_6 then
      local l_82_7 = Infrastructure_NotSystemFolder(l_82_6)
      local l_82_8 = Infrastructure_NotUserSystemFolder(l_82_6)
      if l_82_7 and l_82_8 then
        if l_82_2 == true and Infrastructure_ValidUwSFolderForRemediation(l_82_6) == false then
          return false
        end
        local l_82_9 = (sysio.FindFiles)(l_82_6, "*", -1)
        for l_82_13,l_82_14 in pairs(l_82_9) do
          (MpDetection.ReportResource)("file", l_82_14, l_82_0, false)
        end
        ;
        (MpDetection.ReportResource)("folder", l_82_6, l_82_0, false)
        local l_82_15 = (sysio.FindFolders)(l_82_6, "*", -1)
        for l_82_19,l_82_20 in pairs(l_82_15) do
          (MpDetection.ReportResource)("folder", l_82_20, l_82_0, false)
        end
      end
    end
  end
...
Infrastructure_CleanRegistryUninstallLocation = function(l_83_0)
  -- function num : 0_82
  if l_83_0 then
    local l_83_1 = {}
    ...
    local l_83_2 = (("HKLM\\Software\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\").RegExpandUserKey)("HKLM\\Software\\Wow6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\")
    local l_83_3 = (sysio.RegExpandUserKey)("HKCU\\Software\\Wow6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\")
    for l_83_7,l_83_8 in pairs(l_83_2) do
      (table.insert)(l_83_1, l_83_8)
    end
    for l_83_12,l_83_13 in pairs(l_83_3) do
      (table.insert)(l_83_1, l_83_13)
    end
    for l_83_17,l_83_18 in pairs(l_83_1) do
      local l_83_19 = (sysio.RegOpenKey)(l_83_18)
      if l_83_19 then
        local l_83_20 = (sysio.RegEnumKeys)(l_83_19)
        if l_83_20 then
          for l_83_24,l_83_25 in pairs(l_83_20) do
            local l_83_26 = (sysio.RegOpenKey)(l_83_18 .. l_83_25)
            if l_83_26 then
              local l_83_27 = (sysio.GetRegValueAsString)(l_83_26, "InstallLocation")
              if l_83_27 and (string.lower)(l_83_27) == (string.lower)(l_83_0) then
                (sysio.DeleteRegKey)(l_83_26, nil)
                return true
              end
            end
          end
...
Infrastructure_DetectionReportUninstallEntriesFromFolder = function(l_84_0, l_84_1)
  -- function num : 0_83
  if l_84_0 == nil or l_84_1 == nil then
    return false
  end
  local l_84_2, l_84_3, l_84_4 = Infrastructure_SplitThreatPath(l_84_1)
  if l_84_4 == nil then
    return false
  end
  if l_84_2 then
    ...
    local l_84_6 = (("HKLM\\Software\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\").RegExpandUserKey)("HKLM\\Software\\Wow6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\")
    local l_84_7 = (sysio.RegExpandUserKey)("HKCU\\Software\\Wow6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\")
    for l_84_11,l_84_12 in pairs(l_84_6) do
      (table.insert)(l_84_5, l_84_12)
    end
    for l_84_16,l_84_17 in pairs(l_84_7) do
      (table.insert)(l_84_5, l_84_17)
    end
    for l_84_21,l_84_22 in pairs(l_84_5) do
      local l_84_23 = (sysio.RegOpenKey)(l_84_22)
      if l_84_23 then
        local l_84_24 = (sysio.RegEnumKeys)(l_84_23)
        if l_84_24 then
          for l_84_28,l_84_29 in pairs(l_84_24) do
            local l_84_30 = (sysio.RegOpenKey)(l_84_22 .. l_84_29)
            if l_84_30 then
              local l_84_31 = (sysio.GetRegValueAsString)(l_84_30, "UninstallString")
              if l_84_31 then
                local l_84_32, l_84_33, l_84_34 = Infrastructure_SplitThreatPath(l_84_31:gsub("\"", ""))
                if l_84_32 and (string.lower)(l_84_32) == (string.lower)(l_84_2) then
                  (MpDetection.ReportResource)("regkey", l_84_22 .. l_84_29, l_84_0, false)
                  return true
                end
              end
            end
...
Infrastructure_GetRegValueAsString = function(l_85_0, l_85_1)
  -- function num : 0_84
  local l_85_2 = (sysio.RegOpenKey)(l_85_0)
  if l_85_2 then
    local l_85_3 = sysio.GetRegValueAsString
    local l_85_4 = l_85_2
    do
      local l_85_5 = l_85_1
      do return l_85_3(l_85_4, l_85_5) end
...
Infrastructure_ReportRegistryKey = function(l_86_0, l_86_1)
  -- function num : 0_85
  if l_86_0 == nil or l_86_1 == nil then
    return 
  end
  local l_86_2 = (sysio.RegOpenKey)(l_86_1)
  if l_86_2 then
    (MpDetection.ReportResource)("regkey", l_86_1, l_86_0, false)
  end
end

Infrastructure_ReportRegistryValue = function(l_87_0, l_87_1, l_87_2)
  -- function num : 0_86
  ...
  if l_87_3 then
    ...
    for l_87_8,l_87_9 in pairs(l_87_4) do
      if (string.lower)(l_87_9) == (string.lower)(l_87_2) then
        (MpDetection.ReportResource)("regkeyvalue", l_87_1 .. "\\\\" .. l_87_2, l_87_0, false)
      end
    end
  end
end

Infrastructure_ReportFirstRegistryValue = function(l_88_0, l_88_1, l_88_2)
  -- function num : 0_87
  if l_88_0 == nil or l_88_1 == nil or l_88_2 == nil then
    return false
  end
  if type(l_88_2) ~= "table" then
    return false
  end
  local l_88_3 = (sysio.RegOpenKey)(l_88_1)
  if l_88_3 then
    local l_88_4 = (sysio.RegEnumValues)(l_88_3)
    if l_88_4 then
      for l_88_8,l_88_9 in pairs(l_88_4) do
        local l_88_10 = (string.lower)(l_88_9)
        for l_88_14,l_88_15 in pairs(l_88_2) do
          if l_88_10 == (string.lower)(l_88_15) then
            (MpDetection.ReportResource)("regkeyvalue", l_88_1 .. "\\\\" .. l_88_9, l_88_0, false)
            return true
          end
        end
      end
...
Infrastructure_ReportFirstRegistryValueIfValueArrMatch = function(l_89_0, l_89_1, l_89_2, l_89_3)
  -- function num : 0_88
  if l_89_0 == nil or l_89_1 == nil or l_89_2 == nil or l_89_3 == nil then
    return false
  end
  if type(l_89_2) ~= "table" or type(l_89_3) ~= "table" then
    return false
  end
  local l_89_4 = (sysio.RegOpenKey)(l_89_1)
  if l_89_4 then
    local l_89_5 = (sysio.RegEnumValues)(l_89_4)
    if l_89_5 then
      for l_89_9,l_89_10 in pairs(l_89_5) do
        local l_89_11 = (string.lower)(l_89_10)
        for l_89_15,l_89_16 in pairs(l_89_2) do
          if l_89_11 == (string.lower)(l_89_16) then
            local l_89_17 = (sysio.GetRegValueAsDword)(l_89_4, l_89_16)
            if type(l_89_17) == "number" then
              for l_89_21,l_89_22 in pairs(l_89_3) do
                if l_89_17 == l_89_22 then
                  (MpDetection.ReportResource)("regkeyvalue", l_89_1 .. "\\\\" .. l_89_10, l_89_0, false)
                  return true
                end
              end
            end
...
Infrastructure_ReportFirstRegistryValueCheckDefaultDW = function(l_90_0, l_90_1, l_90_2)
  -- function num : 0_89
  if l_90_0 == nil or l_90_1 == nil or l_90_2 == nil then
    return false
  end
  if type(l_90_2) ~= "table" then
    return false
  end
  local l_90_3 = (sysio.RegOpenKey)(l_90_1)
  if l_90_3 then
    local l_90_4 = (sysio.RegEnumValues)(l_90_3)
    if l_90_4 then
      for l_90_8,l_90_9 in pairs(l_90_4) do
        local l_90_10 = (string.lower)(l_90_9)
        for l_90_14,l_90_15 in pairs(l_90_2) do
          if type(l_90_14) == "string" and type(l_90_15) == "number" and l_90_10 == (string.lower)(l_90_14) then
            local l_90_16 = (sysio.GetRegValueAsDword)(l_90_3, l_90_14)
            if type(l_90_16) == type(l_90_15) and l_90_16 ~= l_90_15 then
              (MpDetection.ReportResource)("regkeyvalue", l_90_1 .. "\\\\" .. l_90_9, l_90_0, false)
              return true
            end
          end
        end
...
Infrastructure_ReportAnyRegistryValue = function(l_91_0, l_91_1)
  -- function num : 0_90
  if l_91_0 == nil or l_91_1 == nil then
    return false
  end
  local l_91_2 = (sysio.RegOpenKey)(l_91_1)
  if l_91_2 then
    local l_91_3 = (sysio.RegEnumValues)(l_91_2)
    if l_91_3 then
      for l_91_7,l_91_8 in pairs(l_91_3) do
        (MpDetection.ReportResource)("regkeyvalue", l_91_1 .. "\\\\" .. l_91_8, l_91_0, false)
        do return true end
      end
    end
  end
...
Infrastructure_ReportRegistryKeyByValueData = function(l_92_0, l_92_1, l_92_2, l_92_3)
  -- function num : 0_91
  local l_92_4 = (sysio.RegOpenKey)(l_92_1)
  do
    if l_92_4 then
      local l_92_5 = (sysio.GetRegValueAsString)(l_92_4, l_92_2)
      if l_92_5 ~= nil and (string.lower)(l_92_5) == (string.lower)(l_92_3) then
        Infrastructure_ReportRegistryKey(l_92_0, l_92_1)
        return true
      end
    end
    return false
...
Infrastructure_ReportSoftwareRegistryByKey = function(l_93_0, l_93_1)
  -- function num : 0_92
  if l_93_0 == nil or l_93_1 == nil then
    return 
  end
  Infrastructure_ReportRegistryKey(l_93_0, "HKLM\\SOFTWARE\\" .. l_93_1)
  Infrastructure_ReportRegistryKey(l_93_0, "HKLM\\SOFTWARE\\Wow6432Node\\" .. l_93_1)
  local l_93_2 = (sysio.RegExpandUserKey)("HKCU\\Software\\" .. l_93_1)
  if l_93_2 then
    for l_93_6,l_93_7 in pairs(l_93_2) do
      Infrastructure_ReportRegistryKey(l_93_0, l_93_7)
    end
  end
end

Infrastructure_ReportUninstallRegistryByKey = function(l_94_0, l_94_1)
  -- function num : 0_93
  Infrastructure_ReportRegistryKey(l_94_0, "HKLM\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\" .. l_94_1)
  Infrastructure_ReportRegistryKey(l_94_0, "HKLM\\SOFTWARE\\Wow6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\" .. l_94_1)
end

Infrastructure_Report_Clsid_And_TypeLib = function(l_95_0, l_95_1, l_95_2)
  -- function num : 0_94
  local l_95_3 = Infrastructure_GetRegValueAsString(l_95_1 .. "\\CLSID\\" .. l_95_2 .. "\\TypeLib", "")
  if l_95_3 ~= nil then
    if (string.len)(l_95_3) == 38 and (string.match)(l_95_3, "{%x%x%x%x%x%x%x%x%-%x%x%x%x%-%x%x%x%x%-%x%x%x%x%-%x%x%x%x%x%x%x%x%x%x%x%x}") then
      Infrastructure_ReportRegistryKey(l_95_0, l_95_1 .. "\\TypeLib\\" .. l_95_3)
    end
    Infrastructure_ReportRegistryKey(l_95_0, l_95_1 .. "\\CLSID\\" .. l_95_2)
  end
end

Infrastructure_ReportCLSID = function(l_96_0, l_96_1)
  -- function num : 0_95
  if l_96_1 ~= nil and (string.len)(l_96_1) == 38 and (string.match)(l_96_1, "{%x%x%x%x%x%x%x%x%-%x%x%x%x%-%x%x%x%x%-%x%x%x%x%-%x%x%x%x%x%x%x%x%x%x%x%x}") then
    Infrastructure_Report_Clsid_And_TypeLib(l_96_0, "HKLM\\SOFTWARE\\Classes", l_96_1)
    Infrastructure_Report_Clsid_And_TypeLib(l_96_0, "HKLM\\SOFTWARE\\Wow6432Node\\Classes", l_96_1)
    Infrastructure_ReportRegistryKey(l_96_0, "HKCR\\CLSID\\" .. l_96_1)
  end
end

Infrastructure_ReportIEExtensionsByClsid = function(l_97_0, l_97_1)
  -- function num : 0_96
  if l_97_1 == nil then
    return 
  end
  Infrastructure_ReportRegistryValue(l_97_0, "HKLM\\SOFTWARE\\Microsoft\\Internet Explorer\\Approved Extensions", l_97_1)
  local l_97_2 = (sysio.RegExpandUserKey)("HKCU\\Software\\Microsoft\\Internet Explorer\\Approved Extensions")
  if l_97_2 then
    for l_97_6,l_97_7 in pairs(l_97_2) do
      Infrastructure_ReportRegistryValue(l_97_0, l_97_7, l_97_1)
    end
  end
  do
    Infrastructure_ReportRegistryValue(l_97_0, "HKLM\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Policies\\Ext\\CLSID", l_97_1)
    local l_97_8 = (sysio.RegExpandUserKey)("HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\Policies\\Ext\\CLSID")
    if l_97_8 then
      for l_97_12,l_97_13 in pairs(l_97_8) do
        Infrastructure_ReportRegistryValue(l_97_0, l_97_13, l_97_1)
      end
    end
    do
      Infrastructure_ReportRegistryKey(l_97_0, "HKLM\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Ext\\PreApproved\\" .. l_97_1)
      local l_97_14 = (sysio.RegExpandUserKey)("HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\Ext\\PreApproved\\" .. l_97_1)
      if l_97_14 then
        for l_97_18,l_97_19 in pairs(l_97_14) do
          Infrastructure_ReportRegistryKey(l_97_0, l_97_19)
        end
      end
      do
        Infrastructure_ReportRegistryKey(l_97_0, "HKLM\\SOFTWARE\\Microsoft\\Internet Explorer\\ApprovedExtensionsMigration\\" .. l_97_1)
        local l_97_20 = (sysio.RegExpandUserKey)("HKCU\\Software\\Microsoft\\Internet Explorer\\ApprovedExtensionsMigration\\" .. l_97_1)
        if l_97_20 then
          for l_97_24,l_97_25 in pairs(l_97_20) do
            Infrastructure_ReportRegistryKey(l_97_0, l_97_25)
          end
        end
      end
    end
...
Infrastructure_ReportBHOByName_RegPath = function(l_98_0, l_98_1, l_98_2)
  -- function num : 0_97
  local l_98_3 = (sysio.RegOpenKey)(l_98_2)
  if l_98_3 then
    local l_98_4 = (sysio.RegEnumKeys)(l_98_3)
    if l_98_4 then
      for l_98_8,l_98_9 in pairs(l_98_4) do
        if Infrastructure_ReportRegistryKeyByValueData(l_98_0, l_98_2 .. "\\" .. l_98_9, "", l_98_1) then
          Infrastructure_ReportCLSID(l_98_0, l_98_9)
          Infrastructure_ReportIEExtensionsByClsid(l_98_0, l_98_9)
        end
      end
    end
  end
...
Infrastructure_ReportBHOByName = function(l_99_0, l_99_1)
  -- function num : 0_98
  Infrastructure_ReportBHOByName_RegPath(l_99_0, l_99_1, "HKLM\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Explorer\\Browser Helper Objects")
  Infrastructure_ReportBHOByName_RegPath(l_99_0, l_99_1, "HKLM\\SOFTWARE\\Wow6432Node\\Microsoft\\Windows\\CurrentVersion\\Explorer\\Browser Helper Objects")
  local l_99_2 = (sysio.RegExpandUserKey)("HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\Explorer\\Browser Helper Objects")
  if l_99_2 then
    for l_99_6,l_99_7 in pairs(l_99_2) do
      Infrastructure_ReportBHOByName_RegPath(l_99_0, l_99_1, l_99_7)
    end
  end
  do
    local l_99_8 = (sysio.RegExpandUserKey)("HKCU\\Software\\Wow6432Node\\Microsoft\\Windows\\CurrentVersion\\Explorer\\Browser Helper Objects")
    if l_99_8 then
      for l_99_12,l_99_13 in pairs(l_99_8) do
        Infrastructure_ReportBHOByName_RegPath(l_99_0, l_99_1, l_99_13)
      end
    end
  end
end

Infrastructure_DetectionReportBHOByCLSID = function(l_100_0, l_100_1)
  -- function num : 0_99
  if l_100_1 ~= nil and l_100_0 ~= nil and (string.len)(l_100_1) == 38 and (string.match)(l_100_1, "{%x%x%x%x%x%x%x%x%-%x%x%x%x%-%x%x%x%x%-%x%x%x%x%-%x%x%x%x%x%x%x%x%x%x%x%x}") then
    Infrastructure_ReportRegistryKey(l_100_0, "HKLM\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Explorer\\Browser Helper Objects" .. l_100_1)
    Infrastructure_ReportRegistryKey(l_100_0, "HKLM\\SOFTWARE\\Wow6432Node\\Microsoft\\Windows\\CurrentVersion\\Explorer\\Browser Helper Objects" .. l_100_1)
    local l_100_2 = (sysio.RegExpandUserKey)("HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\Explorer\\Browser Helper Objects\\" .. l_100_1)
    if l_100_2 then
    ...
    do
      local l_100_8 = (sysio.RegExpandUserKey)("HKCU\\Software\\Wow6432Node\\Microsoft\\Windows\\CurrentVersion\\Explorer\\Browser Helper Objects\\" .. l_100_1)
      if l_100_8 then
...
Infrastructure_DetectionReportUninstallRegKey = function(l_101_0, l_101_1)
  -- function num : 0_100
  if l_101_1 ~= nil and l_101_0 ~= nil then
    Infrastructure_ReportRegistryKey(l_101_0, "HKLM\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\" .. l_101_1)
    Infrastructure_ReportRegistryKey(l_101_0, "HKLM\\SOFTWARE\\Wow6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\" .. l_101_1)
    local l_101_2 = (sysio.RegExpandUserKey)("HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\" .. l_101_1)
    if l_101_2 then
      for l_101_6,l_101_7 in pairs(l_101_2) do
        Infrastructure_ReportRegistryKey(l_101_0, l_101_7)
      end
    end
    do
      local l_101_8 = (sysio.RegExpandUserKey)("HKCU\\Software\\Wow6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\" .. l_101_1)
      if l_101_8 then
        for l_101_12,l_101_13 in pairs(l_101_8) do
          Infrastructure_ReportRegistryKey(l_101_0, l_101_13)
        end
      end
    end
  end
...
Infrastructure_ScanTaskschedulerResources = function()
  -- function num : 0_101
  local l_102_0 = "%SystemRoot%\\Tasks"
  local l_102_1 = "%SystemRoot%\\System32\\Tasks"
  ;
  (MpDetection.ScanResource)("specialfolder://norecursive:taskscheduler:" .. l_102_0)
  ;
  (MpDetection.ScanResource)("specialfolder://recursive:taskscheduler:" .. l_102_1)
  local l_102_2 = (sysio.RegOpenKey)("HKLM\\SOFTWARE\\Microsoft\\SchedulingAgent")
  if not l_102_2 then
    return false
  end
  local l_102_3 = (sysio.GetRegValueAsString)(l_102_2, "TasksFolder")
  if l_102_3 and l_102_3 ~= l_102_0 and l_102_3 ~= l_102_1 then
    if Info.OSMajorVersion < 6 then
      (MpDetection.ScanResource)("specialfolder://norecursive:taskscheduler:" .. l_102_3)
    else
      ;
      (MpDetection.ScanResource)("specialfolder://recursive:taskscheduler:" .. l_102_3)
    end
  end
end

Infrastructure_HKCUExpandSpecialPath = function(l_103_0)
  -- function num : 0_102
  local l_103_1 = {}
  if l_103_0 then
    local l_103_2 = (sysio.RegExpandUserKey)("HKCU\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Explorer\\Shell Folders")
    local l_103_3 = {}
    if l_103_2 then
      for l_103_7,l_103_8 in pairs(l_103_2) do
        local l_103_9 = (sysio.RegOpenKey)(l_103_8)
        if l_103_9 then
          local l_103_10 = (sysio.GetRegValueAsString)(l_103_9, l_103_0)
          if l_103_10 and not l_103_3[l_103_10] then
            (table.insert)(l_103_1, l_103_10)
            l_103_3[l_103_10] = true
          end
        end
      end
    end
...
Infrastructure_FixHostsFile = function()
  ...
  local l_104_0 = (MpCommon.ExpandEnvironmentVariables)("%windir%")
  local l_104_1 = l_104_0 .. "\\System32\\drivers\\etc\\hosts"
  local l_104_2 = "# Copyright (c) 1993-2006 Microsoft Corp." .. "\r\n" .. "#" .. "\r\n" .. "# This is a sample HOSTS file used by Microsoft TCP/IP for Windows." .. "\r\n" .. "#" .. "\r\n" .. "# This file contains the mappings of IP addresses to host names. Each" .. "\r\n" .. "# entry should be kept on an individual line. The IP address should" .. "\r\n" .. "# be placed in the first column followed by the corresponding host name." .. "\r\n" .. "# The IP address and the host name should be separated by at least one" .. "\r\n" .. "# space." .. "\r\n" .. "#" .. "\r\n" .. "# Additionally, comments (such as these) may be inserted on individual" .. "\r\n" .. "# lines or following the machine name denoted by a \'#\' symbol." .. "\r\n" .. "#" .. "\r\n" .. "# For example:" .. "\r\n" .. "#" .. "\r\n" .. "#      102.54.94.97     rhino.acme.com          # source server" .. "\r\n" .. "#       38.25.63.10     x.acme.com              # x client host" .. "\r\n" .. "# localhost name resolution is handle within DNS itself." .. "\r\n" .. "#       127.0.0.1       localhost" .. "\r\n" .. "#       ::1             localhost" .. "\r\n"
  local l_104_3 = "# Copyright (c) 1993-2006 Microsoft Corp." .. "\r\n" .. "#" .. "\r\n" .. "# This is a sample HOSTS file used by Microsoft TCP/IP for Windows." .. "\r\n" .. "#" .. "\r\n" .. "# This file contains the mappings of IP addresses to host names. Each" .. "\r\n" .. "# entry should be kept on an individual line. The IP address should" .. "\r\n" .. "# be placed in the first column followed by the corresponding host name." .. "\r\n" .. "# The IP address and the host name should be separated by at least one" .. "\r\n" .. "# space." .. "\r\n" .. "#" .. "\r\n" .. "# Additionally, comments (such as these) may be inserted on individual" .. "\r\n" .. "# lines or following the machine name denoted by a \'#\' symbol." .. "\r\n" .. "#" .. "\r\n" .. "# For example:" .. "\r\n" .. "#" .. "\r\n" .. "#      102.54.94.97     rhino.acme.com          # source server" .. "\r\n" .. "#       38.25.63.10     x.acme.com              # x client host" .. "\r\n" .. "" .. "\r\n" .. "# localhost name resolution is handle within DNS itself." .. "\r\n" .. "#       127.0.0.1       localhost" .. "\r\n" .. "#       ::1             localhost" .. "\r\n"
  local l_104_4 = "# Copyright (c) 1993-2006 Microsoft Corp." .. "\r\n" .. "#" .. "\r\n" .. "# This is a sample HOSTS file used by Microsoft TCP/IP for Windows." .. "\r\n" .. "#" .. "\r\n" .. "# This file contains the mappings of IP addresses to host names. Each" .. "\r\n" .. "# entry should be kept on an individual line. The IP address should" .. "\r\n" .. "# be placed in the first column followed by the corresponding host name." .. "\r\n" .. "# The IP address and the host name should be separated by at least one" .. "\r\n" .. "# space." .. "\r\n" .. "#" .. "\r\n" .. "# Additionally, comments (such as these) may be inserted on individual" .. "\r\n" .. "# lines or following the machine name denoted by a \'#\' symbol." .. "\r\n" .. "#" .. "\r\n" .. "# For example:" .. "\r\n" .. "#" .. "\r\n" .. "#      102.54.94.97     rhino.acme.com          # source server" .. "\r\n" .. "#       38.25.63.10     x.acme.com              # x client host" .. "\r\n" .. "" .. "\r\n" .. "127.0.0.1       localhost" .. "\r\n" .. "::1             localhost" .. "\r\n"
  local l_104_5 = "# Copyright (c) 1993-1999 Microsoft Corp." .. "\r\n" .. "#" .. "\r\n" .. "# This is a sample HOSTS file used by Microsoft TCP/IP for Windows." .. "\r\n" .. "#" .. "\r\n" .. "# This file contains the mappings of IP addresses to host names. Each" .. "\r\n" .. "# entry should be kept on an individual line. The IP address should" .. "\r\n" .. "# be placed in the first column followed by the corresponding host name." .. "\r\n" .. "# The IP address and the host name should be separated by at least one" .. "\r\n" .. "# space." .. "\r\n" .. "#" .. "\r\n" .. "# Additionally, comments (such as these) may be inserted on individual" .. "\r\n" .. "# lines or following the machine name denoted by a \'#\' symbol." .. "\r\n" .. "#" .. "\r\n" .. "# For example:" .. "\r\n" .. "#" .. "\r\n" .. "#      102.54.94.97     rhino.acme.com          # source server" .. "\r\n" .. "#       38.25.63.10     x.acme.com              # x client host" .. "\r\n" .. "" .. "\r\n" .. "127.0.0.1       localhost" .. "\r\n"
  if (sysio.IsFileExists)(l_104_1) == false then
    return false
  end
  local l_104_6 = (sysio.GetFileSize)(l_104_1)
  if l_104_6 == nil then
    return false
  end
  while 1 do
    if Info.OSMajorVersion < 6 then
      if (string.len)(l_104_5) < l_104_6 then
        l_104_5 = l_104_5 .. "\r\n"
  ...
  if (sysio.WriteFile)(l_104_1, 0, l_104_5) ~= (string.len)(l_104_5) then
    return false
  else
    return true
  end
  ...
  while 1 do
    if ((string.len)(l_104_5) + 2).OSMajorVersion == 6 and Info.OSMinorVersion == 0 then
      if (string.len)(l_104_4) < l_104_6 then
        l_104_4 = l_104_4 .. "\r\n"
  ...
  if (sysio.WriteFile)(l_104_1, 0, l_104_4) ~= (string.len)(l_104_4) then
    return false
  else
    return true
  end
  ...
  while 1 do
    if ((string.len)(l_104_4) + 2).OSMajorVersion == 6 and Info.OSMinorVersion == 1 then
      if (string.len)(l_104_3) < l_104_6 then
        l_104_3 = l_104_3 .. "\r\n"
  ...
  if (sysio.WriteFile)(l_104_1, 0, l_104_3) ~= (string.len)(l_104_3) then
    return false
  else
    return true
  end
  ...
  while 1 do
    if (((string.len)(l_104_3) + 2).OSMajorVersion == 6 and Info.OSMinorVersion == 2) or Info.OSMajorVersion > 6 then
      if (string.len)(l_104_2) < l_104_6 then
        l_104_2 = l_104_2 .. "\r\n"
  ...
  if (sysio.WriteFile)(l_104_1, 0, l_104_2) ~= (string.len)(l_104_2) then
    return false
  else
    return true
  end
...
Infrastructure_ReportRegistryAppId = function(l_105_0, l_105_1)
  -- function num : 0_104
  if l_105_0 == nil or l_105_1 == nil then
    return false
  end
  local l_105_2 = {}
  ...
  for l_105_6,l_105_7 in ("HKLM\\SOFTWARE\\Classes\\AppID\\")("HKLM\\SOFTWARE\\Classes\\WOW6432Node\\AppID\\") do
    local l_105_8 = (sysio.RegOpenKey)(l_105_7)
    if l_105_8 then
      local l_105_9 = (sysio.RegEnumKeys)(l_105_8)
      if l_105_9 then
        for l_105_13,l_105_14 in pairs(l_105_9) do
          if l_105_14 == l_105_1 then
            (MpDetection.ReportResource)("regkey", l_105_7 .. l_105_14, l_105_0, false)
            local l_105_15 = (sysio.RegOpenKey)(l_105_7 .. l_105_14)
            if l_105_15 then
              local l_105_16 = (sysio.GetRegValueAsString)(l_105_15, "AppId")
              if l_105_16 then
                (MpDetection.ReportResource)("regkey", l_105_7 .. l_105_16, l_105_0, false)
              end
            end
          end
        end
...
Infrastructure_RestoreRegValueDataFromAnotherRegValueAsString = function(l_106_0, l_106_1, l_106_2, l_106_3)
  -- function num : 0_105
  if l_106_0 == nil or l_106_2 == l_106_1 or l_106_3 ~= true and l_106_3 ~= false then
    return 
  end
  local l_106_4 = (sysio.RegOpenKey)(l_106_0)
  if l_106_4 then
    local l_106_5 = (sysio.GetRegValueAsString)(l_106_4, l_106_2)
    if l_106_5 ~= nil then
      (sysio.SetRegValueAsString)(l_106_4, l_106_1, l_106_5)
      if l_106_3 == true then
        (sysio.DeleteRegValue)(l_106_4, l_106_2)
      end
    end
  end
end

Infrastructure_ReportImageFileDebugger = function(l_107_0, l_107_1)
  -- function num : 0_106
  if l_107_0 == nil or l_107_1 == nil then
    return 
  end
  Infrastructure_ReportRegistryValue(l_107_0, "HKLM\\SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Image File Execution Options\\" .. l_107_1, "Debugger")
  Infrastructure_ReportRegistryValue(l_107_0, "HKLM\\SOFTWARE\\Wow6432Node\\Microsoft\\Windows NT\\CurrentVersion\\Image File Execution Options\\" .. l_107_1, "Debugger")
end
...
Infrastructure_CleanBrowserShellOpenCommandParameter_SearchString = function(l_109_0, l_109_1)
  -- function num : 0_108
  if l_109_0 == nil or l_109_1 == nil then
    return 
  end
  local l_109_2 = (sysio.RegOpenKey)(l_109_0)
  if l_109_2 ~= nil then
    local l_109_3 = (sysio.GetRegValueAsString)(l_109_2, "")
    if l_109_3 ~= nil then
      local l_109_4, l_109_5 = (string.find)((string.lower)(l_109_3), (string.lower)(l_109_1), 1, true)
      if l_109_4 ~= nil and l_109_5 ~= nil and l_109_5 < (string.len)(l_109_3) then
        (sysio.SetRegValueAsString)(l_109_2, "", (string.sub)(l_109_3, 1, l_109_5))
      end
    end
  end
end

Infrastructure_CleanImageFileDebugger = function(l_110_0)
  -- function num : 0_109
  if l_110_0 == nil then
    return 
  end
  Infrastructure_CleanImageFileDebugger_Regkey("HKLM\\SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Image File Execution Options\\" .. l_110_0)
  Infrastructure_CleanImageFileDebugger_Regkey("HKLM\\SOFTWARE\\Wow6432Node\\Microsoft\\Windows NT\\CurrentVersion\\Image File Execution Options\\" .. l_110_0)
end

Infrastructure_CleanImageFileDebugger_Regkey = function(l_111_0)
  -- function num : 0_110
  if l_111_0 == nil then
    return 
  end
  local l_111_1 = (sysio.RegOpenKey)(l_111_0)
  if l_111_1 then
    (sysio.DeleteRegValue)(l_111_1, "Debugger")
  end
end

Infrastructure_ReportAll_RegistryValueFromRegistryKey = function(l_112_0, l_112_1)
  -- function num : 0_111
  if l_112_1 == nil then
    return 
  end
  local l_112_2 = (sysio.RegOpenKey)(l_112_1)
  if l_112_2 then
    local l_112_3 = (sysio.RegEnumValues)(l_112_2)
    for l_112_7,l_112_8 in pairs(l_112_3) do
      (MpDetection.ReportResource)("regkeyvalue", l_112_1 .. "\\\\" .. l_112_8, l_112_0, false)
    end
  end
end

Infrastructure_ReportProductExcludedPathsInGroupPolicy = function(l_113_0)
  -- function num : 0_112
  Infrastructure_ReportAll_RegistryValueFromRegistryKey(l_113_0, "HKLM\\SOFTWARE\\Policies\\Microsoft\\Windows Defender\\Exclusions\\Paths")
  Infrastructure_ReportAll_RegistryValueFromRegistryKey(l_113_0, "HKLM\\SOFTWARE\\Policies\\Microsoft\\Microsoft Antimalware\\Exclusions\\Paths")
end

Infrastructure_ReportProductBulkExclusion = function(l_114_0)
  -- function num : 0_113
  if l_114_0 == nil or l_114_0 == "" then
    return 
  end
  local l_114_1 = function(l_115_0)
    -- function num : 0_113_0
    local l_115_1 = {}
    for l_115_5,l_115_6 in pairs(l_115_0) do
      local l_115_7 = (sysio.ExpandFilePath)(l_115_6, true)
      if l_115_7 ~= nil then
        for l_115_11,l_115_12 in pairs(l_115_7) do
          l_115_12 = (string.gsub)(l_115_12, "^\\\\%?\\", "")
          ;
          (table.insert)(l_115_1, l_115_12:lower())
        end
      end
    end
    do return l_115_1 end
    -- DECOMPILER ERROR at PC34: Confused about usage of register R2 for local variables in 'ReleaseLocals'

  end

  local l_114_2 = "HKLM\\SOFTWARE\\Microsoft\\Windows Defender\\Exclusions\\"
  local l_114_3 = l_114_2 .. "Extensions"
  if l_114_3 then
    local l_114_4 = {}
    -- DECOMPILER ERROR at PC15: No list found for R4 , SetList fails
    ...
    for l_114_8,l_114_9 in ("exe")("dll") do
      Infrastructure_ReportRegistryValue(l_114_0, l_114_3, l_114_9)
    end
  end
  do
    l_114_4 = l_114_2
    l_114_4 = l_114_4 .. "Paths"
    local l_114_10 = nil
    if l_114_4 then
      local l_114_11 = nil
      l_114_11 = "%systemdrive%"
      l_114_11 = l_114_1
      l_114_11 = l_114_11(l_114_10)
      -- DECOMPILER ERROR at PC45: Overwrote pending register: R5 in 'AssignReg'

      l_114_11 = pairs
      l_114_11 = l_114_11(l_114_10)
      for l_114_15,l_114_16 in l_114_11 do
        local l_114_16 = nil
        l_114_16 = Infrastructure_ReportRegistryValue
        l_114_16(l_114_0, l_114_4, l_114_15)
      end
      -- DECOMPILER ERROR at PC57: Confused about usage of register R6 for local variables in 'ReleaseLocals'

    end
  end
end

Infrastructure_DeleteAll_RegistryValueFromRegistryKey = function(l_115_0)
  -- function num : 0_114
  if l_115_0 == nil then
    return 
  end
  local l_115_1 = (sysio.RegOpenKey)(l_115_0)
  if l_115_1 then
    local l_115_2 = (sysio.RegEnumValues)(l_115_1)
    for l_115_6,l_115_7 in pairs(l_115_2) do
      (sysio.DeleteRegValue)(l_115_1, l_115_7)
    end
  end
end
...
Infrastructure_RestrictNTLMTraffic = function()
  -- function num : 0_116
  local l_117_0 = (sysio.RegOpenKey)("HKLM\\SYSTEM\\CurrentControlSet\\Control\\Lsa\\MSV1_0")
  if l_117_0 then
    (sysio.SetRegValueAsDword)(l_117_0, "restrictsendingntlmtraffic", 1)
  end
end

Infrastructure_ReportScheduleTaskByTaskId = function(l_118_0, l_118_1)
  -- function num : 0_117
  if (string.len)(l_118_0) == 38 and (string.match)(l_118_0, "{%x%x%x%x%x%x%x%x%-%x%x%x%x%-%x%x%x%x%-%x%x%x%x%-%x%x%x%x%x%x%x%x%x%x%x%x}") then
    local l_118_2 = "HKLM\\Software\\Microsoft\\Windows NT\\CurrentVersion\\Schedule\\Taskcache\\Tasks\\" .. l_118_0
    local l_118_3 = (sysio.RegOpenKey)(l_118_2)
    if l_118_3 then
      local l_118_4 = (sysio.GetRegValueAsString)(l_118_3, "Path")
      if l_118_4 ~= nil and (string.sub)(l_118_4, 1, 1) == "\\" then
        l_118_4 = (string.sub)(l_118_4, 2)
        local l_118_5 = (MpCommon.ExpandEnvironmentVariables)("%windir%")
        if (sysio.IsFileExists)(l_118_5 .. "\\Tasks\\" .. l_118_4 .. ".job") then
          (MpDetection.ReportResource)("taskscheduler", l_118_5 .. "\\Tasks\\" .. l_118_4 .. ".job", l_118_1, false)
        end
        if (sysio.IsFileExists)(l_118_5 .. "\\System32\\Tasks\\" .. l_118_4) then
          (MpDetection.ReportResource)("taskscheduler", l_118_5 .. "\\System32\\Tasks\\" .. l_118_4, l_118_1, false)
        end
      end
    end
  end
...
Infrastructure_DeleteRegistryEntriesOnValueMatch = function(l_119_0, l_119_1)
  -- function num : 0_118
  if l_119_0 == nil then
    return 
  end
  local l_119_2 = (sysio.RegEnumValues)(l_119_0)
  if l_119_2 == nil then
    return 
  end
  for l_119_6,l_119_7 in pairs(l_119_2) do
    if l_119_7 ~= nil then
      l_119_7 = (string.lower)(l_119_7)
      for l_119_11,l_119_12 in pairs(l_119_1) do
        l_119_12 = (string.lower)(l_119_12)
        if l_119_7 == l_119_12 then
          (sysio.DeleteRegValue)(l_119_0, l_119_7)
        end
      end
    end
  end
...
Infrastructure_DelRegKeyValuesIfExist = function(l_120_0, l_120_1)
  -- function num : 0_119
  if l_120_0 == nil or l_120_1 == nil then
    return 
  end
  local l_120_2 = (sysio.RegOpenKey)(l_120_0)
  if l_120_2 then
    do
      if type(l_120_1) == "string" then
        local l_120_3 = {}
      ...
      if type(l_120_1) ~= "table" then
        return 
      end
      Infrastructure_DeleteRegistryEntriesOnValueMatch(l_120_2, l_120_1)
    end
  end
end
...
Infrastructure_RemoveDefenderDAVASPolicyKey = function()
  ...
  local l_121_1 = "disableantivirus"
  -- DECOMPILER ERROR at PC5: Overwrote pending register: R2 in 'AssignReg'

  local l_121_2 = (("disableantispyware").RegOpenKey)(l_121_1)
  Infrastructure_DeleteRegistryEntriesOnValueMatch(l_121_2, l_121_0)
end
...
Infrastructure_RemoveDefenderDAVASPrefKey = function()
  ...
  local l_122_1 = "disableantivirus"
  -- DECOMPILER ERROR at PC5: Overwrote pending register: R2 in 'AssignReg'

  local l_122_2 = (("disableantispyware").RegOpenKey)(l_122_1)
  Infrastructure_DeleteRegistryEntriesOnValueMatch(l_122_2, l_122_0)
end
...
Infrastructure_IsE5 = function()
  ...
  local l_123_0 = 0
  do
    local l_123_1 = (sysio.RegOpenKey)("HKLM\\SOFTWARE\\Microsoft\\Windows Defender\\Features")
    if l_123_1 then
      l_123_0 = (sysio.GetRegValueAsDword)(l_123_1, "SenseEnabled")
    end
    do return l_123_0 == 1 end
...
Infrastructure_IsE3 = function()
  ...
  local l_124_0 = 0
  do
    local l_124_1 = (sysio.RegOpenKey)("HKLM\\SOFTWARE\\Microsoft\\Windows Defender")
    if l_124_1 then
      l_124_0 = (sysio.GetRegValueAsDword)(l_124_1, "ManagedDefenderProductType")
    end
    do return l_124_0 ~= nil and l_124_0 ~= 0 end
    -- DECOMPILER ERROR: 1 unprocessed JMP targets
  end
end

Infrastructure_HasPartnerGuid = function(l_125_0)
  -- function num : 0_124
  if l_125_0 == nil then
    return false
  end
  local l_125_1 = nil
  do
    local l_125_2 = (sysio.RegOpenKey)("HKLM\\SOFTWARE\\Policies\\Microsoft\\Windows Defender")
    if l_125_2 then
      l_125_1 = (sysio.GetRegValueAsString)(l_125_2, "PartnerGuid")
      if l_125_1 then
        if #l_125_1 > 36 then
          l_125_1 = (string.gsub)(l_125_1, "^%s*(.-)%s*$", "%1")
        end
        l_125_1 = (string.lower)(l_125_1)
      end
    end
    if #l_125_0 > 36 then
      l_125_0 = (string.gsub)(l_125_0, "^%s*(.-)%s*$", "%1")
    end
    l_125_0 = (string.lower)(l_125_0)
    do return l_125_1 ~= nil and l_125_1 == l_125_0 end
    -- DECOMPILER ERROR: 1 unprocessed JMP targets
  end
end

Infrastructure_HasAnyPartnerGuid = function(l_126_0)
  -- function num : 0_125
  if l_126_0 == nil or type(l_126_0) ~= "table" then
    return false
  end
  for l_126_4,l_126_5 in ipairs(l_126_0) do
    if Infrastructure_HasPartnerGuid(l_126_5) then
      return true
    end
  end
  return false
