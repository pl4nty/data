...
-- Command line: lua\!InfrastructureShared\Unknowcategory\0x000006a0_luac 
                              ...
                              if (string.sub)(l_0_2, 1, 11) == "PowerShell_" then
                                ...
                                do
                                  do
                                    ...
                                    if l_0_18 and l_0_19 == nil then
                                      (mp.set_mpattribute)("MpPowershellAmsiViaCmdLine")
                                    end
                                    if l_0_2 == "Excel" then
                                      ...
                                      if (string.sub)(l_0_2, 1, 15) == "Exchange Server" then
                                        ...
                                        local l_0_21, l_0_22 = pcall(mp.get_contextdata, mp.CONTEXT_DATA_AMSI_CONTENTNAME)
                                        if l_0_21 and l_0_22 ~= nil and (string.sub)(l_0_22, 1, 12) == "BodyContent;" then
                                          (mp.set_mpattribute)("MpIsExchangeAmsiBodyScan")
                                        end
                                      else
                                        do
                                          do
