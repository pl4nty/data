...
-- Command line: lua\!InfrastructureShared\Unknowcategory\0x000005c0_luac 
      ...
      if (this_sigattrlog[6]).matched and (this_sigattrlog[6]).utf8p2 ~= nil then
        ...
        if (string.find)(nil, "\\\\admin$\\\\", 1, true) or (string.find)(nil, "\\[a-z]%$\\") then
          ...
          if (string.lower)((MpCommon.PathToWin32Path)(nil)) ~= nil and (string.sub)((string.lower)((MpCommon.PathToWin32Path)(nil)), 0, 2) == "\\\\" and l_0_4 ~= nil then
            if (string.find)((string.lower)(l_0_4), "\\munich re group\\", 1, true) then
              return mp.CLEAN
            end
            local l_0_6 = nil
            for l_0_10,l_0_11 in ipairs((mp.GetExecutablesFromCommandLine)(l_0_4)) do
              ...
              R8_PC169 = (mp.ContextualExpandEnvironmentVariables)(R8_PC169)
              if (sysio.IsFileExists)(R8_PC169) == true then
                if (string.find)((string.lower)(R8_PC169), "getupdatedates", 1, true) then
                  return mp.CLEAN
                end
