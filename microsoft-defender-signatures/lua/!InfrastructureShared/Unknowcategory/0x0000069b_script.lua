...
-- Command line: lua\!InfrastructureShared\Unknowcategory\0x0000069b_luac 
...
GetPathExclusions = function()
  ...
  l_2_0["%windir%\\System32\\Dism\\DismHost.exe"] = 2
  l_2_0["%systemdrive%\\$WinREAgent\\Scratch\\*\\DismHost.exe"] = 2
  l_2_0["%localappdata%\\Temp\\*\\DismHost.exe"] = 1
  ...
  l_2_0["%programfiles%\\ATERA Networks\\AteraAgent\\Packages\\AgentPackageMonitoring\\AgentPackageMonitoring.exe"] = 2
  l_2_0["%windir%\\system32\\format.com"] = 2
  l_2_0["%windir%\\SysWOW64\\format.com"] = 2
  return l_2_0
end
