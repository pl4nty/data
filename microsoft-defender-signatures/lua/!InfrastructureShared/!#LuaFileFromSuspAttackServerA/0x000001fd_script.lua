...
-- Command line: lua\!InfrastructureShared\!#LuaFileFromSuspAttackServerA\0x000001fd_luac 
...
if l_0_0 ~= nil and l_0_0 ~= "" then
  ...
  if (mp.get_mpattribute)("Lua:CloudBlockLevelGT3") then
    ...
    l_0_3 = IsHostAttackServerCloudChk(l_0_0, "Lua:FileFromSuspAttackServer.A", l_0_4, l_0_5, "MOTW")
  else
    do
      l_0_3 = IsHostAttackServer(l_0_0)
      if l_0_3 then
        (mp.set_mpattribute)("Lua:FileFromAttackerServer")
        local l_0_6 = (string.format)("scenario:has_motw_attackerurl;filepath:%s;attacksvr:%s", l_0_2, l_0_0)
