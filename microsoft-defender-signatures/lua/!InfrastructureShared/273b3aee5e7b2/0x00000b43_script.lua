...
-- Command line: lua\!InfrastructureShared\273b3aee5e7b2\0x00000b43_luac 
...
if l_0_0 ~= nil and l_0_0 ~= "" then
  ...
  if ((".rtf")[10]).matched and (this_sigattrlog[10]).utf8p1 ~= nil and (this_sigattrlog[11]).matched and (this_sigattrlog[11]).utf8p1 ~= nil then
    local l_0_3 = false
    -- DECOMPILER ERROR at PC39: Overwrote pending register: R4 in 'AssignReg'

    local l_0_4 = ((".docx")[10]).utf8p1
    -- DECOMPILER ERROR at PC42: Overwrote pending register: R5 in 'AssignReg'

    local l_0_5 = ((".doc")[11]).utf8p1
  ...
  do
    ...
    if (l_0_3[12]).matched and (this_sigattrlog[12]).utf8p1 ~= nil and (this_sigattrlog[13]).matched and (this_sigattrlog[13]).utf8p1 ~= nil then
      local l_0_12 = false
      local l_0_13 = (this_sigattrlog[12]).utf8p1
      local l_0_14 = (this_sigattrlog[13]).utf8p1
    ...
    do
      ...
      if (l_0_12[14]).matched and (this_sigattrlog[14]).utf8p1 ~= nil and (this_sigattrlog[15]).matched and (this_sigattrlog[15]).utf8p1 ~= nil then
        local l_0_21 = false
        local l_0_22 = (this_sigattrlog[14]).utf8p1
        local l_0_23 = (this_sigattrlog[15]).utf8p1
      ...
      do
        ...
        if (l_0_21[16]).matched and (this_sigattrlog[16]).utf8p1 ~= nil and (this_sigattrlog[17]).matched and (this_sigattrlog[17]).utf8p1 ~= nil then
          local l_0_30 = false
          local l_0_31 = (this_sigattrlog[16]).utf8p1
          local l_0_32 = (this_sigattrlog[17]).utf8p1
        ...
        do
          ...
          if (l_0_30[18]).matched and (this_sigattrlog[18]).utf8p1 ~= nil and (this_sigattrlog[19]).matched and (this_sigattrlog[19]).utf8p1 ~= nil then
            local l_0_39 = false
            local l_0_40 = (this_sigattrlog[18]).utf8p1
            local l_0_41 = (this_sigattrlog[19]).utf8p1
