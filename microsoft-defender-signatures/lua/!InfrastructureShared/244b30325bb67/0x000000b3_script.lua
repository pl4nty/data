...
-- Command line: lua\!InfrastructureShared\244b30325bb67\0x000000b3_luac 
...
l_0_2, l_0_3 = l_0_0:match, l_0_0
l_0_4 = "(%d+);regionsize:(%d+)"
...
, [l_0_16.ANALYZE] = function(l_8_0)
  ...
  for l_8_4,l_8_5 in pairs(l_8_0.disassembled_instructions) do
    if l_8_5.opcode == 235 or l_8_5.opcode == 195 or l_8_5.opcode == 194 or l_8_5.opcode == 49 then
...
, [l_0_16.FINISH] = function(l_9_0)
  ...
  return mp.CLEAN
            ...
            -- DECOMPILER ERROR at PC197: Confused about usage of register: R28 in 'UnsetPending'
...
, [l_0_16.FINISH] = function(l_9_0)
  ...
  do return mp.CLEAN end
  -- DECOMPILER ERROR at PC238: freeLocal<0 in 'ReleaseLocals'
