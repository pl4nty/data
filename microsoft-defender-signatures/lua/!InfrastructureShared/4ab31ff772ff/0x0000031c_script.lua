...
-- Command line: lua\!InfrastructureShared\4ab31ff772ff\0x0000031c_luac 
...
if (mp.bitand)(l_0_4, 1) == 1 or (mp.bitand)(l_0_5, 1) == 1 or (mp.bitand)(l_0_6, 1) == 1 then
  if l_0_9 == "BM" then
    (bm.trigger_sig)("MacChmodToExec", l_0_1)
  else
    ;
    (bm.trigger_sig)("MacChmodToExec", l_0_1, l_0_9)
  end
  TrackPidAndTechniqueBM(l_0_9, "T1222.002", "DefenseEvasion_PermissionModification_MacChmodToExec")
  l_0_10 = true
end
if (mp.bitand)(l_0_7, 2) == 2 or (mp.bitand)(l_0_7, 4) == 4 then
  ...
  TrackPidAndTechniqueBM(l_0_9, "T1548.001", "PrivilegeEscalation_AbuseElevationControlMechanism_MacSetuidSetgid")
  l_0_10 = true
end
