...
-- Command line: lua\!InfrastructureShared\!#SLFTrojanWin32GracingD\0x000006ca_luac 
...
do
  ...
  for l_0_5,l_0_6 in (4294967280)(4294967291) do
    if (mp.bitand)(l_0_0, l_0_6) ~= l_0_6 then
      local l_0_7 = "Medicated64Golang"
      local l_0_8 = 3600
      local l_0_9 = 15
      AppendToRollingQueue(l_0_7, "magik", 1, l_0_8, l_0_9)
