...
-- Command line: lua\!InfrastructureShared\414d717bd6689\0x00000e76_luac 
  ...
  do
    ...
    if l_0_8 and ((l_0_8[1]).matched or (l_0_8[2]).matched or mp.HSTR_WEIGHT > 30) then
      ...
      do
        ...
        AppendToRollingQueue("PFApp_PotentialDownload_Ppid", l_0_13.ppid, l_0_9, 300, 500, 0)
        do
          ...
          do
            ...
            if l_0_12.CommandlineTokens and l_0_2 then
              ...
              -- DECOMPILER ERROR at PC207: Confused about usage of register: R18 in 'UnsetPending'
              ...
              do
                if not l_0_3 then
                  ...
                  if not startTrackingApp(l_0_13.ppid, l_0_2 or l_0_19, l_0_4 or "generic") then
                    ...
                    -- DECOMPILER ERROR at PC265: Confused about usage of register: R25 in 'UnsetPending'

                    ;
                    (MpCommon.BmTriggerSig)(l_0_13.ppid, "ProcAttribError", safeJsonSerialize(R32_PC269))
                  else
                    local l_0_33 = nil
                    ...
                    if next(R31_PC301) and (l_0_13.ppid).IsNewApp then
                      (l_0_13.ppid).SignatureName = "PFApps.A"
                      ;
                      (l_0_13.ppid).Score = l_0_11
                      -- DECOMPILER ERROR at PC311: Confused about usage of register: R25 in 'UnsetPending'

                      ;
                      (MpCommon.BmTriggerSig)(R31_PC301, "SetProcessAttrib", safeJsonSerialize(R34_PC315))
                    end
                  end
                  do
                    -- DECOMPILER ERROR at PC318: Confused about usage of register: R15 in 'UnsetPending'

                    -- DECOMPILER ERROR at PC320: Confused about usage of register: R17 in 'UnsetPending'
                    ...
                    do
                      ...
                      local l_0_39 = nil
                      -- DECOMPILER ERROR at PC363: Confused about usage of register: R15 in 'UnsetPending'

                      -- DECOMPILER ERROR at PC366: Confused about usage of register: R15 in 'UnsetPending'
                        ...
                        do
                          do
                            ...
                            if safeJsonSerialize(l_0_1, 150, nil, true) then
                              ...
                              if l_0_1 then
                                set_research_data("Error", (MpCommon.Base64Encode)(R21_PC414), R21_PC414)
                                return mp.INFECTED
                              end
                            end
