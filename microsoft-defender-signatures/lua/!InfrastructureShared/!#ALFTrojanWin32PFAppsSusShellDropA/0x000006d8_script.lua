...
-- Command line: lua\!InfrastructureShared\!#ALFTrojanWin32PFAppsSusShellDropA\0x000006d8_luac 
...
do
  ...
  if ((MpCommon.PathToWin32Path)(l_0_1)):match("([^\\]+)$") then
    ...
    local l_0_16 = l_0_14
    l_0_15 = l_0_15(l_0_16, {".exe", ".dll"})
    if l_0_15 then
      l_0_15 = AppendToRollingQueue
      l_0_16 = "PFApp_FileDropped_Path"
      l_0_15(l_0_16, (string.lower)(l_0_13), l_0_2, 1800, 500, 0)
    end
  end
  do
    local l_0_17 = nil
    ...
    do
      if (mp.enum_mpattributesubstring)("") and #(mp.enum_mpattributesubstring)("") > 0 then
        ...
        for l_0_25,l_0_26 in ipairs(l_0_21) do
          local l_0_22 = {}
          -- DECOMPILER ERROR at PC150: Confused about usage of register: R22 in 'UnsetPending'

          local l_0_28 = (MpCommon.StringRegExpSearch)("((alf:|slf:|tel:|detection:).*(webshell|shellcode|shellexecute|downloader|exploit|backdoor))", (string.lower)(R22_PC150))
      ...
      l_0_19.FileExtensionScore = GetFileExtensionScore(R22_PC196)
      l_0_20 = l_0_20 + (l_0_19.FileExtensionScore or 0)
      local l_0_33 = nil
      -- DECOMPILER ERROR at PC208: Overwrote pending register: R22 in 'AssignReg'

      R22_PC196 = R22_PC196((string.match)(R22_PC196, "^(.*)\\"))
      local l_0_34 = nil
      l_0_19.NormalizedDirectory = R22_PC196
      ...
      -- DECOMPILER ERROR at PC221: Confused about usage of register: R23 in 'UnsetPending'
      ...
      do
        ...
        if l_0_17 then
          ...
          local l_0_45 = nil
          -- DECOMPILER ERROR at PC282: Unhandled construct in 'MakeBoolean' P3
          ...
          if (l_0_43 > 0 and l_0_42 > 1) or l_0_44 > 5 then
            ...
            do
              ...
              if l_0_17 then
                local l_0_51 = nil
                local l_0_52, l_0_53 = , AnomalyTableCheck(R35_PC310, l_0_36 .. ";" .. R35_PC310, 30, l_0_40)
                if l_0_53 and not R35_PC310 then
                  l_0_19.AnomalousFileExtension = true
                  l_0_20 = l_0_20 + 10
                end
                l_0_19.AnomalousFileExtension_tblInfo = l_0_36 .. ";" .. R35_PC310
              end
              do
                l_0_19.FileDropScore = l_0_20
                local l_0_54 = nil
                local l_0_55, l_0_56 = l_0_18.Score, nil
                -- DECOMPILER ERROR at PC339: Overwrote pending register: R27 in 'AssignReg'

                if l_0_20 >= 10 then
                  IncreaseProcessAnomalyScore(l_0_2, nil, l_0_56, l_0_11, l_0_19)
                else
                  -- DECOMPILER ERROR at PC361: Overwrote pending register: R26 in 'AssignReg'
                ...
                if l_0_19.AnomalousDirectory then
                  ...
                  local l_0_59 = l_0_35
                  local l_0_60 = 1
                  -- DECOMPILER ERROR at PC380: Overwrote pending register: R35 in 'AssignReg'

                  if hasSeenBefore(l_0_58, l_0_59, R35_PC310, "FileDropInSuspDirectory") then
                    return mp.CLEAN
                  end
                  -- DECOMPILER ERROR at PC390: Overwrote pending register: R35 in 'AssignReg'

                  -- DECOMPILER ERROR at PC393: Overwrote pending register: R35 in 'AssignReg'

                  -- DECOMPILER ERROR at PC395: Overwrote pending register: R26 in 'AssignReg'

                  l_0_57 = 5
                  -- DECOMPILER ERROR at PC400: Overwrote pending register: R35 in 'AssignReg'

                  IncreaseProcessAnomalyScore(l_0_2, l_0_57, R35_PC310, l_0_11, l_0_19)
                end
                do
                  if l_0_56 then
