...
-- Command line: lua\!InfrastructureShared\!#SLFRansomNoteTrackerGen\0x00001b3d_luac 
...
if l_0_10 then
  ...
  if #l_0_10 == 5 then
    (MpCommon.BmTriggerSig)(l_0_1, "BM_GenRansomNoteTrackerGenC", safeJsonSerialize(l_0_10))
    ;
    (mp.set_mpattribute)("Lua:RansomNoteTracker.Gen")
    extractRansomNote(l_0_2 .. "\\" .. l_0_3)
    return mp.INFECTED
  end
else
  AppendToRollingQueue(l_0_5, l_0_9, l_0_2, l_0_6, l_0_7, 0)
