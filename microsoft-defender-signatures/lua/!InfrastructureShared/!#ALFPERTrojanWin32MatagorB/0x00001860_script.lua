...
-- Command line: lua\!InfrastructureShared\!#ALFPERTrojanWin32MatagorB\0x00001860_luac 
...
local l_0_1 = (("auditmodule").getfilesize)()
-- DECOMPILER ERROR at PC12: Overwrote pending register: R2 in 'AssignReg'

if l_0_1 < 512000 or l_0_1 > 20971520 then
  return ("servicemain").CLEAN
end
local l_0_2, l_0_3 = (pe.get_exports)(), "_cgo_dummy_export"
local l_0_4 = 0
