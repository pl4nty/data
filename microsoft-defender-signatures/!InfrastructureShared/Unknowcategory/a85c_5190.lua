...
-- Command line: lua\!InfrastructureShared\Unknowcategory\a85c_5190.luac 
...
if (versioning.GetHostOsType)() == 1 then
  ...
  -- DECOMPILER ERROR at PC147: Overwrote pending register: R5 in 'AssignReg'
  ...
  local l_0_7 = "-1.0"
  -- DECOMPILER ERROR at PC161: Overwrote pending register: R3 in 'AssignReg'
  ...
  do
    ...
    if (l_0_3.GetHostOsType)() == 2 then
      local l_0_9 = nil
      -- DECOMPILER ERROR at PC222: Overwrote pending register: R3 in 'AssignReg'
      ...
      do
        if (versioning.GetHostOsType)() == 3 then
          ...
          do
            ...
            -- DECOMPILER ERROR at PC469: freeLocal<0 in 'ReleaseLocals'
