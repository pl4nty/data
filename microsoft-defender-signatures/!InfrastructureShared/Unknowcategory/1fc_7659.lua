...
if not l_0_6 then
  ...
  if l_0_7 ~= nil and l_0_7 ~= "" then
    ...
    if l_0_5 == "d7c7c745-195f-4223-9c7a-99fb420fd000" and (MpCommon.IsSampled)(80000, false, true, true) == true then
...
do
  if not l_0_6 then
    ...
    do
      do
        if l_0_5 == "d7c7c745-195f-4223-9c7a-99fb420fd000" and (MpCommon.IsSampled)(80000, false, true, true) == true and (string.find)(l_0_10, "onedrivesetup.*%.exe") ~= nil then
