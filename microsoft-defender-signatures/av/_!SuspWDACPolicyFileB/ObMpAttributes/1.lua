...
-- Command line: lua\_!SuspWDACPolicyFileB\ObMpAttributes\1.luac 
...
, function(l_4_0)
  ...
  do
    ...
    l_4_13["msmpeng.exe"] = true
    l_4_13["wdfilter.sys"] = true
    l_4_13["wdnisdrv.sys"] = true
    l_4_13["mssecflt.sys"] = true
    l_4_13["msseccore.sys"] = true
    l_4_13["mssecwfp.sys"] = true
    l_4_13["mpcoredefenderservice.exe"] = true
    l_4_13["senseir.exe"] = true
    local l_4_14 = {}
...
, function(l_5_0)
  ...
  if l_5_0.Type == "OCTET STRING" then
    ...
    if l_5_4 == "07000000" or l_5_4 == "06000000" or l_5_4 == "05000000" or l_5_4 == "04000000" or l_5_4 == "03000000" or l_5_4 == "02000000" or l_5_4 == "01000000" then
      do
        ...
        if l_5_4 then
          ...
          for l_5_13,l_5_14 in l_5_4 do
            local l_5_13, l_5_14 = nil
            l_5_13 = l_0_7
            l_5_14 = l_5_12
            l_5_13 = l_5_13(l_5_14)
            local l_5_15, l_5_16 = nil
            if l_5_13 then
              l_5_15 = true
              l_5_16 = 
              return l_5_15, l_5_16
            end
          end
        end
        do
    ...
    if l_0_11(R12_PC55) then
      if R12_PC55 and R12_PC55 == "file" then
        return mp.INFECTED
      else
        ;
        (mp.changedetectionname)(805306764)
        return mp.INFECTED
      end
    end
  end
