...
if IsBasFileEncryptExt(l_0_5) == false then
  ...
  if (string.find)(l_0_3, "[a-z]:\\windows\\temp\\sb%-sim%-temp") == nil and (string.find)(l_0_3, l_0_9 .. "\\temp\\sb-sim-temp", 1, true) == nil and (string.find)(l_0_3, "[a-z]:\\users\\[^\\]+\\appdata\\local\\temp\\sb_%d+_bs_") == nil and (string.find)(l_0_3, l_0_10 .. "\\sb_%d+_bs_") == nil and l_0_6 ~= nil and (string.find)(l_0_6, "[a-z]:\\windows\\temp\\sb%-sim%-temp") == nil and l_0_6 ~= nil and (string.find)(l_0_6, l_0_9 .. "\\temp\\sb-sim-temp", 1, true) == nil and l_0_6 ~= nil and (string.find)(l_0_6, "[a-z]:\\users\\[^\\]+\\appdata\\local\\temp\\sb_%d+_bs_") == nil and l_0_6 ~= nil and (string.find)(l_0_6, l_0_10 .. "\\sb_%d+_bs_") == nil and l_0_7 ~= nil and (string.find)(l_0_7, "[a-z]:\\windows\\temp\\sb%-sim%-temp") == nil and l_0_7 ~= nil and (string.find)(l_0_7, l_0_9 .. "\\temp\\sb-sim-temp", 1, true) == nil and l_0_7 ~= nil and (string.find)(l_0_7, "[a-z]:\\users\\[^\\]+\\appdata\\local\\temp\\sb_%d+_bs_") == nil and l_0_7 ~= nil and (string.find)(l_0_7, l_0_10 .. "\\sb_%d+_bs_") == nil and l_0_8 ~= nil and (string.find)(l_0_8, "[a-z]:\\windows\\temp\\sb%-sim%-temp") == nil and l_0_8 ~= nil and (string.find)(l_0_8, l_0_9 .. "\\temp\\sb-sim-temp", 1, true) == nil and l_0_8 ~= nil and (string.find)(l_0_8, "[a-z]:\\users\\[^\\]+\\appdata\\local\\temp\\sb_%d+_bs_") == nil and l_0_8 ~= nil and (string.find)(l_0_8, l_0_10 .. "\\sb_%d+_bs_") == nil then
