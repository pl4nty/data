...
-- Command line: lua\_!GracingH\Includes\1.luac 
...
do
  if l_0_2 then
    local l_0_8, l_0_9 = pcall(mp.get_contextdata, mp.CONTEXT_DATA_REMOTE_SESSION_IP)
    if l_0_8 and not isnull(l_0_9) and isPublicIP(l_0_9) then
      local l_0_10 = {}
      l_0_10.SIG_CONTEXT = "GoLang"
      l_0_10.CONTENT_SOURCE = "SMB_GOLANG_32_WITH_TEMPERED_PCLNTAB_MAGIC"
