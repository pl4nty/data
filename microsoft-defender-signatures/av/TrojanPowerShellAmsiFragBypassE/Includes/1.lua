...
-- Command line: lua\TrojanPowerShellAmsiFragBypassE\Includes\1.luac 
...
if l_0_0 == mp.SCANREASON_AMSI then
  ...
  if l_0_1 ~= nil then
    ...
    if (mp.get_mpattribute)("SCRIPT:PowerShell/PublicStatic") then
      AddTacticForPid(l_0_2, "PublicStatic", 3600)
    end
