...
-- Command line: lua\_!BatTamperA\Includes\1.luac 
...
l_0_0["SCPT:Trojan:JS/BatTamper.AK1!MSR"] = -100
local l_0_1 = {}
l_0_1.yml = true
l_0_1.xml = true
l_0_1.json = true
...
local l_0_5 = {}
-- DECOMPILER ERROR at PC113: No list found for R5 , SetList fails

-- DECOMPILER ERROR at PC114: Overwrote pending register: R6 in 'AssignReg'

if ("os.2020")(l_0_4, l_0_5) then
  return mp.CLEAN
end
local l_0_6 = (string.match)(l_0_3, "([^\\%.]+)$")
if l_0_6 == nil or #l_0_6 < 2 or l_0_1[l_0_6] == true then
  l_0_2 = l_0_2 - 100
end
for l_0_10,l_0_11 in pairs(l_0_0) do
