...
if ((l_0_0 ~= "d7c7c745-195f-4223-9c7a-99fb420fd000" and l_0_0 ~= "392708a8-b7f0-49e3-bc8f-ca134f1f60d7") or (MpCommon.IsSampled)(55000, false, false, false) ~= true) and (MpCommon.IsSampled)(4000, false, false, false) ~= true then
  return mp.CLEAN
end
