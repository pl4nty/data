...
-- Command line: lua\_!SuspGolangM\Includes\1.luac 

-- params : ...
-- function num : 0
if (mp.get_contextdata)(mp.CONTEXT_DATA_HAS_MOTW_ADS) and (mp.GetMOTWZone)() >= 3 then
  local l_0_0, l_0_1 = pcall(mp.GetMOTWHostUrl)
  if l_0_0 and not isnull(l_0_1) then
    ...
    do
      if l_0_4 then
        ...
        l_0_10.CONTENT_SOURCE = "MOTW_GOLANG_64_WITH_TAMPERED_PCLNTAB_MAGIC"
