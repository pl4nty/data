...
#ifndef TOOLS_WIN_PROCESS_VIEWER_EDGE_DATA_PROVIDER_PROCESS_DATA_PROVIDER_H_
#define TOOLS_WIN_PROCESS_VIEWER_EDGE_DATA_PROVIDER_PROCESS_DATA_PROVIDER_H_

#include <memory>
#include <vector>

#include "tools/win/process_viewer/edge_data_provider/process.h"
...
#endif  // TOOLS_WIN_PROCESS_VIEWER_EDGE_DATA_PROVIDER_PROCESS_DATA_PROVIDER_H_
