...
#ifndef TOOLS_WIN_PROCESS_VIEWER_EDGE_DATA_PROVIDER_TASK_EXPORT_H_
#define TOOLS_WIN_PROCESS_VIEWER_EDGE_DATA_PROVIDER_TASK_EXPORT_H_
...
#endif  // TOOLS_WIN_PROCESS_VIEWER_EDGE_DATA_PROVIDER_TASK_EXPORT_H_
