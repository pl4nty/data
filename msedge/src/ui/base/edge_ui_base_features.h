...
COMPONENT_EXPORT(UI_BASE_FEATURES)
BASE_DECLARE_FEATURE(kBrowserSideAreaSelection);
#endif  // BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX)
COMPONENT_EXPORT(UI_BASE_FEATURES)
bool IsBrowserSideAreaSelectionEnabled();
COMPONENT_EXPORT(UI_BASE_FEATURES)
...
COMPONENT_EXPORT(UI_BASE_FEATURES)
BASE_DECLARE_FEATURE(kEdgeComposeDebug);
COMPONENT_EXPORT(UI_BASE_FEATURES)
bool IsEdgeComposeDebugEnabled();

COMPONENT_EXPORT(UI_BASE_FEATURES)
BASE_DECLARE_FEATURE(kEdgeComposeVoiceInput);
COMPONENT_EXPORT(UI_BASE_FEATURES)
bool IsEdgeComposeVoiceInputEnabled();
