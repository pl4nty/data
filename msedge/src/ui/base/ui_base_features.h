...
#include "build/branding_buildflags.h" // MICROSOFT_EDGE_BRANDING
...
// TODO(task.ms/54401287): Rebaseline tests for UiGpuRasterization.
// This feature is disabled for multiple interactive_ui_tests and
// components_unit_tests. The following tests will need to re-enable this
// feature and have their test images re-baselined: CollaboratorsPixelTest,
// EdgeAppMenuPixelTest, InfoBarPixelTest, MainWidgetPixelTest,
// OmniboxPixelTest, TabActionsMenuPixelTest, ToolbarViewVisualRefreshPixelTest,
// WinCaptionButtonPixelTest, ContinuityWindowTest.
COMPONENT_EXPORT(UI_BASE_FEATURES) BASE_DECLARE_FEATURE(kUiGpuRasterization);
