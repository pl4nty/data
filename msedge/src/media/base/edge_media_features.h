...
#if BUILDFLAG(ENABLE_CDM_OVERRIDE_WIN_10)
...
#endif  // BUILDFLAG(ENABLE_CDM_OVERRIDE_WIN_10)

#if BUILDFLAG(ENABLE_MF_AC3_EAC3_DECODING)
COMPONENT_EXPORT(EDGE_MEDIA_FEATURES)
BASE_DECLARE_FEATURE(kDecodeAc3Eac3UsingMF);
#endif  // BUILDFLAG(ENABLE_MF_AC3_EAC3_DECODING)
...
#if BUILDFLAG(ENABLE_MF_HEVC_DECODING)
COMPONENT_EXPORT(EDGE_MEDIA_FEATURES) BASE_DECLARE_FEATURE(kDecodeHevcUsingMF);
#endif  // BUILDFLAG(ENABLE_MF_HEVC_DECODING)

#if BUILDFLAG(ENABLE_SMTC_SUPPORT_FOR_PWA)
COMPONENT_EXPORT(EDGE_MEDIA_FEATURES) BASE_DECLARE_FEATURE(kSmtcSupportForPwa);
#endif  // BUILDFLAG(ENABLE_SMTC_SUPPORT_FOR_PWA)
...
#if BUILDFLAG(ENABLE_MEDIA_FOUNDATION_OVERRIDE)
...
#endif  // BUILDFLAG(ENABLE_MEDIA_FOUNDATION_OVERRIDE)
...
COMPONENT_EXPORT(EDGE_MEDIA_FEATURES)
BASE_DECLARE_FEATURE_TRIGGER(kVideoSuperResMsVideoSuperResCapableTrigger);

COMPONENT_EXPORT(EDGE_MEDIA_FEATURES)
BASE_DECLARE_FEATURE_TRIGGER(kVideoSuperResRightSizeTrigger);
...
#if BUILDFLAG(ENABLE_VIDEO_ELEMENT_IMG_CONTENTS)
COMPONENT_EXPORT(EDGE_MEDIA_FEATURES)
BASE_DECLARE_FEATURE(kVideoElementImgContents);
#endif  // BUILDFLAG(ENABLE_VIDEO_ELEMENT_IMG_CONTENTS)
...
COMPONENT_EXPORT(EDGE_MEDIA_FEATURES)
BASE_DECLARE_FEATURE(kEdgeAndroidMediaUseTrigger);
COMPONENT_EXPORT(EDGE_MEDIA_FEATURES)
...
COMPONENT_EXPORT(EDGE_MEDIA_FEATURES)
BASE_DECLARE_FEATURE(kEdgeGMCLiveCaption);
