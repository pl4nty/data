...
/* #define FFMPEG_CONFIGURATION "--disable-everything --disable-all --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-static --enable-avcodec --enable-avformat --enable-avutil --enable-static --enable-libopus --disable-debug --disable-bzlib --disable-error-resilience --disable-iconv --disable-network --disable-schannel --disable-sdl2 --disable-symver --disable-xlib --disable-zlib --disable-securetransport --disable-faan --disable-alsa --disable-iamf --disable-autodetect --extra-cflags=-I/Users/msftelectron/adoagent/_work/11/b/src/third_party/opus/src/include --disable-linux-perf --x86asmexe=nasm --optflags='\0-O2\0' --enable-pic --cc=clang --cxx=clang++ --ld=clang --extra-ldflags='-Wl,-flat_namespace -Wl,-undefined,warning' --arch=x86_64 --extra-cflags=-m64 --extra-ldflags='-arch x86_64' --enable-decoder='vorbis,libopus,flac,theora,vp8,vp9,h264' --enable-decoder='pcm_u8,pcm_s16le,pcm_s24le,pcm_s32le,pcm_f32le,mp3' --enable-decoder='pcm_s16be,pcm_s24be,pcm_mulaw,pcm_alaw' --enable-demuxer='flac,mp3,mov,ogg,wav' --enable-parser='opus,vorbis,flac,mpegaudio,vp9,vp3,vp8,h264' --enable-cross-compile" -- elide long configuration string from binary */
