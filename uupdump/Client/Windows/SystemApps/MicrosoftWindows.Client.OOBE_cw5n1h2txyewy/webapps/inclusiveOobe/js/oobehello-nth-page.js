...
//
(() => {
    WinJS.UI.Pages.define("/webapps/inclusiveOobe/view/oobehello-nth-main.html", {
        ...
        ready: (element, options) => {
            require(['lib/knockout', 'corejs/knockouthelpers', 'legacy/bridge', 'legacy/events', 'oobehello-nth-vm', 'lib/knockout-winjs'], (ko, KoHelpers, bridge, constants, HelloNthViewModel) => {
                ...
                if (!this.skipNgc && this.enrollmentKinds && (this.enrollmentKinds.face || this.enrollmentKinds.fingerprint)) {
                    ...
                    ko.applyBindings(new HelloNthViewModel(this.resourceStrings, this.enrollmentKinds));
