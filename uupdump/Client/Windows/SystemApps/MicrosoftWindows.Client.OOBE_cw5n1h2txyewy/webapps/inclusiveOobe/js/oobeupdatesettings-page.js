(() => {
    WinJS.UI.Pages.define("/webapps/inclusiveOobe/view/oobeupdatesettings-main.html", {
        ...
        ready: (element, options) => {
            require(['lib/knockout', 'corejs/knockouthelpers', 'legacy/bridge', 'legacy/events', 'oobeupdatesettings-vm', 'lib/knockout-winjs'], (ko, KoHelpers, bridge, constants, UpdateSettingsViewModel) => {
