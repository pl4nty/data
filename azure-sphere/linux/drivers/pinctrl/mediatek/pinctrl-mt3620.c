...
static const struct mtk_drv_group_desc mt3620_drv_grp[] =  {
	MTK_DRV_GRP(4, 16, 0, 1, 4)
};

static const struct mtk_pin_drv_grp mt3620_pin_drv[] = {
	// GPIO_GRP0
	MTK_PIN_DRV_GRP(0,   0x0070,  0, 0),
	MTK_PIN_DRV_GRP(1,   0x0070,  2, 0),
	MTK_PIN_DRV_GRP(2,   0x0070,  4, 0),
	MTK_PIN_DRV_GRP(3,   0x0070,  6, 0),

	// GPIO_GRP1
	MTK_PIN_DRV_GRP(4,   0x0070,  0, 0),
	MTK_PIN_DRV_GRP(5,   0x0070,  2, 0),
	MTK_PIN_DRV_GRP(6,   0x0070,  4, 0),
	MTK_PIN_DRV_GRP(7,   0x0070,  6, 0),

	// GPIO_GRP2
	MTK_PIN_DRV_GRP(8,   0x0070,  0, 0),
	MTK_PIN_DRV_GRP(9,   0x0070,  2, 0),
	MTK_PIN_DRV_GRP(10,  0x0070,  4, 0),
	MTK_PIN_DRV_GRP(11,  0x0070,  6, 0),

	// GPIO_GRP3
	MTK_PIN_DRV_GRP(12,  0x0070,  0, 0),
	MTK_PIN_DRV_GRP(13,  0x0070,  2, 0),
	MTK_PIN_DRV_GRP(14,  0x0070,  4, 0),
	MTK_PIN_DRV_GRP(15,  0x0070,  6, 0),

	// GPIO_GRP4
	MTK_PIN_DRV_GRP(16,  0x0070,  0, 0),
	MTK_PIN_DRV_GRP(17,  0x0070,  2, 0),
	MTK_PIN_DRV_GRP(18,  0x0070,  4, 0),
	MTK_PIN_DRV_GRP(19,  0x0070,  6, 0),

	// GPIO_GRP5
	MTK_PIN_DRV_GRP(20,  0x0070,  0, 0),
	MTK_PIN_DRV_GRP(21,  0x0070,  2, 0),
	MTK_PIN_DRV_GRP(22,  0x0070,  4, 0),
	MTK_PIN_DRV_GRP(23,  0x0070,  6, 0),
};
...
static const struct mtk_pinctrl_devdata mt3620_pinctrl_data = {
	...
	.port_align = 4,
	.pin_drv_grp = mt3620_pin_drv,
	.n_pin_drv_grps = ARRAY_SIZE(mt3620_pin_drv),
	.grp_desc = mt3620_drv_grp,
	.n_grp_cls = ARRAY_SIZE(mt3620_drv_grp),
};
