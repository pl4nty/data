...
Invoke-WebRequest -Uri "https://sourceforge.net/projects/unluac/files/Unstable/unluac_2025_12_23.jar/download" -OutFile "unluac.jar" -UserAgent "Microsoft-Delivery-Optimization/10.1"
